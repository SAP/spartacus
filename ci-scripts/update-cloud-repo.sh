...
# Create a new branch
git checkout -b new_branch9

# Replace the content inside js-storefront/spartacusstore with the content from ./../../spartacus-${version}/apps/spartacusstore
rm -rf js-storefront/spartacusstore/*
cp -r ../../spartacus-2211.27.0-2/apps/spartacusstore/* js-storefront/spartacusstore/
