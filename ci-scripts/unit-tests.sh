...
ng test cds --watch=false --source-mapp --code-coverage --browsers=ChromeHeadless
...
ng test product-configurator --source-mapp --watch=false --code-coverage --browsers=ChromeHeadless
...
ng test cdc --source-mapp --watch=false --code-coverage --browsers=ChromeHeadless
...
ng test digital-payments --source-mapp --watch=false --code-coverage --browsers=ChromeHeadless
...
ng test epd-visualization --source-mapp --watch=false --code-coverage --browsers=ChromeHeadless
...
ng test storefinder --source-mapp --watch=false --code-coverage --browsers=ChromeHeadless
...
ng test qualtrics --source-mapp --watch=false --code-coverage --browsers=ChromeHeadless
...
ng test asm --source-mapp --watch=false --code-coverage --browsers=ChromeHeadless
...
ng test tracking --source-mapp --watch=false --code-coverage --browsers=ChromeHeadless
