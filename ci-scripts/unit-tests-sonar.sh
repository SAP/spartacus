...
if [[ $1 == '-h' ]]; then
    ...
    -Dsonar.sources=projects/storefrontlib,projects/core,projects/storefrontstyles \
    -Dsonar.tests=projects/storefrontlib,projects/core,projects/storefrontstyles \
