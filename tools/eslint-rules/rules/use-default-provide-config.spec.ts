...
ruleTester.run(RULE_NAME, rule, {
  ...
  invalid: [
    ...
    }) as TSESLint.InvalidTestCase<'useDefaultProvideConfig', never[]>, // type cast used as convertAnnotatedSourceToFailureCase simplifies testing, but TSESLint requires never[] instead of readonly unknown[]
    convertAnnotatedSourceToFailureCase({
      description:
