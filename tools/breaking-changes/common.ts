...
export const NEW_MAJOR_VERSION = '2211_19'; // Increment this number to match the current release for which the script is used.
export const BREAKING_CHANGES_FILE_PATH = `data/${NEW_MAJOR_VERSION}/breaking-changes.json`;
export const MAJOR_VERSION_DOC_HOME = `../../docs/migration/${NEW_MAJOR_VERSION}`;
...
export const MIGRATION_SCHEMATICS_HOME = `../../projects/schematics/src/migrations/${NEW_MAJOR_VERSION}`;
