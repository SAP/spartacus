...
storeDetails$: import("rxjs").Observable<({
        payload: import("@spartacus/core").PointOfService;
    } & import("@ngrx/store").Action<"[Pickup Locations] Get Store Details Success">) | ({
        payload: any;
        error: any;
    } & import("@ngrx/store").Action<"[Pickup Locations] Get Store Details Fail">)> & import("@ngrx/effects").CreateEffectMetadata
```
...
```
loadStockLevels$: import("rxjs").Observable<StockLevelActions.StockLevelSuccess | StockLevelActions.StockLevelFail> & import("@ngrx/effects").CreateEffectMetadata
```
