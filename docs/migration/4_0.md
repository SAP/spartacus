...
Change: Protected method`getCartEndpoint` has been removed. There is a new method: `getCartCostCenterEndpoint`.

###OccCheckoutDeliveryAdapter
Lib: @spartacus/checkout
Class: OccCheckoutDeliveryAdapter
Change: Protected method`getCartEndpoint` has been removed. There are new methods: `deliveryAddressesEndpoint`, `setDeliveryAddressEndpoint`, `getDeliveryModeEndpoint`, `getDeliveryModesEndpoint`.

###OccCheckoutPaymentTypeAdapter
Lib: @spartacus/checkout
Class: OccCheckoutPaymentTypeAdapter
Change: Protected method`getCartEndpoint` has been removed. There are new methods: `getPaymentTypesEndpoint`, `getCartPaymentTypeEndpoint`.

###OccCheckoutPaymentAdapter
Lib: @spartacus/checkout
Class: OccCheckoutPaymentAdapter
Change: Protected method`getCartEndpoint` has been removed. There are new methods: `getPaymentDetailsEndpoint`, `getPaymentProviderRequestEndpoint`, `getPaymentProviderResponseEndpoint`, `getCardTypesEndpoint`.
...
Lib: @spartacus/checkout
Class: OccCheckoutPaymentAdapter
Change: Protected method`getCartEndpoint` has been removed. There are new methods: `getPlaceOrderEndpoint`, `getDeliveryAddressesEndpoint`, `getDeliveryModeEndpoint`, `getLoadCheckoutDetailsEndpoint`.
