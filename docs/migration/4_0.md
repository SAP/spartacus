...
- `ClearCheckoutService` is now required parameter in component constructor.
- Method `resetCheckoutProcesses` was removed, use method `resetCheckoutProcesses` from `ClearCheckoutService` instead.
