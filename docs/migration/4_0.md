...
#### div[class.cx-total]` element has been chanted to `h4[class.cx-total]`
...
#### BreadcrumbComponent
- `isNotNullable`, `filter` import was removed 
- `PageTitleComponent` import was added
- `BreadcrumbComponent` extends `PageTitleComponent`
- `setTitle()` function was moved to `PageTitleComponent`
