...
- Class now implements `OnDestroy` interface.
- Subject `reviewsTabAvailable` has been renamed to "isReviewsTabAvailable$".
- Private method `getReviewsComponent` has been removed.
- Class has new protected method `observeOnTabMutations`.