...
- Wrapper for entire dialog `<div #dialog>` has been removed. Instead all modal content was wrapped inside `<ng-container>`, `<div class="cx-modal-container">` and `<div class="cx-modal-content">` tags
