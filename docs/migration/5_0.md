...
- For security improvement, html sanitizer has been removed from `JsonLdScriptFactory`, now replaced by html characters escape. It impacts `JsonLdDirective` and `StructuredDataFactory`.
