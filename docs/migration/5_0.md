...
- `<div class="cx-configurator-tab-bar-component">` was added to the view, wrapping the component implementation. This allows for disabling the components'
  styling in case it is not rendered
