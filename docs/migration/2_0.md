...
- `CreateCart` now extends `EntityLoadAction` for `MULTI_CART_DATA`.
- `CreateCartFail` now extends `EntityFailAction` for `MULTI_CART_DATA`.
- `CreateCartSuccess` now extends `EntitySuccessAction` for `MULTI_CART_DATA`.
- `CartAddEntry` now extends `EntityProcessesIncrementAction` for `MULTI_CART_DATA`.
- `CartAddEntrySuccess` now extends `EntityProcessesDecrementAction` for `MULTI_CART_DATA`.
- `CartAddEntryFail` now extends `EntityProcessesDecrementAction` for `MULTI_CART_DATA`.
- `CartRemoveEntry` now extends `EntityProcessesIncrementAction` for `MULTI_CART_DATA`.
- `CartRemoveEntrySuccess` now extends `EntityProcessesDecrementAction` for `MULTI_CART_DATA`.
- `CartRemoveEntryFail` now extends `EntityProcessesDecrementAction` for `MULTI_CART_DATA`.
- `CartUpdateEntry` now extends `EntityProcessesIncrementAction` for `MULTI_CART_DATA`.
- `CartUpdateEntrySuccess` now extends `EntityProcessesDecrementAction` for `MULTI_CART_DATA`.
- `CartUpdateEntryFail` now extends `EntityProcessesDecrementAction` for `MULTI_CART_DATA`.
- `CartRemoveVoucherEntry` now extends `EntityProcessesIncrementAction` for `MULTI_CART_DATA`.
- `CartRemoveVoucherEntrySuccess` now extends `EntityProcessesDecrementAction` for `MULTI_CART_DATA`.
- `CartRemoveVoucherEntryFail` now extends `EntityProcessesDecrementAction` for `MULTI_CART_DATA`.
