...
Support for declared variables dropped: `cards`, `goTo`, `setAddress`, `setAddressSub`, `selectedAddressSub`, `checkoutStepUrlNext`, `checkoutStepUrlPrevious`, `selectedAddress`
Support for functions dropped: `addressSelected`, `back`, `next`, `addNewAddress`, `ngOnDestroy`
