...
Preciously config validator logic was part of ConfigModule. If you are not using `StorefrontFoundationModule` or any of its descendants, it's required to import `ConfigValidatorsModule.forRoot()` in order to make config validators run.   
