...
| `CartDetailsComponent.getAllPromotionsForCart` method removed | Use `PromotionService` | `PromotionService` is not the main promotion data source. Whenever you need promotions information you should use this service. |
...
| `CartItemComponent.potentialProductPromotions` input removed | Use `PromotionService` | `PromotionService` is not the main promotion data source. Whenever you need promotions information you should use this service. |
