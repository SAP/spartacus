...
- Remove the previous migration scripts from the core-libs/schematics/src/migrations/x_0 directory. Also, remove the references to the removed migration scripts from the core-libs/schematics/src/migrations/migrations.json
