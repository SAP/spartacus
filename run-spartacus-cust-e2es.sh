...
CYPRESS_B2B_OTP_FOLDER="$CYPRESS_ROOT_FOLDER/b2b/regression/user_registration"
...
export E2ES_TO_RUN="$CYPRESS_OTP_FOLDER/otp*.e2e-flaky.cy.ts,$CYPRESS_B2B_OTP_FOLDER/b2b-otp*.e2e-flaky.cy.ts"
