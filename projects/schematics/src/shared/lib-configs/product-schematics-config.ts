...
export const PRODUCT_VARIANTS_MULTIDIMENSIONAL_SCHEMATICS_CONFIG: SchematicConfig =
  {
    library: {
      featureName: VARIANTS_MULTIDIMENSIONAL_FEATURE_NAME_CONSTANT,
      mainScope: SPARTACUS_PRODUCT,
      featureScope: SPARTACUS_VARIANTS_MULTIDIMENSIONAL,
    },
    folderName: PRODUCT_FOLDER_NAME,
    moduleName: VARIANTS_MULTIDIMENSIONAL_MODULE_NAME,
    featureModule: {
      name: VARIANTS_MULTIDIMENSIONAL_MODULE_NAME,
