...
export const SPARTACUS_CHECKOUT_B2B_OCC = `${SPARTACUS_CHECKOUT}/occ`;
export const SPARTACUS_CHECKOUT_B2B_CORE = `${SPARTACUS_CHECKOUT}/core`;
export const SPARTACUS_CHECKOUT_B2B_ROOT = `${SPARTACUS_CHECKOUT}/root`;
export const SPARTACUS_CHECKOUT_B2B_COMPONENTS = `${SPARTACUS_CHECKOUT}/components`;
...
export const SPARTACUS_CHECKOUT_SCHEDULED_REPLENISHMENT_OCC = `${SPARTACUS_CHECKOUT}/occ`;
export const SPARTACUS_CHECKOUT_SCHEDULED_REPLENISHMENT_CORE = `${SPARTACUS_CHECKOUT}/core`;
export const SPARTACUS_CHECKOUT_SCHEDULED_REPLENISHMENT_ROOT = `${SPARTACUS_CHECKOUT}/root`;
export const SPARTACUS_CHECKOUT_SCHEDULED_REPLENISHMENT_COMPONENTS = `${SPARTACUS_CHECKOUT}/components`;
