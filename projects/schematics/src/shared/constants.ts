...
export const KEY_VALUE_DIFFERS = 'KeyValueDiffers';
...
export const ACTIVE_CART_FACADE = 'ActiveCartFacade';
...
export const MYACCOUNT_VIEW_NAME_MODULE = 'MyaccountViewNameModule';
