...
export const CLI_PRODUCT_VARIANTS_MULTIDIMENSIONAL_FEATURE =
  'Product-Variants-Multidimensional';
...
export const VARIANTS_MULTIDIMENSIONAL_MODULE =
  'ProductVariantsMultidimensionalModule';
export const VARIANTS_MULTIDIMENSIONAL_ROOT_MODULE =
  'ProductVariantsMultidimensionalRootModule';
