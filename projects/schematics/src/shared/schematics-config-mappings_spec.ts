...
import {
  ...
  DIGITAL_PAYMENTS_FEATURE_NAME, ORDER_DOCUMENT_FLOW_FEATURE_NAME,
  ORDER_FEATURE_NAME,
  S4OM_FEATURE_NAME,
  SPARTACUS_ASM,
  SPARTACUS_CDC,
...
describe('schematics-config-mappings', () => {
  describe('libraryFeatureMapping', () => {
    it('should generate a correct mapping', () => {
      ...
      expect(result.get(SPARTACUS_ORDER)).toEqual([ORDER_FEATURE_NAME, ORDER_DOCUMENT_FLOW_FEATURE_NAME]);
