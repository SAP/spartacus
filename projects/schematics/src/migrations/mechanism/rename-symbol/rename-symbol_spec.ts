...
const PREVIOUS_IMPORT = `import { StoreFinderMapComponent } from '@spartacus/storefront'`;
const NEW_IMPORT = `import { StoreFinderMapComponent } from '@spartacus/storefinder/components'`;
