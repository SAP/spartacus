...
export const REMOVED_PUBLIC_API_DATA: DeprecatedNode[] = [
  ...
  {
    node: BUDGET_ROUTING_CONFIG,
    importPath: SPARTACUS_ORGANIZATION_ADMINISTRATION_COMPONENTS,
    comment: `${BUDGET_ROUTING_CONFIG} was removed from the public API. No replacement.`,
  },
  {
    node: COST_CENTER_ROUTING_CONFIG,
    importPath: SPARTACUS_ORGANIZATION_ADMINISTRATION_COMPONENTS,
    comment: `${COST_CENTER_ROUTING_CONFIG} was removed from the public API. No replacement.`,
  },
  {
    node: PERMISSION_ROUTING_CONFIG,
    importPath: SPARTACUS_ORGANIZATION_ADMINISTRATION_COMPONENTS,
    comment: `${PERMISSION_ROUTING_CONFIG} was removed from the public API. No replacement.`,
  },
  {
    node: UNITS_ROUTING_CONFIG,
    importPath: SPARTACUS_ORGANIZATION_ADMINISTRATION_COMPONENTS,
    comment: `${UNITS_ROUTING_CONFIG} was removed from the public API. No replacement.`,
  },
  {
    node: USER_GROUP_ROUTING_CONFIG,
    importPath: SPARTACUS_ORGANIZATION_ADMINISTRATION_COMPONENTS,
    comment: `${USER_GROUP_ROUTING_CONFIG} was removed from the public API. No replacement.`,
  },
  {
    node: USER_ROUTING_CONFIG,
    importPath: SPARTACUS_ORGANIZATION_ADMINISTRATION_COMPONENTS,
    comment: `${USER_ROUTING_CONFIG} was removed from the public API. No replacement.`,
  },
];
