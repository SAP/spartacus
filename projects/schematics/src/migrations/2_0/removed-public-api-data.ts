...
export const REMOVED_PUBLIC_API_DATA: DeprecatedNode[] = [
  ...
  // projects/core/src/cart/store/cart-state.ts
  {
    ...
    importPath: SPARTACUS_CORE,
    comment: `'${CART_DATA_CONST}' along with rest of the 'cart' state was removed. Instead use 'carts' state.`,
  },
  // projects/core/src/cart/store/cart-state.ts
  {
    node: STATE_WITH_CART,
    importPath: SPARTACUS_CORE,
    comment: `'${STATE_WITH_CART}' along with rest of the 'cart' state was removed. Instead use 'carts' state.`,
  },
  // projects/core/src/cart/store/cart-state.ts
  {
    node: CARTS_STATE,
    importPath: SPARTACUS_CORE,
    comment: `'${CARTS_STATE}' along with rest of the 'cart' state was removed. Instead use 'carts' state.`,
  },
  // projects/core/src/cart/store/cart-state.ts
  {
    node: CART_FEATURE_CONST,
    importPath: SPARTACUS_CORE,
    comment: `'${CART_FEATURE_CONST}' along with rest of the 'cart' state was removed. Instead use 'carts' state.`,
  },
  // projects/core/src/cart/store/cart-state.ts
  {
    node: CART_STATE,
    importPath: SPARTACUS_CORE,
    comment: `'${CART_STATE}' along with rest of the 'cart' state was removed. Instead use 'carts' state.`,
  },
];
