import { MethodPropertyDeprecation } from 'projects/schematics/src/shared/utils/file-utils';
...
export const CART_LIB_AND_CHECKOUT_MIGRATION: MethodPropertyDeprecation[] = [
  ...
  },
  {
    ...
    comment:
      '// TODO:Spartacus - Property "checkoutService" was removed from Class "CheckoutPaymentService". ',
  },
  {
    class: 'CheckoutPaymentService',
    importPath: '@spartacus/checkout/core',
  ...
  },
  {
    ...
    deprecatedNode: 'orderFacade',
    comment:
      '// TODO:Spartacus - Property "orderFacade" was removed from Class "ConfiguratorAddToCartButtonComponent". ',
  },
  {
  ...
  },
  {
    ...
    comment:
      '// TODO:Spartacus - Constructor "constructor" was removed from Class "AddToCartComponent". ',
  },
  {
    class: 'AddToCartComponent',
    importPath: '@spartacus/storefront',
