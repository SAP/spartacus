...
describe('UrlTranslatorService', () => {
  ...
  describe('translate', () => {
    it('should recognize nested routes names when first argument is a string url', () => {
      spyOn(routesService, 'getNestedRoutesTranslations').and.returnValue(null);
    ...
    function test_translate({
      ...
      expect(service.translate(nestedRoutesNames, nestedRoutesParams)).toEqual(
        expectedResult
      );
    }
