...
> = createSelector(getUserState, (state: UserState) => state.replenishmetOrders);

export const getReplenishmentOrdersLoaded: MemoizedSelector<
    StateWithUser,
    boolean
> = createSelector(getReplenishmentOrdersState, (state: LoaderState<ReplenishmentOrderList>) =>
