...
/**
 * @deprecated since 4.2 - use getReducersTransitional_4_1 with order lib instead
 */
...
/**
 * @deprecated since 4.2 - use reducerTransitional_4_1_Provider with order lib instead
 */
