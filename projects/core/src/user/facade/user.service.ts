...
export class UserService {
   ...
   */
  load(): void {
    this.store.dispatch(new UserActions.LoadUserDetails(OCC_USERID_CURRENT));
  }
   ...
   */
  remove(): void {
    this.store.dispatch(new UserActions.RemoveUser(OCC_USERID_CURRENT));
  }
