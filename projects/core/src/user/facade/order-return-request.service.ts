...
/**
 * @deprecated since 4.1 - use OrderReturnFacade in @spartacus/order/root instead
 * TODO: processStateStore is added in OrderReturnFacade's constructor, need to update it in 5.0 migration doc.
 */
@Injectable({
  providedIn: 'root',
})
