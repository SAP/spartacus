...
import { StateWithMultiCart, NewCartState, MultiCartState, MULTI_CART_FEATURE } from '../cart-state';
...
export const getCartEntitySelectorFactory = (
  ...
  return createSelector(
    ...
    (state: EntityLoaderState<NewCartState>) => entityStateSelector(state, cartId)
  )
}
...
export const getCartSelectorFactory = (
  ...
  return createSelector(
    getMultiCartsEntities,
    (state: EntityLoaderState<NewCartState>) => entityValueSelector(state, cartId)
  )
}
...
export const getCartEntriesSelectorFactory = (
  ...
  return createSelector(
    getMultiCartsEntities,
    (state: EntityLoaderState<NewCartState>) => entityValueSelector(state, cartId).content.entries
  )
}
...
export const getCartEntrySelectorFactory = (
  ...
  return createSelector(
    getMultiCartsEntities,
    (state: EntityLoaderState<NewCartState>) => entityValueSelector(state, cartId).content.entries.find(entry => entry.product.code === productCode)
  )
}
