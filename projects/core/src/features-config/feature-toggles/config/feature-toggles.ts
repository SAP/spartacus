...
export interface FeatureTogglesInterface {
  ...
  /**
   * When enabled, the 'ProductImageZoomDialogComponent' will be closed when the user presses the 'Esc' key.
   */
  a11yZoomDialogCloseOnEsc?: boolean;
...
export const defaultFeatureToggles: Required<FeatureTogglesInterface> = {
  ...
  a11yZoomDialogCloseOnEsc: false,
