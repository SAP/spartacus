...
import { Configurator, GenericConfigurator, TranslationService } from "@spartacus/core";
...
export class ConfigAttributeHeaderComponent {
  constructor(private uiKeyGen: ConfigUIKeyGeneratorService, protected translationService: TranslationService) {
  }
