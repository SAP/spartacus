...
describe('UnitUsersComponent', () => {
  let component: UnitUsersComponent;
  let fixture: ComponentFixture<UnitUsersComponent>;
  let orgUnitService: MockOrgUnitService;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule, InteractiveTableModule, I18nTestingModule],
      declarations: [UnitUsersComponent, MockUrlPipe, MockPaginationComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(UnitUsersComponent);
