...
import { MyAccountV2NotificationPreferenceComponent } from '../my-account-v2/my-account-v2-notification-preference/my-account-v2-notification-preference.component';
