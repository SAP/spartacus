...
context('Assisted Service Module', () => {
  describe('Customer Support Agent - Emulation', () => {
    ...
    it('should checkout as customer2', () => {
  ...
  describe('When a customer session and an asm agent session are both active', () => {
    ...
    it('Customer should not be able to login when there is an active CS agent session2.', () => {
    ...
    it.skip('agent login when user is logged in should start this user emulation s2', () => {});

    // TODO(#9445): Add e2e test for this scenario
    it.skip('agent logout when user was logged and emulated should restore the session s2', () => {});
  });
  ...
  describe('Apparel Site', () => {
    ...
    it.skip("should fetch products in a category based on the emulated user's authentication s2", () => {
      cy.cxConfig({
        context: {
