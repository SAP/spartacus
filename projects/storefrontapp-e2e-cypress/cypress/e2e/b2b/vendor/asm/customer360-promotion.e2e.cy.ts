  ...
  describe('B2B Asm Customer360 Promotion', () => {
    ...
    it('should be able to sent customer coupon for customer coupon (CXSPA-3945)', () => {
      interceptPost(
        ...
        '/users/*/customercoupons/claim?*' // check '/users/*/customercoupons/claim?*' instead when enable 'enableClaimCustomerCouponWithCodeInRequestBody' with the new Occ endpoint is available since Commerce 2211.28
      );
      cy.get('.cx-asm-customer-360-promotion-listing-row')
