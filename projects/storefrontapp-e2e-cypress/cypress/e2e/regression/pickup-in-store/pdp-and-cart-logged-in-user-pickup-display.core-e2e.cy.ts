...
describe('Pickup Delivery Option - A logged in user which checkout with BOPIS', () => {
  viewportContext(['desktop'], () => {
    ...
    it("User has not selected a store for the product to be picked up from previously and doesn't have a preferred store. The user is on the PDP page. Don't display an elected pickup store", () => {
      /*
    GIVEN
    The user has not selected a store for the product to be picked up from previously and doesn't have a preferred store
    WHEN
