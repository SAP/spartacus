...
import { clearCacheTestIsolationForEach } from '../../../helpers/utils-cypress-legacy';
import { viewportContext } from '../../../helpers/viewport-context';
import { clearAllStorage } from '../../../support/utils/clear-all-storage';

context('Cart Import/Export', { testIsolation: false }, () => {
  viewportContext(['mobile', 'desktop'], () => {
    clearCacheTestIsolationForEach();
    beforeEach(() => {
      clearAllStorage();
    });
    ...
    describe('Multiple products', { testIsolation: false }, () => {
    ...
    describe(
      'Multiple products with varied quantities',
      { testIsolation: false },
      () => {
    ...
    describe(
      'Normal products with configurable products',
      { testIsolation: false },
      () => {
        const EXPECTED_CSV = `Code,Quantity,Name,Price\r\n1934793,1,PowerShot A480,$99.85\r\n1934793,1,PowerShot A480,$99.85\r\n1934793,1,PowerShot A480,$99.85\r\n300938,3,Photosmart E317 Digital Camera,$342.36\r\n`;
        clearCacheTestIsolationForEach();
    ...
    describe(
      'Non-default export configuration',
      { testIsolation: false },
      () => {
    ...
    xdescribe('Configurable products', { testIsolation: false }, () => {
      clearCacheTestIsolationForEach();
    ...
    describe('Malformed CSVs', { testIsolation: false }, () => {
      clearCacheTestIsolationForEach();
