...
import { interceptOrdersEndpoint, waitForResponse } from "../../../helpers/order-history";
import * as s4omHelper from "../../../helpers/vendor/s4om/s4om";
import { b2bAccountShipToUser, ORDER_REQUEST_ENDPOINT, order_type, poNumber, POWERTOOLS_BASESITE, USER_REQUEST_ENDPOINT } from "../../../sample-data/b2b-checkout";
...
describe('S4HANA Order management', () => {
    ...
    describe('Schedule Lines in Checkout Flow', () => {
        ...
        it('should add a S4 HANA product (TG-11) to cart', () => {
            s4omHelper.resetCart();
            s4omHelper.addB2bS4ProductToCart();
        });
