...
describe('Payment Methods', () => {
  viewportContext(['mobile', 'desktop'], () => {
    ...
    describe('Authenticated user', () => {
      ...
      it(
        ['payment_method', 'my_account'],
        'should validate payment methods core',
        () => {
      ...
      it(
        ['payment_method', 'my_account'],
        'should render page with two payment methods',
        () => {
      ...
      it(
        ['payment_method', 'my_account'],
        'should set additional payment method as default',
        () => {
          cy.intercept({
            method: 'GET',
      ...
      it(
        ['payment_method', 'my_account'],
        'should be able to delete payment method',
        () => {
