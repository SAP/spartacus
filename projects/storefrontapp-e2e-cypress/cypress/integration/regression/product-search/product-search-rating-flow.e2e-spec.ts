<<<<<<< HEAD:projects/storefrontapp-e2e-cypress/cypress/integration/product-search-rating-flow.e2e-spec.ts
import { PRODUCT_LISTING } from '../helpers/data-configuration';
=======
import { PRODUCT_LISTING } from '../../../helpers/data-configuration';
>>>>>>> develop:projects/storefrontapp-e2e-cypress/cypress/integration/regression/product-search/product-search-rating-flow.e2e-spec.ts
