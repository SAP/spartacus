...
context('Product search', () => {
  viewportContext(['mobile', 'desktop'], () => {
    ...
    describe('Pagination', () => {
      it(
        ['product_search', 'smoke_b2c'],
        'should navigate to the next page and display results',
        () => {
      ...
      it(
        ['product_search'],
        'should be able navigate to the specified page number and display results',
        () => {
      ...
      it(
        ['product_search'],
        'should navigate to the previous page and display results',
        () => {
    ...
    describe('product list view mode', () => {
      it(
        ['product_search', 'smoke_b2c'],
        'should be able to switch to grid mode',
        () => {
    ...
    describe('Facets', () => {
      it(
        ['product_search'],
        'should filter results using facet filtering',
        () => {
    ...
    describe('Sorting', () => {
      ...
      it(
        ['product_search', 'smoke_b2c'],
        'should be able to sort by lowest price',
        () => {
      ...
      it(
        ['product_search', 'smoke_b2c'],
        'should be able to sort by highest price',
        () => {
      ...
      it(
        ['product_search'],
        'should be able to sort by name descending',
        () => {
