...
let orderList = {
  "orders" : [
  {
     ...
     "orgCustomer" : {
        ...
        "roles" : [ "b2badmingroup", "b2bapprovergroup", "b2bmanagergroup", "b2bcustomergroup" ],
        "selected" : false,
        "title" : "Mr.",
        "titleCode" : "0002"
     },
...
export const SERVICABLE_ORDER_IN_24HRS_DETAILS = generateServicableOrderWithin24Hours();
