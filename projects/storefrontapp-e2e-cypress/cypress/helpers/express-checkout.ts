...
export function testExpressCheckout() {
  it(
    ['express_checkout'],
    'should go to first step of checkout when there is no default address/payment',
    () => {
  ...
  it(
    ['express_checkout'],
    'should skip address and payment checkout steps once address and payment are set',
    () => {
  ...
  it(
    ['express_checkout'],
    'should setup express checkout with another preferred delivery mode',
    () => {
      cy.cxConfig({
        checkout: {
          express: true,
