...
export const orderHistoryTest = {
  ...
  checkIfOrderIsDisplayed() {
    it(['order_history', 'smoke'], 'should display placed order in Order History', () => {
      doPlaceOrder().then(() => {
  ...
  checkSortingByCode() {
    it(['order_history', 'smoke'], 'should sort the orders table by given code', () => {
  ...
  checkCorrectDateFormat() {
    it(['order_history', 'smoke'], 'should show correct date format', () => {
  ...
  checkOrderDetailsUnconsignedEntries() {
    it(['order_history', 'smoke'], 'should display order details page with unconsigned entries', () => {
      doPlaceOrder().then((orderData: any) => {
