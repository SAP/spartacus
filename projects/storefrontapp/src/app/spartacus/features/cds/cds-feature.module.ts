...
const cds1: CdsConfig = {
  cds: {
    ...
    profileTag: {
      javascriptUrl: 'E_SPA_JS_URL',
      configUrl: 'E_SPA_CONFIG_URL',
...
const cds2 = {
  cds: {
    ...
    profileTag: {
      javascriptUrl: 'A_SPA_JS_URL',
      configUrl: 'A_SPA_CONFIG_URL',
      allowInsecureCookies: true,
    },
  },
};
...
@NgModule({
  ...
  providers: [provideConfigFactory(cdsConfig, [WindowRef])],
})
