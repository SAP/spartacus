...
- TODOs in:
- events:
  - where to handle (currently in feature-libs/checkout/root/events/checkout-delivery-address-event.listener.ts)
...
- where to handle (currently in feature-libs/checkout/root/events/checkout-delivery-mode-event.listener.ts)
...
- where to handle (currently in feature-libs/checkout/b2b/root/events/checkout-cost-center-event.listener.ts)
...
-feature-libs/checkout/b2b/root/events/checkout-payment-type-event.listener.ts

- feature-libs/checkout/core/facade/checkout-delivery-address.service.ts's events to the listener
...
- extending enum - feature-libs/checkout/root/model/checkout-step.model.ts
