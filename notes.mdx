...
- getCurrentOrderType? Can we check that based on order content?

# Next session

- schedule replenishment order
- remove process for order
- remove orderDetails from ngrx state
- set cost center command
- get cost center with super query (extending super query for b2b)
- payment types query
- set payment type command
- get payment type with super query
- get po number with super query
- order confirmation page handling with super query
