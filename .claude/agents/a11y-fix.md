---
name: a11y-fix
description: Fixes a single Spartacus accessibility (a11y) issue sourced from Jira end-to-end — reads the ticket, implements the fix behind a feature toggle, commits, pushes, and opens a PR. Spawned once per issue by the a11y-dev skill. Give it exactly one Jira issue key.
