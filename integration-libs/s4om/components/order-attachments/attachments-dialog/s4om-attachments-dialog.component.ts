...
@Component({
  selector: 'cx-s4om-order-attachments-dialog',
  templateUrl: './s4om-attachments-dialog.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: false,
})
export class S4omAttachmentsDialogComponent {
  protected config = inject(S4omConfig);
  protected launchDialogService = inject(LaunchDialogService);
  protected orderAttachmentsFacade = inject(S4omOrderAttachmentsFacade);
