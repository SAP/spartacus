...
describe('S4omOrderDetailAttachmentsComponent', () => {
  let component: S4omOrderDetailAttachmentsComponent;
  let fixture: ComponentFixture<S4omOrderDetailAttachmentsComponent>;
  let orderDetailsService: OrderDetailsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [I18nTestingModule],
      declarations: [S4omOrderDetailAttachmentsComponent],
      providers: [
        {
    ...
    fixture = TestBed.createComponent(S4omOrderDetailAttachmentsComponent);
