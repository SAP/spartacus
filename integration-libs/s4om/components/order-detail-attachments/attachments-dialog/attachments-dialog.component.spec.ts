...
const MOCK_MIME_TYPE_CONFIG: S4OMOrderAttachmentsPreviewMimeTypesConfig = {
  previewMimeTypes: [
    pdfMimeType,
  ],
};
...
describe('AttachmentsDialogComponent', () => {
  ...
  beforeEach(() => {
    const orderAttachmentsFacadeSpy =
      jasmine.createSpyObj('OrderAttachmentsFacade', ['getOrderAttachments', 'getOrderAttachment']);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: MOCK_MIME_TYPE_CONFIG,
        },
      ],
    }).compileComponents();
    fixture = TestBed.createComponent(AttachmentsDialogComponent);
    component = fixture.componentInstance;
    orderAttachmentsFacade = TestBed.inject(OrderAttachmentsFacade) as jasmine.SpyObj<OrderAttachmentsFacade>;
  ...
  describe('initialization', () => {
    beforeEach(() => {
      spyOn(component, 'initializeOrderCode').and.stub();
      spyOn(component, 'initializeAttachments').and.stub();
      spyOn(component, 'initializeAttachmentsCount').and.stub();

      component.ngOnInit();
    });

    it('should call initializeOrderCode', () => {
      expect(component.initializeAttachments).toHaveBeenCalled();
    });

    it('should call initializeAttachments', () => {
      expect(component.initializeAttachments).toHaveBeenCalled();
    });

    it('should call initializeAttachmentsCount', () => {
      expect(component.initializeAttachmentsCount).toHaveBeenCalled();
    });

  });

  describe('observables', () => {
    it('should return correct order code', () => {
      component.initializeOrderCode();
    ...
    it('should return attachments array', () => {
      ...
      component.initializeAttachments();
    ...
    it('should return correct attachments count', () => {
      component.attachments$ = of(attachmentsData.attachments ?? []);
      component.initializeAttachmentsCount();
    ...
    it('should return empty attachment array on error', () => {
    ...
    it('should emit true from error$ when attachment fetch fails', () => {
      orderAttachmentsFacade.getOrderAttachments.and.returnValue(throwError(() => 'mockError'));
      ...
      component.orderCode$ = of(attachmentId);
      component.initializeAttachments();
      component.attachments$.subscribe().unsubscribe();
  ...
  describe('Attachments handling', () => {
    it('should openOrderAttachment correctly update loadingAttachments array', fakeAsync(() => {
      orderAttachmentsFacade.getOrderAttachment.and.returnValue(of(configuredMimeTypeBlob).pipe(delay(1000)));
    ...
    it('should openOrderAttachment correctly update loadingAttachments array on error', fakeAsync(() => {
      orderAttachmentsFacade.getOrderAttachment.and.returnValue(
        timer(1000).pipe(
    ...
    it('should preview attachments if mime type is configured', () => {
      orderAttachmentsFacade.getOrderAttachment.and.returnValue(of(configuredMimeTypeBlob));
      spyOn(component, 'previewFile').and.stub();
      spyOn(component, 'downloadFile').and.stub();
      component.ngOnInit();
    ...
    it('should download attachments if mime type is NOT configured', () => {
      ...
      spyOn(component, 'previewFile').and.stub();
      spyOn(component, 'downloadFile').and.stub();
      orderAttachmentsFacade.getOrderAttachment.and.returnValue(of(notConfiguredMimeTypeBlob));
