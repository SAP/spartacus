...
// Use the latest long term support version of UI5.
// Synchronize this with the version of the @sapui5/ts-types in the package.json
export const EPD_VISUALIZATION_UI5_VERSION = '1.96.0';
