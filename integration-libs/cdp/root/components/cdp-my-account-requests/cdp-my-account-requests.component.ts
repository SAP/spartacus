...
@Component({
  ...
  templateUrl: './cdp-my-account-requests.component.html',
  styleUrls: ['./cdp-my-account-requests.component.scss'],
  // styleUrls: ['./cdp-my-account.component.scss'],
  providers: [CxDatePipe,CdpOrderService],
})

  export class CdpMyAccountRequestsComponent implements OnInit {
    constructor(
