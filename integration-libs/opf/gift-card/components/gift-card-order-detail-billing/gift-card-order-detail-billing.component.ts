...
@Component({
  selector: 'cx-gift-card-order-detail-billing',
  templateUrl: './gift-card-order-detail-billing.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [NgIf, CardComponent, AsyncPipe, CommonModule, TranslatePipe],
  standalone: true,
})
export class GiftCardOrderDetailBillingComponent implements OnInit, OnDestroy {
