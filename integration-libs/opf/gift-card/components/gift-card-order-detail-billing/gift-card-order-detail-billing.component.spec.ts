...
import { GiftCardOrderDetailBillingComponent } from './gift-card-order-detail-billing.component';
import { Order } from '@spartacus/order/root';
import { TranslationService } from '@spartacus/core';

describe('GiftCardOrderDetailBillingComponent', () => {
  let component: GiftCardOrderDetailBillingComponent;
  let fixture: ComponentFixture<GiftCardOrderDetailBillingComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [GiftCardOrderDetailBillingComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(GiftCardOrderDetailBillingComponent);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle rapid succession of order updates', (done) => {
      ...
      const orders: unknown[] = [
        { code: 'order-201', sapGiftCardSummary: { totalAppliedAmount: { value: 10 }, totalBalance: { value: 50 }, totalRemainingBalance: { value: 40 }, giftCardsCoverFullAmount: false } },
        { code: 'order-202', sapGiftCardSummary: { totalAppliedAmount: { value: 20 }, totalBalance: { value: 50 }, totalRemainingBalance: { value: 30 }, giftCardsCoverFullAmount: false } },
        { code: 'order-203', sapGiftCardSummary: { totalAppliedAmount: { value: 30 }, totalBalance: { value: 50 }, totalRemainingBalance: { value: 20 }, giftCardsCoverFullAmount: false } },
      ];
