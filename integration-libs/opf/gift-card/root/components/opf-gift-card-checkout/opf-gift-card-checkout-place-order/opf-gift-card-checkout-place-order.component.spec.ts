...
import { OpfGiftCardCheckoutPlaceOrderComponent } from './opf-gift-card-checkout-place-order.component';
...
describe('OpfGiftCardCheckoutPlaceOrderComponent', () => {
  let component: OpfGiftCardCheckoutPlaceOrderComponent;
  let fixture: ComponentFixture<OpfGiftCardCheckoutPlaceOrderComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [I18nTestingModule, OpfGiftCardCheckoutPlaceOrderComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(OpfGiftCardCheckoutPlaceOrderComponent);
