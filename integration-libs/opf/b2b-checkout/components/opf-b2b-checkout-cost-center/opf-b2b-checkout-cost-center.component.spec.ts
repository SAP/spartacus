...
describe('OpfB2bCheckoutCostCenterComponent', () => {
  let component: OpfB2bCheckoutCostCenterComponent;
  let fixture: ComponentFixture<OpfB2bCheckoutCostCenterComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(OpfB2bCheckoutCostCenterComponent);
