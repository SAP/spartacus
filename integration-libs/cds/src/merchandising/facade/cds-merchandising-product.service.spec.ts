...
class SearchContextServiceStub { // PR15712
...
describe('CdsMerchandisingProductService', () => {
  ...
  describe('CdsMerchandisingProductService with SearchContextService', () => { // PR15712
    ...
    it('loadProductsForStrategy should call connector', () => {
      ...
      const userContext: MerchandisingUserContext = { // PR15712
        category: '574',
      };
    ...
    it('loadProductsForStrategy should call connector and pass in the consent-reference as a header', () => { // PR15712
      const strategyRequest = {
        queryParams: {
          site: 'electronics-spa',
          language: 'en',
    ...
    it('loadProductsForStrategy should call connector and pass the seach phrase as a query param', () => {
      ...
      spyOn(siteContextService, 'getSiteContext').and.returnValue( // PR15712
        of(siteContext)
      );
      spyOn(userContextService, 'getUserContext').and.returnValue(
        of(userContext)
  ...
  describe('CdsMerchandisingProductService without SearchContextService', () => { // PR15712
    beforeEach(() => {
      TestBed.configureTestingModule({
        providers: [
          {
