...
export declare abstract class MerchandisingStrategyAdapter {
    /**
     ...
     */
    abstract loadProductsForStrategy(strategyId: string, strategyRequest?: StrategyRequest): Observable<StrategyProducts>;
}
