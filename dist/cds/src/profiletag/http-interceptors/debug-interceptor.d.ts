...
export declare class DebugInterceptor implements HttpInterceptor {
    ...
    private isOccUrl;
    static ɵfac: i0.ɵɵFactoryDeclaration<DebugInterceptor, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<DebugInterceptor>;
}
