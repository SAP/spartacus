...
class CdsEndpointsService {
    ...
    getUrl(endpoint, urlParams = {}, queryParams) {
        var _a, _b;
        if ((_b = (_a = this.cdsConfig) === null || _a === void 0 ? void 0 : _a.cds) === null || _b === void 0 ? void 0 : _b.endpoints[endpoint]) {
...
class MerchandisingCarouselViewedEvent {
    constructor(carouselEvent, productSkus) {
        ...
        this.data = Object.assign(Object.assign({}, carouselEvent), { productSkus });
    }
}
class MerchandisingCarouselClickedEvent {
    constructor(carouselEvent, slotId, sku, imageUrl) {
        this.name = 'CarouselClicked';
        this.data = Object.assign(Object.assign({}, carouselEvent), { slotId,
            sku,
            imageUrl });
    }
}
...
class ProfileTagEventService {
    ...
    setConsentReferenceFromLocalStorage() {
        if (this.winRef.isBrowser() && this.winRef.localStorage) {
            ...
            this.subscription.add(this.baseSiteService
                ...
                .subscribe((baseSite) => {
                var _a;
                this.latestConsentReference = new BehaviorSubject((_a = profileTagMetadata.cr[`${baseSite}-consentReference`]) === null || _a === void 0 ? void 0 : _a.consentReference);
            }));
        }
    }
    getProfileTagEvents() {
    ...
    createConfig(siteId) {
        const newConfig = Object.assign(Object.assign({}, this.config.cds.profileTag), { tenant: this.config.cds.tenant, siteId, spa: true });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ProfileTagEventService, decorators: [{
        ...
        return [{ type: i1.WindowRef }, { type: CdsConfig }, { type: i1.BaseSiteService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [PLATFORM_ID]
                    }] }];
    } });
...
class ProfileTagLifecycleService {
    ...
    consentChanged() {
        ...
        return this.consentService
            .getConsent((_b = (_a = this.config.cds) === null || _a === void 0 ? void 0 : _a.consentTemplateId) !== null && _b !== void 0 ? _b : '')
...
class ProfileTagPushEventsService {
    ...
    getPushEvents() {
        return this.pushEvents$.pipe(withLatestFrom(merge(of({ segments: undefined, actions: undefined }), this.personalizationContextService.getPersonalizationContext())), map(([item, personalizationContext]) => {
            ...
            item.data.segments = personalizationContext === null || personalizationContext === void 0 ? void 0 : personalizationContext.segments;
            item.data.actions = personalizationContext === null || personalizationContext === void 0 ? void 0 : personalizationContext.actions;
            return item;
        }));
    }
    /**
...
class CdsMerchandisingUserContextService {
    ...
    getUserContext() {
        return combineLatest([
            ...
            const result = Object.assign(Object.assign({}, consentContext), pageContext);
    ...
    getSearchContext() {
        return combineLatest([
            ...
            var _a;
            const facets = (_a = facetList === null || facetList === void 0 ? void 0 : facetList.activeFacets) === null || _a === void 0 ? void 0 : _a.map((facet) => `${facet.facetCode}:${facet.facetValueCode}`).join(':');
            return {
...
class CdsMerchandisingProductService {
    ...
    loadProductsForStrategy(strategyId, numberToDisplay) {
        return combineLatest([
            ...
            return {
                queryParams: Object.assign(Object.assign({}, siteContext), { products: userContext.products, category: userContext.category, facets: userContext.facets, searchPhrase: userContext.searchPhrase, pageSize: numberToDisplay }),
                headers: {
...
class MerchandisingCarouselComponentService {
    ...
    getMerchandisingCaourselViewportThreshold(cmsComponent) {
        var _a, _b, _c, _d, _e;
        const viewportPercentage = (_e = (_a = cmsComponent.viewportPercentage) !== null && _a !== void 0 ? _a : (_d = (_c = (_b = this.cdsConfig) === null || _b === void 0 ? void 0 : _b.cds) === null || _c === void 0 ? void 0 : _c.merchandising) === null || _d === void 0 ? void 0 : _d.defaultCarouselViewportThreshold) !== null && _e !== void 0 ? _e : DEFAULT_CAROUSEL_VIEWPORT_THRESHOLD;
    ...
    sendCarouselItemClickedEvent(merchandisingCarouselModel, clickedProduct) {
        var _a, _b;
        const carouselEvent = this.getCarouselEventFromCarouselModel(merchandisingCarouselModel);
        carouselEvent.metadata = Object.assign(Object.assign({}, carouselEvent.metadata), clickedProduct.metadata);
        this.profileTagEventService.notifyProfileTagOfEventOccurrence(new MerchandisingCarouselClickedEvent(carouselEvent, clickedProduct.metadata.slot, clickedProduct.code, (_b = (_a = clickedProduct.images) === null || _a === void 0 ? void 0 : _a.PRIMARY['product']) === null || _b === void 0 ? void 0 : _b.url));
    }
    getCarouselMetadata(strategyProducts, componentData) {
        var _a;
        const metadata = (_a = strategyProducts.metadata) !== null && _a !== void 0 ? _a : {};
    ...
    mapStrategyProductsToCarouselItems(strategyProducts) {
        return strategyProducts && strategyProducts.products
            ? strategyProducts.products.map((strategyProduct, index) => this.productService
                ...
                .pipe(map((product) => (Object.assign(Object.assign({}, product), { metadata: this.getCarouselItemMetadata(strategyProduct, index + 1) })))))
            : [EMPTY];
    }
    ...
    getCarouselItemMetadata(strategyProduct, index) {
        var _a;
        const metadata = (_a = strategyProduct.metadata) !== null && _a !== void 0 ? _a : {};
        metadata.slot = index;
