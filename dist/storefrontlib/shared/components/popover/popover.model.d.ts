export type PopoverPosition = 'auto' | 'top' | 'bottom' | 'left' | 'right' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' | 'left-top' | 'left-bottom' | 'right-top' | 'right-bottom';
export type PopoverPositionArray = PopoverPosition | Array<PopoverPosition> | string;
export declare enum PopoverEvent {
