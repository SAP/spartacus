...
class CheckoutConfigService {
    ...
    shouldUseAddressSavedInCart() {
        var _a, _b;
        return !!((_b = (_a = this.checkoutConfig) === null || _a === void 0 ? void 0 : _a.checkout) === null || _b === void 0 ? void 0 : _b.guestUseSavedAddress);
    }
...
class CheckoutStepService {
        ...
        this.activeStepIndex$ = this.routingService
            ...
            return this.steps$.pipe(map((steps) => {
                ...
                steps.forEach((step, index) => {
                    var _a, _b;
                    const routeUrl = `/${(_b = (_a = this.routingConfigService.getRouteConfig(step.routeName)) === null || _a === void 0 ? void 0 : _a.paths) === null || _b === void 0 ? void 0 : _b[0]}`;
    ...
    getStepUrlFromStepRoute(stepRoute) {
        var _a, _b, _c;
        return ((_c = (_b = (_a = this.routingConfigService.getRouteConfig(stepRoute)) === null || _a === void 0 ? void 0 : _a.paths) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : null);
    }
...
class ExpressCheckoutService {
    ...
    setDeliveryMode() {
        this.deliveryModeSet$ = combineLatest([
            ...
            return of([supportedDeliveryModesState]).pipe(filter(([supportedDeliveryModesStateObject]) => {
                var _a;
                return !supportedDeliveryModesStateObject.loading &&
                    !!((_a = supportedDeliveryModesStateObject.data) === null || _a === void 0 ? void 0 : _a.length);
...
class CheckoutDeliveryAddressComponent {
    ...
    get selectedAddress$() {
        return this.checkoutDeliveryAddressFacade.getDeliveryAddressState().pipe(filter((state) => !state.loading), map((state) => state.data), distinctUntilChanged((prev, curr) => (prev === null || prev === void 0 ? void 0 : prev.id) === (curr === null || curr === void 0 ? void 0 : curr.id)));
    }
    ...
    selectAddress(address) {
        var _a;
        if ((address === null || address === void 0 ? void 0 : address.id) === ((_a = getLastValueSync(this.selectedAddress$)) === null || _a === void 0 ? void 0 : _a.id)) {
            return;
        }
    ...
    createCards() {
        ...
        return combineLatest([addresses$, translations$]).pipe(tap(([[addresses, selected]]) => this.selectDefaultAddress(addresses, selected)), map(([[addresses, selected], [textDefault, textShipTo, textSelected, textPhone, textMobile],]) => addresses === null || addresses === void 0 ? void 0 : addresses.map((address) => ({
            address,
    ...
    shouldUseAddressSavedInCart() {
        var _a;
        return !!((_a = this.checkoutConfigService) === null || _a === void 0 ? void 0 : _a.shouldUseAddressSavedInCart());
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CheckoutDeliveryAddressComponent, decorators: [{
        ...
        return [{ type: i1$1.UserAddressService }, { type: i2.CheckoutDeliveryAddressFacade }, { type: i3.ActivatedRoute }, { type: i1$1.TranslationService }, { type: i1.ActiveCartFacade }, { type: CheckoutStepService }, { type: i2.CheckoutDeliveryModesFacade }, { type: i1$1.GlobalMessageService }, { type: CheckoutConfigService, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class CheckoutDeliveryModeComponent {
    ...
    constructor(fb, checkoutConfigService, activatedRoute, checkoutStepService, checkoutDeliveryModesFacade, activeCartFacade, globalMessageService) {
        ...
        this.selectedDeliveryModeCode$ = this.checkoutDeliveryModesFacade
            ...
            .pipe(filter((state) => !state.loading), map((state) => state.data), map((deliveryMode) => deliveryMode === null || deliveryMode === void 0 ? void 0 : deliveryMode.code));
        this.supportedDeliveryModes$ = this.checkoutDeliveryModesFacade
            .getSupportedDeliveryModes()
            .pipe(filter((deliveryModes) => !!(deliveryModes === null || deliveryModes === void 0 ? void 0 : deliveryModes.length)), withLatestFrom(this.selectedDeliveryModeCode$), tap(([deliveryModes, code]) => {
            if (!code ||
    ...
    onError() {
        var _a;
        (_a = this.globalMessageService) === null || _a === void 0 ? void 0 : _a.add({ key: 'setDeliveryMode.unknownError' }, GlobalMessageType.MSG_TYPE_ERROR);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CheckoutDeliveryModeComponent, decorators: [{
        ...
        return [{ type: i3$1.UntypedFormBuilder }, { type: CheckoutConfigService }, { type: i3.ActivatedRoute }, { type: CheckoutStepService }, { type: i2.CheckoutDeliveryModesFacade }, { type: i1.ActiveCartFacade }, { type: i1$1.GlobalMessageService, decorators: [{
                        type: Optional
                    }] }];
    } });
    ...
    canActivate() {
        return this.authService.isUserLoggedIn().pipe(map((isLoggedIn) => {
            ...
            if (isLoggedIn) {
                ...
                return this.router.parseUrl((_b = this.semanticPathService.get('cart')) !== null && _b !== void 0 ? _b : '');
            }
            return !isLoggedIn;
        }));
    }
...
class CheckoutGuard {
    constructor(router, routingConfigService, checkoutConfigService, expressCheckoutService, activeCartFacade, checkoutStepService) {
        ...
        this.firstStep$ = this.checkoutStepService.steps$.pipe(map((steps) => {
            var _a, _b;
            return this.router.parseUrl((_b = (_a = this.routingConfigService.getRouteConfig(steps[0].routeName)) === null || _a === void 0 ? void 0 : _a.paths) === null || _b === void 0 ? void 0 : _b[0]);
        }));
    }
    canActivate() {
        const expressCheckout$ = this.expressCheckoutService
            ...
            return expressCheckoutPossible && reviewOrderRoute
                ? of(this.router.parseUrl((_b = (_a = this.routingConfigService.getRouteConfig(reviewOrderRoute)) === null || _a === void 0 ? void 0 : _a.paths) === null || _b === void 0 ? void 0 : _b[0]))
                : this.firstStep$;
        }));
...
class CheckoutPaymentMethodComponent {
    ...
    get selectedMethod$() {
        return this.checkoutPaymentFacade.getPaymentDetailsState().pipe(filter((state) => !state.loading), map((state) => state.data), distinctUntilChanged((prev, curr) => (prev === null || prev === void 0 ? void 0 : prev.id) === (curr === null || curr === void 0 ? void 0 : curr.id)));
    }
    ...
    selectDefaultPaymentMethod(paymentMethods, selectedMethod) {
        if (!this.doneAutoSelect &&
            (paymentMethods === null || paymentMethods === void 0 ? void 0 : paymentMethods.length) &&
    ...
    selectPaymentMethod(paymentDetails) {
        var _a;
        if ((paymentDetails === null || paymentDetails === void 0 ? void 0 : paymentDetails.id) === ((_a = getLastValueSync(this.selectedMethod$)) === null || _a === void 0 ? void 0 : _a.id)) {
            return;
        }
        this.globalMessageService.add({
    ...
    setPaymentDetails({ paymentDetails, billingAddress, }) {
        ...
        details.billingAddress = billingAddress !== null && billingAddress !== void 0 ? billingAddress : this.deliveryAddress;
        this.busy$.next(true);
...
class CheckoutStepsSetGuard {
    ...
    canActivate(route) {
        ...
        return this.checkoutStepService.steps$.pipe(take(1), switchMap((steps) => {
            currentIndex = steps.findIndex((step) => {
                var _a, _b;
                const stepRouteUrl = `/${(_b = (_a = this.routingConfigService.getRouteConfig(step.routeName)) === null || _a === void 0 ? void 0 : _a.paths) === null || _b === void 0 ? void 0 : _b[0]}`;
        ...
        if (step && !step.disabled) {
            switch (step.type[0]) {
                ...
                case "paymentDetails" /* CheckoutStepType.PAYMENT_DETAILS */: {
                    if ((_a = this.checkoutStepService.getCheckoutStep("deliveryMode" /* CheckoutStepType.DELIVERY_MODE */)) === null || _a === void 0 ? void 0 : _a.disabled) {
    ...
    getUrl(routeName) {
        var _a, _b;
        return this.router.parseUrl((_b = (_a = this.routingConfigService.getRouteConfig(routeName)) === null || _a === void 0 ? void 0 : _a.paths) === null || _b === void 0 ? void 0 : _b[0]);
    }
...
class CheckoutReviewSubmitComponent {
    ...
    getCheckoutStepUrl(stepType) {
        const step = this.checkoutStepService.getCheckoutStep(stepType);
        return step === null || step === void 0 ? void 0 : step.routeName;
    }
    deliverySteps(steps) {
