...
class OccCheckoutDeliveryModesAdapter {
    ...
    getSupportedModes(userId, cartId) {
        return this.http
            ...
            .pipe(catchError((error) => throwError(normalizeHttpError(error, this.logger))), backOff({
            shouldRetry: isJaloError,
        }), map((listResponse) => listResponse.deliveryModes), map((modes) => modes !== null && modes !== void 0 ? modes : []), this.converter.pipeableMany(DELIVERY_MODE_NORMALIZER));
    }
...
class OccCheckoutPaymentAdapter {
    ...
    getPaymentCardTypes() {
        return this.http
            ...
            .pipe(catchError((error) => throwError(normalizeHttpError(error, this.logger))), backOff({
            shouldRetry: isJaloError,
        }), map((cardTypeList) => { var _a; return (_a = cardTypeList.cardTypes) !== null && _a !== void 0 ? _a : []; }), this.converter.pipeableMany(PAYMENT_CARD_TYPE_NORMALIZER));
    }
