...
class B2BCheckoutDeliveryAddressComponent extends CheckoutDeliveryAddressComponent {
    constructor(userAddressService, checkoutDeliveryAddressFacade, activatedRoute, translationService, activeCartFacade, checkoutStepService, checkoutDeliveryModesFacade, globalMessageService, checkoutCostCenterFacade, checkoutPaymentTypeFacade, userCostCenterService) {
        ...
        this.isAccountPayment$ = this.checkoutPaymentTypeFacade
            .isAccountPayment()
            .pipe(distinctUntilChanged());
        this.costCenterAddresses$ = this.checkoutCostCenterFacade.getCostCenterState().pipe(filter((state) => !state.loading), map((state) => state.data), distinctUntilChanged((prev, curr) => (prev === null || prev === void 0 ? void 0 : prev.code) === (curr === null || curr === void 0 ? void 0 : curr.code)), switchMap((costCenter) => {
            this.doneAutoSelect = false;
            return (costCenter === null || costCenter === void 0 ? void 0 : costCenter.code)
...
class CheckoutPaymentTypeComponent {
    constructor(checkoutPaymentTypeFacade, checkoutStepService, activatedRoute, globalMessageService) {
        ...
        this.paymentTypes$ = this.checkoutPaymentTypeFacade
            ...
            var _a, _b;
            if (((_b = (_a = error.details) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.type) === "ClassMismatchError" /* OccHttpErrorType.CLASS_MISMATCH_ERROR */ &&
        ...
        this.typeSelected$ = combineLatest([
            ...
            if (availablePaymentTypes.length) {
                this.busy$.next(true);
                this.checkoutPaymentTypeFacade
                    .setPaymentType(availablePaymentTypes[0].code, (_b = (_a = this.poNumberInputElement) === null || _a === void 0 ? void 0 : _a.nativeElement) === null || _b === void 0 ? void 0 : _b.value)
                    .subscribe({
            ...
            this.typeSelected = selected === null || selected === void 0 ? void 0 : selected.code;
            this.checkoutStepService.resetSteps();
            this.checkoutStepService.disableEnableStep("paymentDetails" /* CheckoutStepType.PAYMENT_DETAILS */, (selected === null || selected === void 0 ? void 0 : selected.code) === B2BPaymentTypeEnum.ACCOUNT_PAYMENT);
        }));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CheckoutPaymentTypeComponent, decorators: [{
        ...
        return [{ type: i5.CheckoutPaymentTypeFacade }, { type: i2.CheckoutStepService }, { type: i3.ActivatedRoute }, { type: i1.GlobalMessageService, decorators: [{
                        type: Optional
                    }] }];
