 ...
 */
export declare abstract class OrderEvent extends CxEvent {
    userId?: string;
    /**
 ...
 */
export declare class OrderPlacedEvent extends OrderEvent {
    /**
     * Event's type
     */
 ...
 */
export declare class ReplenishmentOrderScheduledEvent extends OrderEvent {
    /**
     * Event's type
     */
 ...
 */
export declare class DownloadOrderInvoicesEvent extends CxEvent {
    /**
     * Event's type
     */
