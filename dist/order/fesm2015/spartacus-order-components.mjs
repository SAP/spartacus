    ...
    canActivate() {
        return this.orderAmendService.getForm().pipe(map((form) => {
            ...
            if (!form.valid) {
                ...
                return this.router.parseUrl((_a = this.semanticPathService.get('orders')) !== null && _a !== void 0 ? _a : '');
            }
            else {
                return true;
            }
...
class OrderDetailBillingComponent {
    ...
    isPaymentInfoCardFull(payment) {
        return (!!(payment === null || payment === void 0 ? void 0 : payment.cardNumber) && !!(payment === null || payment === void 0 ? void 0 : payment.expiryMonth) && !!(payment === null || payment === void 0 ? void 0 : payment.expiryYear));
    }
}
...
class OrderOverviewComponent {
    ...
    getAddressCardContent(deliveryAddress) {
        return this.translation.translate('addressCard.shipTo').pipe(filter(() => Boolean(deliveryAddress)), map((textTitle) => {
            var _a, _b;
            const formattedAddress = this.normalizeFormattedAddress((_a = deliveryAddress.formattedAddress) !== null && _a !== void 0 ? _a : '');
            return {
                title: textTitle,
                textBold: `${deliveryAddress.firstName} ${deliveryAddress.lastName}`,
                text: [formattedAddress, (_b = deliveryAddress.country) === null || _b === void 0 ? void 0 : _b.name],
            };
        }));
    }
        ...
        return this.translation.translate('paymentForm.billingAddress').pipe(filter(() => Boolean(billingAddress)), map((textTitle) => {
            ...
            return ({
                ...
                text: [
                    ...
                    (_a = billingAddress.country) === null || _a === void 0 ? void 0 : _a.name,
                ],
            });
        }));
    }
...
class OrderConfirmationShippingComponent {
    constructor(orderFacade, translationService, cd, outlet) {
        ...
        this.order$ = this.orderFacade
            ...
            .pipe(tap((order) => {
            var _a;
            this.entries = (_a = order === null || order === void 0 ? void 0 : order.entries) === null || _a === void 0 ? void 0 : _a.filter((entry) => !entry.deliveryPointOfService);
        }));
        this.subscription = new Subscription();
    }
    ngOnInit() {
        var _a;
        this.subscription.add((_a = this.outlet) === null || _a === void 0 ? void 0 : _a.context$.subscribe((context) => {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: OrderConfirmationShippingComponent, decorators: [{
        ...
        return [{ type: i1.OrderFacade }, { type: i2.TranslationService }, { type: i0.ChangeDetectorRef }, { type: i3.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
...
class OrderConfirmationThankYouMessageComponent {
        ...
        this.order$ = this.orderFacade.getOrderDetails().pipe(tap((order) => {
            ...
            this.isGuestCustomer =
                order && 'guestCustomer' in order
                    ? (_a = order.guestCustomer) !== null && _a !== void 0 ? _a : false
                    : false;
            this.orderGuid = order === null || order === void 0 ? void 0 : order.guid;
        }));
    }
    ngAfterViewInit() {
    ...
    addThankYouMessage() {
        this.getThankYouAssistiveMessage()
            ...
            var _a;
            const code = (_a = order.replenishmentOrderCode) !== null && _a !== void 0 ? _a : order.code;
...
class MyAccountV2OrderConsignmentsService {
    getGroupedConsignments(order, pickup) {
        ...
        const consignments = pickup
            ? (_a = order.consignments) === null || _a === void 0 ? void 0 : _a.filter((consignment) => consignment.deliveryPointOfService !== undefined)
            : (_b = order.consignments) === null || _b === void 0 ? void 0 : _b.filter((consignment) => consignment.deliveryPointOfService === undefined);
    ...
    getUnconsignedEntries(order, pickup) {
        ...
        return pickup
            ? (_a = order.unconsignedEntries) === null || _a === void 0 ? void 0 : _a.filter((entry) => entry.deliveryPointOfService !== undefined)
            : (_b = order.unconsignedEntries) === null || _b === void 0 ? void 0 : _b.filter((entry) => entry.deliveryPointOfService === undefined);
    }
    groupConsignments(consignments) {
        const grouped = consignments === null || consignments === void 0 ? void 0 : consignments.reduce((result, current) => {
...
class MyAccountV2ConsignmentTrackingComponent extends ConsignmentTrackingComponent {
    ...
    ngOnInit() {
        var _a, _b;
        (_a = this.outlet) === null || _a === void 0 ? void 0 : _a.context$.subscribe((context) => {
            this.consignment = context.item;
        });
        (_b = this.outlet) === null || _b === void 0 ? void 0 : _b.context$.subscribe((context) => {
            var _a, _b;
            this.orderCode = (_b = (_a = context === null || context === void 0 ? void 0 : context.order) === null || _a === void 0 ? void 0 : _a.code) !== null && _b !== void 0 ? _b : '';
        });
        super.ngOnInit();
    }
}
...
class OrderHistoryComponent {
    ...
    setOrderHistoryParams(orders) {
        ...
        this.hasPONumber = ((_c = (_b = orders === null || orders === void 0 ? void 0 : orders.orders) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.purchaseOrderNumber) !== undefined;
    }
    ngOnDestroy() {
...
class MyAccountV2OrderConsolidatedInformationComponent {
    ...
    getOrderEntriesCount(orderEntries) {
        var _a;
        return (_a = orderEntries === null || orderEntries === void 0 ? void 0 : orderEntries.length) !== null && _a !== void 0 ? _a : 0;
    }
    ...
    getPickupConsignments(consignments) {
        ...
        return ((_a = this.orderConsignmentsService.getGroupedConsignments(orderDetail, true)) !== null && _a !== void 0 ? _a : []);
    }
    getDeliveryConsignments(consignments) {
        var _a;
        const orderDetail = {};
        orderDetail.consignments = consignments;
        return ((_a = this.orderConsignmentsService.getGroupedConsignments(orderDetail, false)) !== null && _a !== void 0 ? _a : []);
    }
    getDeliveryUnconsignedEntries(unconsignedEntries) {
        var _a;
        const orderDetail = {};
        orderDetail.unconsignedEntries = unconsignedEntries;
        return ((_a = this.orderConsignmentsService.getUnconsignedEntries(orderDetail, false)) !== null && _a !== void 0 ? _a : []);
    }
    getPickupUnconsignedEntries(unconsignedEntries) {
        var _a;
        const orderDetail = {};
        orderDetail.unconsignedEntries = unconsignedEntries;
        return ((_a = this.orderConsignmentsService.getUnconsignedEntries(orderDetail, true)) !== null && _a !== void 0 ? _a : []);
    }
    getProductImages(entries) {
        ...
        for (const item of entries) {
            if ((_a = item.product) === null || _a === void 0 ? void 0 : _a.images) {
                if (index >= this.IMAGE_COUNT) {
                    break;
                }
                index++;
                images.push((_b = item.product) === null || _b === void 0 ? void 0 : _b.images);
            }
        }
        return images;
    }
