...
class AddToWishListComponent {
    ...
    getProductInWishList(product, entries) {
        const item = entries.find((entry) => { var _a; return ((_a = entry.product) === null || _a === void 0 ? void 0 : _a.code) === product.code; });
        return item;
    }
    ...
    getWishListEntries() {
        return this.wishListFacade.getWishList().pipe(filter((wishlist) => Boolean(wishlist)), map((wishList) => { var _a; return (_a = wishList.entries) !== null && _a !== void 0 ? _a : []; }));
    }
}
