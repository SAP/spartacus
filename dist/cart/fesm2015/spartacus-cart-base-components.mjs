...
class CartItemValidationWarningComponent {
    constructor(cartValidationFacade) {
        ...
        this.cartModification$ = this.cartValidationFacade
            ...
            .pipe(map((modificationList) => modificationList.find((modification) => { var _a, _b; return ((_b = (_a = modification.entry) === null || _a === void 0 ? void 0 : _a.product) === null || _b === void 0 ? void 0 : _b.code) === this.code; })));
    }
}
...
class AddedToCartDialogComponent {
    ...
    getQuantityFormControl(entry) {
        ...
        if (!this.form.get('quantity')) {
            const quantity = new UntypedFormControl(entry === null || entry === void 0 ? void 0 : entry.quantity, {
                updateOn: 'blur',
            });
            this.form.addControl('quantity', quantity);
            const entryNumber = new UntypedFormControl(entry === null || entry === void 0 ? void 0 : entry.entryNumber);
            this.form.addControl('entryNumber', entryNumber);
        }
        else {
            // set the real quantity added to cart
            (_a = this.form.get('quantity')) === null || _a === void 0 ? void 0 : _a.setValue(entry === null || entry === void 0 ? void 0 : entry.quantity);
        }
...
class CartCouponComponent {
    ...
    ngOnInit() {
        ...
        this.cart$ = combineLatest([
            ...
            this.getApplicableCustomerCoupons(cart, (_a = customerCoupons.coupons) !== null && _a !== void 0 ? _a : []);
        }), map(([cart]) => cart));
...
class CartItemListComponent {
    ...
    getInputsFromContext() {
        var _a;
        return (_a = this.outlet) === null || _a === void 0 ? void 0 : _a.context$.subscribe((context) => {
    ...
    rerenderChangedItems(items) {
        ...
        for (let i = 0; i - offset < Math.max(items.length, this._items.length); i++) {
            ...
            if (JSON.stringify((_a = this._items) === null || _a === void 0 ? void 0 : _a[index]) !== JSON.stringify(items[index])) {
                if (this._items[index]) {
                    (_b = this.form) === null || _b === void 0 ? void 0 : _b.removeControl(this.getControlName(this._items[index]));
                }
                if (!items[index]) {
    ...
    createForm() {
        this._items.forEach((item) => {
            ...
            if (control) {
                if (((_a = control.get('quantity')) === null || _a === void 0 ? void 0 : _a.value) !== item.quantity) {
    ...
    getControlName(item) {
        var _a;
        return ((_a = item.entryNumber) === null || _a === void 0 ? void 0 : _a.toString()) || '';
    }
    removeEntry(item) {
    ...
    getControl(item) {
        var _a;
        return (_a = this.form.get(this.getControlName(item))) === null || _a === void 0 ? void 0 : _a.valueChanges.pipe(
        // eslint-disable-next-line import/no-deprecated
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CartItemListComponent, decorators: [{
        ...
        return [{ type: i1$1.ActiveCartFacade }, { type: i1$1.SelectiveCartFacade }, { type: i2.UserIdService }, { type: i1$1.MultiCartFacade }, { type: i0.ChangeDetectorRef }, { type: i1.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
...
class OrderSummaryComponent {
    ...
    ngOnInit() {
        var _a;
        if ((_a = this.outlet) === null || _a === void 0 ? void 0 : _a.context$) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: OrderSummaryComponent, decorators: [{
        ...
        return [{ type: i1.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
    }, propDecorators: { cart: [{
                type: Input
    ...
    addToCart() {
        ...
        if (this.pickupOptionCompRef instanceof ComponentRef) {
            this.pickupOptionCompRef.instance.intendedPickupLocation$
                ...
                this.pickupStore =
                    (intendedPickupLocation === null || intendedPickupLocation === void 0 ? void 0 : intendedPickupLocation.pickupOption) === 'pickup'
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: AddToCartComponent, decorators: [{
        ...
        return [{ type: i1.CurrentProductService }, { type: i0.ChangeDetectorRef }, { type: i1$1.ActiveCartFacade }, { type: i1.CmsComponentData }, { type: i2.EventService }, { type: i1.ProductListItemContext, decorators: [{
                        type: Optional
                    }] }];
...
class CartDetailsComponent {
    ...
    saveForLater(item) {
        ...
        if (this.loggedIn) {
            this.activeCartService.removeEntry(item);
            this.selectiveCartService.addEntry((_b = (_a = item.product) === null || _a === void 0 ? void 0 : _a.code) !== null && _b !== void 0 ? _b : '', (_c = item.quantity) !== null && _c !== void 0 ? _c : 0);
        }
        else {
            ...
            return combineLatest([
                ...
                return isEmpty(cart) && loadingCart
                    ...
                    : cart.totalItems
                        ...
                        : (selectiveCart === null || selectiveCart === void 0 ? void 0 : selectiveCart.totalItems)
                            ? exclude(slots, [
                                'EmptyCartMiddleContent',
                                'CenterRightContentSlot',
                            ])
...
class SaveForLaterComponent {
    ...
    moveToCart(item) {
        var _a, _b, _c;
        this.selectiveCartService.removeEntry(item);
        this.cartService.addEntry((_b = (_a = item.product) === null || _a === void 0 ? void 0 : _a.code) !== null && _b !== void 0 ? _b : '', (_c = item.quantity) !== null && _c !== void 0 ? _c : 0);
    }
}
