...
const orgBudgetAssignedCostCenters = {
    title: 'Cost centers',
    subtitle: 'Budget: {{ item.name }}',
};
...
const orgUserGroupAssignedUsers = {
    title: 'Assigned users',
    subtitle: 'User group: {{ item.name }}',
    assigned: 'User {{item.name}} assigned successfully',
    unassigned: 'User {{item.name}} unassigned successfully',
};
const orgUserGroupUsers = {
    title: 'Manage users',
    subtitle: 'User group: {{ item.name }}',
    assigned: 'User {{item.name}} assigned successfully',
    unassigned: 'User {{item.name}} unassigned successfully',
...
const orgUserGroupAssignedPermissions = {
...
const orgUserAssignedUserGroups = {
...
const organizationTranslationChunksConfig = {
    organization: [
        'orgBudget',
        'orgBudgetAssignedCostCenters',
        'orgCostCenter',
...
export { organizationTranslationChunksConfig, organizationTranslations };
//# sourceMappingURL=spartacus-organization-administration-assets.mjs.map
