 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const accountSummaryTranslations = {
    en,
};
const accountSummaryTranslationChunksConfig = {
...
export { accountSummaryTranslationChunksConfig, accountSummaryTranslations };
//# sourceMappingURL=spartacus-organization-account-summary-assets.mjs.map
