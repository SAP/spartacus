...
class AccountSummaryService {
    ...
    getAccountSummary(orgUnitId) {
        return this.accountSummaryConnector
            .getAccountSummary(this.userId, orgUnitId !== null && orgUnitId !== void 0 ? orgUnitId : this.orgUnitId)
            .pipe(shareReplay(1));
    }
...
class AccountSummaryPageMetaResolver extends OrganizationPageMetaResolver {
    constructor(contentPageMetaResolver, translation, semanticPath, routingService) {
         ...
         */
        this.orgAccountSummaryBreadcrumb$ = defer(() => this.routingService.getRouterState()).pipe(map((routerState) => { var _a; return (_a = routerState === null || routerState === void 0 ? void 0 : routerState.state) === null || _a === void 0 ? void 0 : _a.semanticRoute; }), distinctUntilChanged(), switchMap((semanticRoute) => {
    ...
    getScore(page) {
        ...
        return (super.getScore(page) +
            (((_a = page.label) === null || _a === void 0 ? void 0 : _a.startsWith(this.ACCOUNT_SUMMARY_LIST_PATH)) ? 1 : -1));
    }
}
