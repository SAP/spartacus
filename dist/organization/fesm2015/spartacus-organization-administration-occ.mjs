...
class OccBudgetListNormalizer {
    ...
    convert(source, target) {
        ...
        target.values =
            (_b = (_a = source.budgets) === null || _a === void 0 ? void 0 : _a.map((budget) => (Object.assign({}, this.converter.convert(budget, BUDGET_NORMALIZER))))) !== null && _b !== void 0 ? _b : [];
        return target;
    }
}
...
class OccPermissionListNormalizer {
    ...
    convert(source, target) {
        ...
        target.values =
            (_b = (_a = source.orderApprovalPermissions) === null || _a === void 0 ? void 0 : _a.map((permission) => (Object.assign({}, this.converter.convert(permission, PERMISSION_NORMALIZER))))) !== null && _b !== void 0 ? _b : [];
        return target;
    }
}
...
class OccPermissionTypeListNormalizer {
    ...
    convert(source, target) {
        var _a;
        target = (_a = source.orderApprovalPermissionTypes) === null || _a === void 0 ? void 0 : _a.map((permissionType) => this.converter.convert(permissionType, PERMISSION_TYPE_NORMALIZER));
