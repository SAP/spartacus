...
class UserRegistrationFormService {
    ...
    getRegions() {
        var _a, _b;
        const regions = [];
        return ((_b = (_a = this.countryControl) === null || _a === void 0 ? void 0 : _a.valueChanges.pipe(filter((countryIsoCode) => !!countryIsoCode), switchMap((countryIsoCode) => {
            var _a;
            (_a = this.regionControl) === null || _a === void 0 ? void 0 : _a.reset();
            return this.userAddressService.getRegions(countryIsoCode);
        }))) !== null && _b !== void 0 ? _b : of(regions));
    }
    /**
    ...
    buildMessageContent(form) {
        ...
        return this.translationService.translate('userRegistrationForm.messageToApproverTemplate', {
            phoneNumber: (_a = form.get('phoneNumber')) === null || _a === void 0 ? void 0 : _a.value,
            addressLine: (_b = form.get('line1')) === null || _b === void 0 ? void 0 : _b.value,
            secondAddressLine: (_c = form.get('line2')) === null || _c === void 0 ? void 0 : _c.value,
            city: (_d = form.get('city')) === null || _d === void 0 ? void 0 : _d.value,
            state: (_f = (_e = form.get('region')) === null || _e === void 0 ? void 0 : _e.get('isocode')) === null || _f === void 0 ? void 0 : _f.value,
            postalCode: (_g = form.get('postalCode')) === null || _g === void 0 ? void 0 : _g.value,
            country: (_j = (_h = form.get('country')) === null || _h === void 0 ? void 0 : _h.get('isocode')) === null || _j === void 0 ? void 0 : _j.value,
            companyName: (_k = form.get('companyName')) === null || _k === void 0 ? void 0 : _k.value,
            message: (_l = form.get('message')) === null || _l === void 0 ? void 0 : _l.value,
        });
    }
    /**
     ...
     */
    registerUser(form) {
        return this.buildMessageContent(form).pipe(take(1), switchMap((message) => {
            var _a, _b, _c, _d;
            return this.organizationUserRegistrationFacade.registerUser({
                titleCode: (_a = form.get('titleCode')) === null || _a === void 0 ? void 0 : _a.value,
                firstName: (_b = form.get('firstName')) === null || _b === void 0 ? void 0 : _b.value,
                lastName: (_c = form.get('lastName')) === null || _c === void 0 ? void 0 : _c.value,
                email: (_d = form.get('email')) === null || _d === void 0 ? void 0 : _d.value,
                message: message,
            });
        }), tap(() => {
