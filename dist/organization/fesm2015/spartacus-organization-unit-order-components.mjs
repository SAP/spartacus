...
class UnitLevelOrderHistoryFilterComponent {
    ...
    searchUnitLevelOrders() {
        var _a, _b;
        const buyer = (_a = this.filterForm.get('buyerFilter')) === null || _a === void 0 ? void 0 : _a.value;
        const unit = (_b = this.filterForm.get('unitFilter')) === null || _b === void 0 ? void 0 : _b.value;
    ...
    emitFilterEvent(buyer, unit) {
        const filters = [];
        if (buyer === null || buyer === void 0 ? void 0 : buyer.length) {
    ...
    clearAll() {
        ...
        const buyer = (_a = this.filterForm.get('buyerFilter')) === null || _a === void 0 ? void 0 : _a.value;
        const unit = (_b = this.filterForm.get('unitFilter')) === null || _b === void 0 ? void 0 : _b.value;
        const buyerMobile = (_c = this.buyerFilterMobileId) === null || _c === void 0 ? void 0 : _c.nativeElement.value;
        const unitMobile = (_d = this.unitFilterMobileId) === null || _d === void 0 ? void 0 : _d.nativeElement.value;
    ...
    getFormValuesForMobileAndEmitFilterEvent() {
        var _a, _b;
        const buyer = (_a = this.filterFormMobile.get('buyerFilterMobile')) === null || _a === void 0 ? void 0 : _a.value;
        this.buyerFilterMobileValue = buyer;
        const unit = (_b = this.filterFormMobile.get('unitFilterMobile')) === null || _b === void 0 ? void 0 : _b.value;
        this.unitFilterMobileValue = unit;
    ...
    clearUnit() {
        var _a;
        (_a = this.filterForm.get('unitFilter')) === null || _a === void 0 ? void 0 : _a.reset();
        this.searchUnitLevelOrders();
    }
    clearBuyer() {
        var _a;
        (_a = this.filterForm.get('buyerFilter')) === null || _a === void 0 ? void 0 : _a.reset();
        this.searchUnitLevelOrders();
    }
    clearUnitMobile() {
        var _a;
        (_a = this.filterFormMobile.get('unitFilterMobile')) === null || _a === void 0 ? void 0 : _a.reset();
        this.renderer.setStyle(document.body, 'overflow', '');
        this.unitFilterMobileValue = null;
        this.getFormValuesForMobileAndEmitFilterEvent();
    }
    clearBuyerMobile() {
        var _a;
        (_a = this.filterFormMobile.get('buyerFilterMobile')) === null || _a === void 0 ? void 0 : _a.reset();
        this.renderer.setStyle(document.body, 'overflow', '');
        this.buyerFilterMobileValue = null;
        this.getFormValuesForMobileAndEmitFilterEvent();
    }
...
class UnitLevelOrderHistoryComponent {
    ...
    filterChange(newFilters) {
        this.updateQueryParams(Object.assign(Object.assign({}, newFilters), { currentPage: 0 }));
...
class UnitLevelOrderOverviewComponent {
    ...
    getAddressCardContent(deliveryAddress) {
        return this.translation.translate('addressCard.shipTo').pipe(filter(() => Boolean(deliveryAddress)), map((textTitle) => {
            var _a, _b;
            const formattedAddress = this.normalizeFormattedAddress((_a = deliveryAddress === null || deliveryAddress === void 0 ? void 0 : deliveryAddress.formattedAddress) !== null && _a !== void 0 ? _a : '');
            return {
                title: textTitle,
                textBold: `${deliveryAddress === null || deliveryAddress === void 0 ? void 0 : deliveryAddress.firstName} ${deliveryAddress === null || deliveryAddress === void 0 ? void 0 : deliveryAddress.lastName}`,
                text: [formattedAddress, (_b = deliveryAddress === null || deliveryAddress === void 0 ? void 0 : deliveryAddress.country) === null || _b === void 0 ? void 0 : _b.name],
            };
        }));
    }
    getDeliveryModeCardContent(deliveryMode) {
        return this.translation.translate('orderDetails.shippingMethod').pipe(filter(() => Boolean(deliveryMode)), map((textTitle) => {
            ...
            return ({
                title: textTitle,
                textBold: deliveryMode === null || deliveryMode === void 0 ? void 0 : deliveryMode.name,
                text: [
                    deliveryMode === null || deliveryMode === void 0 ? void 0 : deliveryMode.description,
                    ((_a = deliveryMode === null || deliveryMode === void 0 ? void 0 : deliveryMode.deliveryCost) === null || _a === void 0 ? void 0 : _a.formattedValue)
    ...
    getPaymentInfoCardContent(payment) {
        return combineLatest([
            ...
            title: textTitle,
            textBold: payment === null || payment === void 0 ? void 0 : payment.accountHolderName,
            text: [payment === null || payment === void 0 ? void 0 : payment.cardNumber, textExpires],
        })));
    }
    getBillingAddressCardContent(billingAddress) {
        return this.translation.translate('paymentForm.billingAddress').pipe(filter(() => Boolean(billingAddress)), map((textTitle) => {
            ...
            return ({
                title: textTitle,
                textBold: `${billingAddress === null || billingAddress === void 0 ? void 0 : billingAddress.firstName} ${billingAddress === null || billingAddress === void 0 ? void 0 : billingAddress.lastName}`,
                text: [
                    billingAddress === null || billingAddress === void 0 ? void 0 : billingAddress.formattedAddress,
                    (_a = billingAddress === null || billingAddress === void 0 ? void 0 : billingAddress.country) === null || _a === void 0 ? void 0 : _a.name,
                ],
            });
        }));
    }
    getBuyerNameCardContent(customer) {
        return this.translation.translate('unitLevelOrderDetails.buyer').pipe(filter(() => Boolean(customer)), map((textTitle) => ({
            title: textTitle,
            text: [customer === null || customer === void 0 ? void 0 : customer.name, `(${customer === null || customer === void 0 ? void 0 : customer.email})`],
        })));
    }
