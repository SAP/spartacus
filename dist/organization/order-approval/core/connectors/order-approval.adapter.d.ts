...
export declare abstract class OrderApprovalAdapter {
    /**
     ...
     */
    abstract load(userId: string, orderApprovalCode: string): Observable<OrderApproval>;
    abstract loadList(userId: string, params?: SearchConfig): Observable<EntitiesModel<OrderApproval>>;
    abstract makeDecision(userId: string, orderApprovalCode: string, orderApprovalDecision: OrderApprovalDecision): Observable<OrderApprovalDecision>;
}
