...
class CustomerTicketingService {
    ...
    constructor(queryService, commandService, userIdService, customerTicketingConnector, routingService, eventService) {
        ...
        this.createTicketEventCommand = this.commandService.create((payload) => this.customerTicketingPreConditions().pipe(switchMap(([customerId, ticketId]) => this.customerTicketingConnector
            ...
            .pipe(tap(() => {
            var _a, _b, _c;
            if (((_a = payload.ticketEvent.toStatus) === null || _a === void 0 ? void 0 : _a.id) === "CLOSED" /* STATUS.CLOSED */) {
                this.eventService.dispatch({}, TicketClosedEvent);
            }
            else if (!payload.containsAttachment) {
                if (((_b = payload.ticketEvent.toStatus) === null || _b === void 0 ? void 0 : _b.id) === "OPEN" /* STATUS.OPEN */ ||
                    ((_c = payload.ticketEvent.toStatus) === null || _c === void 0 ? void 0 : _c.id) === "INPROCESS" /* STATUS.INPROCESS */) {
        ...
        this.uploadAttachmentCommand = this.commandService.create((payload) => this.customerTicketingPreConditions().pipe(switchMap(([customerId, ticketId]) => {
            var _a;
            return this.customerTicketingConnector
                .uploadAttachment(customerId, (_a = payload.ticketId) !== null && _a !== void 0 ? _a : ticketId, payload.eventCode, payload.file)
    ...
    getTicketAssociatedObjects() {
        return this.getTicketAssociatedObjectsState().pipe(concatMap((state) => (state === null || state === void 0 ? void 0 : state.error) ? throwError(state.error) : of(state)), map((state) => { var _a; return (_a = state.data) !== null && _a !== void 0 ? _a : []; }));
    }
    getTicketCategoriesState() {
        return this.getTicketCategoriesQuery.getState();
    }
    getTicketCategories() {
        return this.getTicketCategoriesState().pipe(map((state) => { var _a; return (_a = state.data) !== null && _a !== void 0 ? _a : []; }));
    }
    getTicketState() {
...
class NotFoundTicketRequestHandler extends HttpErrorHandler {
    ...
    isCustomerTicketingDetailsRoute() {
        var _a, _b;
        return (((_b = (_a = getLastValueSync(this.routingService.getRouterState())) === null || _a === void 0 ? void 0 : _a.state) === null || _b === void 0 ? void 0 : _b.semanticRoute) === 'supportTicketDetails');
    }
    ...
    getErrors(response) {
        var _a;
        return ((_a = response.error) === null || _a === void 0 ? void 0 : _a.errors) || [];
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: NotFoundTicketRequestHandler, decorators: [{
        ...
        return [{ type: i1.GlobalMessageService }, { type: i1.RoutingService }, { type: Object, decorators: [{
                        type: Inject,
                        args: [PLATFORM_ID]
                    }] }];
    } });
...
class CustomerTicketingPageMetaResolver extends PageMetaResolver {
    ...
    resolveHeading() {
        return this.customerTicketingFacade
            .getTicket()
            .pipe(map((ticket) => (ticket === null || ticket === void 0 ? void 0 : ticket.subject) || ''));
    }
    resolveDescription() {
