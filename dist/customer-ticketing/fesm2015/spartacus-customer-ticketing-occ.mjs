...
class OccCustomerTicketingAdapter {
    ...
    getTicketAssociatedObjects(customerId) {
        return this.http
            ...
            .pipe(catchError((error) => throwError(normalizeHttpError(error, this.logger))), map((associatedObjectList) => { var _a; return (_a = associatedObjectList.ticketAssociatedObjects) !== null && _a !== void 0 ? _a : []; }), this.converter.pipeableMany(CUSTOMER_TICKETING_ASSOCIATED_OBJECTS_NORMALIZER));
    }
    ...
    getTicketCategories() {
        return this.http
            ...
            .pipe(catchError((error) => throwError(normalizeHttpError(error, this.logger))), map((categoryList) => { var _a; return (_a = categoryList.ticketCategories) !== null && _a !== void 0 ? _a : []; }), this.converter.pipeableMany(CUSTOMER_TICKETING_CATEGORY_NORMALIZER));
    }
    ...
    getTicket(customerId, ticketId) {
        ...
        }), tap((ticket) => { var _a; return (_a = ticket.ticketEvents) === null || _a === void 0 ? void 0 : _a.reverse(); }), this.converter.pipeable(CUSTOMER_TICKETING_DETAILS_NORMALIZER));
    }
