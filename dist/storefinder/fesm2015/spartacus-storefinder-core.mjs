...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: StoreFinderService, decorators: [{
        ...
        return [{ type: i1.Store }, { type: i2.WindowRef }, { type: i2.GlobalMessageService }, { type: i2.RoutingService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [PLATFORM_ID]
                    }] }];
    } });
...
class GoogleMapRendererService {
    ...
    renderMap(mapElement, locations, selectMarkerHandler) {
        var _a;
        if ((_a = this.config.googleMaps) === null || _a === void 0 ? void 0 : _a.apiKey) {
