...
class QualtricsLoaderService {
    ...
    constructor(winRef, platformId, scriptLoader) {
         ...
         */
        this.qsi$ = this.qsiLoaded$.pipe(switchMap(() => this.isDataLoaded()), map((dataLoaded) => { var _a; return (dataLoaded ? (_a = this.window) === null || _a === void 0 ? void 0 : _a.QSI : EMPTY); }), filter((qsi) => Boolean(qsi)), tap((qsi) => (this.qsiApi = qsi)));
        this.initialize();
    }
    /**
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: QualtricsLoaderService, decorators: [{
        ...
        return [{ type: i1.WindowRef }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [PLATFORM_ID]
