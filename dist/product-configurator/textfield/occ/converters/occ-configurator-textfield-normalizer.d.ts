...
export declare class OccConfiguratorTextfieldNormalizer implements Converter<OccConfiguratorTextfield.Configuration, ConfiguratorTextfield.Configuration> {
    constructor();
    /**
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<OccConfiguratorTextfieldNormalizer, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<OccConfiguratorTextfieldNormalizer>;
}
