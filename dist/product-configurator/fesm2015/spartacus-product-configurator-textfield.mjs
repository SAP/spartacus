...
class ConfiguratorTextfieldService {
    constructor(store, activeCartService, configuratorUtils, userIdService) {
        ...
        this.ensureConfigurationDefined = (configuration) => configuration !== null && configuration !== void 0 ? configuration : {
            configurationInfos: [],
...
class OccConfiguratorTextfieldAddToCartSerializer {
    ...
    convert(source, target) {
        ...
        (_a = source.configuration) === null || _a === void 0 ? void 0 : _a.configurationInfos.forEach((info) => this.convertInfo(info, configurationInfos));
        const resultTarget = Object.assign(Object.assign({}, target), { userId: source.userId, cartId: source.cartId, product: { code: source.productCode }, quantity: source.quantity, configurationInfos: configurationInfos });
        return resultTarget;
    }
...
class OccConfiguratorTextfieldNormalizer {
     ...
     */
    convert(source, target) {
        const resultTarget = Object.assign(Object.assign({}, target), source);
        return resultTarget;
    }
}
...
class OccConfiguratorTextfieldAdapter {
    ...
    readConfigurationForCartEntry(parameters) {
        ...
        return this.http.get(url).pipe(this.converterService.pipeable(CONFIGURATION_TEXTFIELD_NORMALIZER), map((resultConfiguration) => {
            return Object.assign(Object.assign({}, resultConfiguration), { owner: Object.assign({}, parameters.owner) });
        }));
    }
    readConfigurationForOrderEntry(parameters) {
