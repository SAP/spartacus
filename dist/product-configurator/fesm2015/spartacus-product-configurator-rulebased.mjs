...
const getCurrentGroup = (ownerKey) => {
    return createSelector(getConfigurationFactory(ownerKey), (configuration) => { var _a; return (_a = configuration === null || configuration === void 0 ? void 0 : configuration.interactionState) === null || _a === void 0 ? void 0 : _a.currentGroup; });
};
const isGroupVisited = (ownerKey, groupId) => {
    return createSelector(getConfigurationFactory(ownerKey), (configuration) => {
        var _a;
        const groupsVisited = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.interactionState) === null || _a === void 0 ? void 0 : _a.groupsVisited;
...
class ConfiguratorUtilsService {
    ...
    isConfigurationCreated(configuration) {
        const configId = configuration === null || configuration === void 0 ? void 0 : configuration.configId;
...
class ConfiguratorCartService {
    ...
    getEntry(entryNumber) {
        return this.activeCartService.requireLoadedCart().pipe(map((cart) => {
            ...
            const filteredEntries = entries.filter((entry) => { var _a; return ((_a = entry.entryNumber) === null || _a === void 0 ? void 0 : _a.toString()) === entryNumber; });
...
class ConfiguratorCommonsService {
    ...
    isConfigurationLoading(owner) {
        return this.store.pipe(select(getConfigurationProcessLoaderStateFactory(owner.key)), map((configurationState) => { var _a; return (_a = configurationState.loading) !== null && _a !== void 0 ? _a : false; }));
    }
    /**
    ...
    hasConflicts(owner) {
        return this.getConfiguration(owner).pipe(map((configuration) => {
            ...
            return configuration.immediateConflictResolution === false &&
                ((_a = configuration.groups[0]) === null || _a === void 0 ? void 0 : _a.groupType) ===
...
class ConfiguratorGroupsService {
    ...
    getCurrentGroupId(owner) {
        return this.configuratorCommonsService.getConfiguration(owner).pipe(map((configuration) => {
            ...
            if (configuration.interactionState.currentGroup) {
                ...
                return (_a = configuration.groups[0]) === null || _a === void 0 ? void 0 : _a.id;
            }
        }));
    }
    /**
    ...
    navigateToFirstIncompleteGroup(owner) {
        this.configuratorCommonsService
            ...
            .subscribe((configuration) => {
            var _a;
            const groupId = (_a = this.configuratorGroupStatusService.getFirstIncompleteGroup(configuration)) === null || _a === void 0 ? void 0 : _a.id;
            if (groupId) {
    ...
    navigateToConflictSolver(owner) {
        this.configuratorCommonsService
            ...
            .subscribe((configuration) => {
            var _a;
            const groupId = (_a = this.getFirstConflictGroup(configuration)) === null || _a === void 0 ? void 0 : _a.id;
            if (groupId) {
            ...
            return this.configuratorCommonsService.getConfiguration(owner).pipe(map((configuration) => {
                ...
                configuration.flatGroups.forEach((group, index) => {
                    ...
                    if (group.id === currentGroupId &&
                        ...
                        !this.isConflictGroupInImmediateConflictResolutionMode((_a = configuration.flatGroups[index + neighboringIndex]) === null || _a === void 0 ? void 0 : _a.groupType, configuration.immediateConflictResolution)) {
                        nextGroup =
...
class ConfiguratorStorefrontUtilsService {
    ...
    scroll(element) {
        ...
        (_a = this.windowRef.nativeWindow) === null || _a === void 0 ? void 0 : _a.scroll(0, topOffset);
    }
    /**
    ...
    focusOnElementForConflicting(attribute, foundFocusableElement, focusableElements) {
        var _a;
        const selectedValue = (_a = attribute.values) === null || _a === void 0 ? void 0 : _a.find((value) => value.selected);
        if (selectedValue) {
    ...
    getVerticallyScrolledPixels() {
        var _a;
        if (this.windowRef.isBrowser()) {
            return (_a = this.windowRef.nativeWindow) === null || _a === void 0 ? void 0 : _a.scrollY;
        }
        return undefined;
    }
    /**
    ...
    isInViewport(element) {
        ...
        if (element) {
            ...
            return (bounding.top >= -height &&
                bounding.left >= -width &&
                bounding.right <=
                    (((_a = this.windowRef.nativeWindow) === null || _a === void 0 ? void 0 : _a.innerWidth) || element.clientWidth) +
                        width &&
                bounding.bottom <=
                    (((_b = this.windowRef.nativeWindow) === null || _b === void 0 ? void 0 : _b.innerHeight) || element.clientHeight) +
                        height);
        }
        return false;
    }
    getHeight(querySelector) {
        ...
        if (isElementInViewport && (element === null || element === void 0 ? void 0 : element.offsetHeight)) {
    ...
    ensureElementVisible(querySelector, element) {
        ...
        if (element && container) {
            if (element.offsetTop > container.scrollTop) {
                ...
                container.scrollTop = ((_a = element.getBoundingClientRect()) === null || _a === void 0 ? void 0 : _a.top) - 10;
            }
        }
    }
}
...
class ConfiguratorAddToCartButtonComponent {
    ...
    ngOnInit() {
        ...
        this.subscription.add(this.quantityControl.valueChanges
            ...
            .subscribe(() => { var _a; return (_a = this.configuratorQuantityService) === null || _a === void 0 ? void 0 : _a.setQuantity(this.quantityControl.value); }));
    }
    navigateToCart() {
    ...
    navigateForProductBound(configWithNextOwner, configuratorType, isOverview) {
        var _a;
        const nextOwner = (_a = configWithNextOwner.nextOwner) !== null && _a !== void 0 ? _a : ConfiguratorModelUtils.createInitialOwner();
    ...
    onUpdateCart(configuration, configuratorType, owner, isOverview) {
        ...
        this.performNavigation(configuratorType, owner, false, isOverview, (_a = configuration.isCartEntryUpdateRequired) !== null && _a !== void 0 ? _a : false);
    ...
    extractConfigPrices(configuration) {
        ...
        const basePrice = (_a = priceSummary === null || priceSummary === void 0 ? void 0 : priceSummary.basePrice) === null || _a === void 0 ? void 0 : _a.formattedValue;
        const selectedOptions = (_b = priceSummary === null || priceSummary === void 0 ? void 0 : priceSummary.selectedOptions) === null || _b === void 0 ? void 0 : _b.formattedValue;
        const totalPrice = (_c = priceSummary === null || priceSummary === void 0 ? void 0 : priceSummary.currentTotal) === null || _c === void 0 ? void 0 : _c.formattedValue;
        const prices = {
            basePrice: basePrice,
...
class ConfiguratorAttributeBaseComponent {
    ...
    getValuePrice(value) {
        var _a, _b, _c;
        if (((_a = value === null || value === void 0 ? void 0 : value.valuePrice) === null || _a === void 0 ? void 0 : _a.value) && !value.selected) {
            if (value.valuePrice.value < 0) {
                return ` [${(_b = value.valuePrice) === null || _b === void 0 ? void 0 : _b.formattedValue}]`;
            }
            else if (value.valuePrice.value > 0) {
                return ` [+${(_c = value.valuePrice) === null || _c === void 0 ? void 0 : _c.formattedValue}]`;
            }
        }
        return '';
    }
    ...
    getSelectedValue(attribute) {
        var _a;
        return (_a = attribute.values) === null || _a === void 0 ? void 0 : _a.find((value) => value.selected);
    }
...
class ConfiguratorAttributeFooterComponent extends ConfiguratorAttributeBaseComponent {
    ...
    needsRequiredAttributeErrorMsg() {
        var _a;
        if ((_a = this.featureConfigService) === null || _a === void 0 ? void 0 : _a.isLevel('6.2')) {
    ...
    needsUserInputMessage() {
        ...
        const needsMessage = this.attribute.required &&
            ...
            this.isUserInputEmpty(this.attribute.userInput);
        return needsMessage !== null && needsMessage !== void 0 ? needsMessage : false;
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorAttributeFooterComponent, decorators: [{
        ...
        return [{ type: ConfiguratorStorefrontUtilsService }, { type: ConfiguratorAttributeCompositionContext }, { type: i1$1.FeatureConfigService, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class ConfiguratorAttributeHeaderComponent extends ConfiguratorAttributeBaseComponent {
    ...
    featureConfigService) {
        ...
        this.groupId = attributeComponentContext.group.id;
        this.groupType =
            (_a = attributeComponentContext.group.groupType) !== null && _a !== void 0 ? _a : Configurator.GroupType.ATTRIBUTE_GROUP;
        this.expMode = attributeComponentContext.expMode;
        this.isNavigationToGroupEnabled =
            (_b = attributeComponentContext.isNavigationToGroupEnabled) !== null && _b !== void 0 ? _b : false;
    }
    ngOnInit() {
        /**
    ...
    findConflictGroupId(configuration, currentAttribute) {
        var _a;
        return (_a = configuration.flatGroups
            .filter((group) => group.groupType === Configurator.GroupType.CONFLICT_GROUP)
            .find((group) => {
            var _a;
            return (_a = group.attributes) === null || _a === void 0 ? void 0 : _a.find((attribute) => attribute.key === currentAttribute.key);
    ...
    isNavigationToConflictEnabled() {
        var _a, _b;
        return ((_b = (this.isNavigationToGroupEnabled &&
            ((_a = this.configuratorUiSettings.productConfigurator) === null || _a === void 0 ? void 0 : _a.enableNavigationToConflict))) !== null && _b !== void 0 ? _b : false);
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorAttributeHeaderComponent, decorators: [{
        ...
        return [{ type: ConfiguratorStorefrontUtilsService }, { type: ConfiguratorCommonsService }, { type: ConfiguratorGroupsService }, { type: ConfiguratorUISettingsConfig }, { type: ConfiguratorAttributeCompositionContext }, { type: i1$1.FeatureConfigService, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class ConfiguratorAttributeQuantityComponent {
    ...
    ngOnInit() {
        var _a, _b;
        this.quantity.setValue((_a = this.quantityOptions) === null || _a === void 0 ? void 0 : _a.initialQuantity);
        this.optionsChangeSub.add((_b = this.quantityOptions.disableQuantityActions$) === null || _b === void 0 ? void 0 : _b.pipe(distinct()).subscribe((disable) => {
    ...
    subscribeToQuantityChange() {
        return this.quantity.valueChanges
            .pipe(debounce(() => { var _a, _b, _c; return timer((_c = (_b = (_a = this.config.productConfigurator) === null || _a === void 0 ? void 0 : _a.updateDebounceTime) === null || _b === void 0 ? void 0 : _b.quantity) !== null && _c !== void 0 ? _c : 0); }), take(1))
    ...
    onChangeQuantity() {
        var _a;
        this.changeQuantity.emit((_a = this.quantity) === null || _a === void 0 ? void 0 : _a.value);
    }
}
...
class ConfiguratorPriceComponent {
    ...
    compileFormattedValue(priceValue, formattedValue, isRTL) {
        if (priceValue > 0) {
            ...
            return formattedValue !== null && formattedValue !== void 0 ? formattedValue : '';
        }
    }
    /**
     * Retrieves price.
    ...
    get price() {
        ...
        if (this.formula.priceTotal) {
            ...
            return this.compileFormattedValue((_b = (_a = this.formula.price) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 0, (_c = this.formula.price) === null || _c === void 0 ? void 0 : _c.formattedValue, this.isRTLDirection());
        }
    }
    /**
    ...
    get priceTotal() {
        var _a, _b, _c;
        return this.compileFormattedValue((_b = (_a = this.formula.priceTotal) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 0, (_c = this.formula.priceTotal) === null || _c === void 0 ? void 0 : _c.formattedValue, this.isRTLDirection());
    }
    /**
    ...
    displayQuantityAndPrice() {
        ...
        return quantity ? ((_a = this.formula.price) === null || _a === void 0 ? void 0 : _a.value) !== 0 && quantity >= 1 : false;
    }
    /**
    ...
    displayPriceOnly() {
        var _a, _b, _c, _d;
        const priceValue = (_b = (_a = this.formula.price) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 0;
        const priceTotalValue = (_d = (_c = this.formula.priceTotal) === null || _c === void 0 ? void 0 : _c.value) !== null && _d !== void 0 ? _d : 0;
    ...
    displayFormula() {
        ...
        const displayFormula = (this.formula.quantity && this.formula.quantity !== 0) ||
            (this.formula.price && ((_a = this.formula.price) === null || _a === void 0 ? void 0 : _a.value) !== 0) ||
            (this.formula.priceTotal && ((_b = this.formula.priceTotal) === null || _b === void 0 ? void 0 : _b.value) !== 0);
        return displayFormula !== null && displayFormula !== void 0 ? displayFormula : false;
    }
    /**
    ...
    quantityWithPrice(formattedQuantity) {
        var _a;
        return formattedQuantity + 'x(' + ((_a = this.formula.price) === null || _a === void 0 ? void 0 : _a.formattedValue) + ')';
    }
    /**
    ...
    isPriceLightedUp() {
        var _a;
        return (_a = this.formula.isLightedUp) !== null && _a !== void 0 ? _a : false;
    }
    /**
...
class ConfiguratorAttributeProductCardComponent extends ConfiguratorAttributeBaseComponent {
    ...
    get showQuantity() {
        var _a;
        return ((_a = (this.productCardOptions.withQuantity &&
            this.productCardOptions.productBoundValue.selected &&
            this.productCardOptions.multiSelect)) !== null && _a !== void 0 ? _a : false);
    }
    ...
    isProductCardSelected() {
        ...
        return isProductCardSelected !== null && isProductCardSelected !== void 0 ? isProductCardSelected : false;
    }
    /**
    ...
    transformToProductType(value) {
        return {
            code: value === null || value === void 0 ? void 0 : value.productSystemId,
            description: value === null || value === void 0 ? void 0 : value.description,
            images: {},
            name: value === null || value === void 0 ? void 0 : value.valueDisplay,
        };
    }
    ...
    getAriaLabelSingleUnselected(product) {
        ...
        if (this.isValueCodeDefined((_b = (_a = this.productCardOptions) === null || _a === void 0 ? void 0 : _a.productBoundValue) === null || _b === void 0 ? void 0 : _b.valueCode)) {
            if (this.hasPriceDisplay() &&
                ((_c = this.productCardOptions.productBoundValue.valuePrice) === null || _c === void 0 ? void 0 : _c.value) !== 0) {
                this.translation
                    .translate('configurator.a11y.itemOfAttributeUnselectedWithPrice', {
                    item: product.code,
                    attribute: (_d = this.productCardOptions) === null || _d === void 0 ? void 0 : _d.attributeLabel,
                    itemIndex: index,
                    itemCount: this.productCardOptions.itemCount,
                    price: (_e = this.productCardOptions.productBoundValue.valuePriceTotal) === null || _e === void 0 ? void 0 : _e.formattedValue,
                })
                    .pipe(take(1))
                ...
                this.translation
                    ...
                    item: product.code,
                    attribute: (_f = this.productCardOptions) === null || _f === void 0 ? void 0 : _f.attributeLabel,
                    itemIndex: index,
                    itemCount: this.productCardOptions.itemCount,
                })
                    .pipe(take(1))
            ...
            this.translation
                ...
                attribute: (_g = this.productCardOptions) === null || _g === void 0 ? void 0 : _g.attributeLabel,
                itemIndex: index,
                itemCount: this.productCardOptions.itemCount,
            })
                .pipe(take(1))
    ...
    getAriaLabelSingleSelected(product) {
        ...
        const index = this.productCardOptions.itemIndex + 1;
        if (this.hasPriceDisplay() &&
            ((_a = this.productCardOptions.productBoundValue.valuePrice) === null || _a === void 0 ? void 0 : _a.value) !== 0) {
            this.translation
                .translate('configurator.a11y.itemOfAttributeSelectedPressToUnselectWithPrice', {
                item: product.code,
                attribute: (_b = this.productCardOptions) === null || _b === void 0 ? void 0 : _b.attributeLabel,
                itemIndex: index,
                itemCount: this.productCardOptions.itemCount,
                price: (_c = this.productCardOptions.productBoundValue.valuePriceTotal) === null || _c === void 0 ? void 0 : _c.formattedValue,
            })
                .pipe(take(1))
                .subscribe((text) => (translatedText = text));
        }
...
class ConfiguratorAttributeSingleSelectionBaseComponent extends ConfiguratorAttributeBaseComponent {
    ...
    get withQuantity() {
        var _a, _b;
        return this.quantityService.withQuantity((_a = this.attribute.dataType) !== null && _a !== void 0 ? _a : Configurator.DataType.NOT_IMPLEMENTED, (_b = this.attribute.uiType) !== null && _b !== void 0 ? _b : Configurator.UiType.NOT_IMPLEMENTED);
    }
    /**
    ...
    onSelect(value) {
        this.loading$.next(true);
        this.configuratorCommonsService.updateConfiguration(this.ownerKey, Object.assign(Object.assign({}, this.attribute), { selectedSingleValue: value }), Configurator.UpdateType.ATTRIBUTE);
    }
    ...
    onHandleQuantity(quantity) {
        this.loading$.next(true);
        this.configuratorCommonsService.updateConfiguration(this.ownerKey, Object.assign(Object.assign({}, this.attribute), { quantity }), Configurator.UpdateType.ATTRIBUTE_QUANTITY);
    }
    ...
    getInitialQuantity(form) {
        var _a;
        const quantity = (_a = this.attribute.quantity) !== null && _a !== void 0 ? _a : 0;
        if (form) {
    ...
    extractValuePriceFormulaParameters(value) {
        return {
            price: value === null || value === void 0 ? void 0 : value.valuePrice,
            isLightedUp: value ? value.selected : false,
        };
    }
    getSelectedValuePrice() {
        var _a, _b;
        return (_b = (_a = this.attribute.values) === null || _a === void 0 ? void 0 : _a.find((value) => value.selected)) === null || _b === void 0 ? void 0 : _b.valuePrice;
    }
    ...
    getAriaLabelWithoutAdditionalValue(value, attribute) {
        var _a, _b;
        let ariaLabel = '';
        if (value.valuePrice && ((_a = value.valuePrice) === null || _a === void 0 ? void 0 : _a.value) !== 0) {
            if (value.valuePriceTotal && ((_b = value.valuePriceTotal) === null || _b === void 0 ? void 0 : _b.value) !== 0) {
                this.translation
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorAttributeSingleSelectionBaseComponent, decorators: [{
        ...
        return [{ type: ConfiguratorAttributeQuantityService }, { type: i1$1.TranslationService }, { type: ConfiguratorAttributeCompositionContext }, { type: ConfiguratorCommonsService }, { type: ConfiguratorStorefrontUtilsService, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class ConfiguratorAttributeMultiSelectionBaseComponent extends ConfiguratorAttributeBaseComponent {
    ...
    extractQuantityParameters(initialQuantity, allowZero) {
        ...
        return {
            allowZero: allowZero !== null && allowZero !== void 0 ? allowZero : !this.attribute.required,
            initialQuantity: initialQuantity,
            disableQuantityActions$: disableQuantityActions$,
        };
    }
...
class ConfiguratorAttributeCheckBoxListComponent extends ConfiguratorAttributeMultiSelectionBaseComponent {
    ...
    ngOnInit() {
        ...
        for (const value of (_a = this.attribute.values) !== null && _a !== void 0 ? _a : []) {
    ...
    onSelect() {
        ...
        this.configuratorCommonsService.updateConfiguration(this.ownerKey, Object.assign(Object.assign({}, this.attribute), { values: selectedValues }), Configurator.UpdateType.ATTRIBUTE);
    }
    onChangeValueQuantity(eventObject, valueCode, formIndex) {
        ...
        this.configuratorCommonsService.updateConfiguration(this.ownerKey, Object.assign(Object.assign({}, this.attribute), { values: [value] }), Configurator.UpdateType.VALUE_QUANTITY);
    }
    onChangeQuantity(eventObject) {
        if (!eventObject) {
...
class ConfiguratorAttributeInputFieldComponent extends ConfiguratorAttributeBaseComponent {
    ...
    ngOnInit() {
        ...
        this.sub = this.attributeInputForm.valueChanges
            .pipe(debounce(() => {
            var _a, _b, _c;
            return timer((_c = (_b = (_a = this.config.productConfigurator) === null || _a === void 0 ? void 0 : _a.updateDebounceTime) === null || _b === void 0 ? void 0 : _b.input) !== null && _c !== void 0 ? _c : this.FALLBACK_DEBOUNCE_TIME);
        }))
            .subscribe(() => this.onChange());
    }
    onChange() {
        if (!this.attributeInputForm.invalid) {
            this.configuratorCommonsService.updateConfiguration(this.ownerKey, Object.assign(Object.assign({}, this.attribute), { userInput: this.attributeInputForm.value, selectedSingleValue: this.attributeInputForm.value }), Configurator.UpdateType.ATTRIBUTE);
        }
    }
    ngOnDestroy() {
        if (this.sub) {
    ...
    get isRequired() {
        ...
        return this.isUserInput(this.attribute)
            ? (_a = this.attribute.required) !== null && _a !== void 0 ? _a : false
            : false;
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorAttributeInputFieldComponent, decorators: [{
        ...
        return [{ type: ConfiguratorUISettingsConfig }, { type: ConfiguratorAttributeCompositionContext }, { type: ConfiguratorCommonsService }, { type: ConfiguratorStorefrontUtilsService, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class ConfiguratorAttributeNumericInputFieldService {
    ...
    getPatternForValidationMessage(decimalPlaces, totalLength, negativeAllowed, locale) {
        let input = (Math.pow(10, totalLength) - 1).toString();
        if (decimalPlaces > 0) {
            input =
    ...
    getNumberFormatValidator(locale, numberDecimalPlaces, numberTotalPlaces, negativeAllowed) {
        return (control) => {
            var _a;
            const input = (_a = control.value) === null || _a === void 0 ? void 0 : _a.trim();
            if (input) {
...
class ConfiguratorAttributeNumericInputFieldComponent extends ConfiguratorAttributeInputFieldComponent {
    ...
    mustDisplayValidationMessage() {
        ...
        const wrongFormat = (this.attributeInputForm.dirty || this.attributeInputForm.touched) &&
            ((_a = this.attributeInputForm.errors) === null || _a === void 0 ? void 0 : _a.wrongFormat);
        return wrongFormat;
    }
    /**
    ...
    mustDisplayIntervalMessage() {
        ...
        const intervalNotMet = (this.attributeInputForm.dirty || this.attributeInputForm.touched) &&
            ((_a = this.attributeInputForm.errors) === null || _a === void 0 ? void 0 : _a.intervalNotMet);
    ...
    initializeValidation() {
        ...
        const validatorArray = ((_a = this.featureConfigService) === null || _a === void 0 ? void 0 : _a.isLevel('6.2'))
            ? [
    ...
    getAriaLabelComplete() {
        ...
        if (((_a = this.attribute.userInput) === null || _a === void 0 ? void 0 : _a.length) === 0) {
            this.translation
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorAttributeNumericInputFieldComponent, decorators: [{
        ...
        return [{ type: ConfiguratorAttributeNumericInputFieldService }, { type: ConfiguratorUISettingsConfig }, { type: i1$1.TranslationService }, { type: ConfiguratorAttributeCompositionContext }, { type: ConfiguratorCommonsService }, { type: ConfiguratorStorefrontUtilsService, decorators: [{
                        type: Optional
...
class ConfiguratorAttributeDropDownComponent extends ConfiguratorAttributeSingleSelectionBaseComponent {
    ...
    getSelectedValue() {
        var _a;
        return (_a = this.attribute.values) === null || _a === void 0 ? void 0 : _a.find((value) => value === null || value === void 0 ? void 0 : value.selected);
    }
}
...
class ConfiguratorAttributeMultiSelectionBundleComponent extends ConfiguratorAttributeMultiSelectionBaseComponent {
    ...
    updateMultipleSelectionValues(valueCode, state) {
        ...
        this.multipleSelectionValues[index] = Object.assign(Object.assign({}, this.multipleSelectionValues[index]), { selected: state });
        const event = {
            changedAttribute: Object.assign(Object.assign({}, this.attribute), { values: this.multipleSelectionValues }),
    ...
    updateMultipleSelectionValuesQuantity(eventValue) {
        ...
        const event = {
            changedAttribute: Object.assign(Object.assign({}, this.attribute), { values: [value] }),
            ownerKey: this.ownerKey,
    ...
    onDeselectAll() {
        this.loading$.next(true);
        this.configuratorCommonsService.updateConfiguration(this.ownerKey, Object.assign(Object.assign({}, this.attribute), { values: [] }), Configurator.UpdateType.ATTRIBUTE);
    }
    ...
    extractProductCardParameters(disableAllButtons, hideRemoveButton, value, index) {
        var _a;
        return {
            disableAllButtons: disableAllButtons !== null && disableAllButtons !== void 0 ? disableAllButtons : false,
            hideRemoveButton: hideRemoveButton !== null && hideRemoveButton !== void 0 ? hideRemoveButton : false,
            ...
            itemCount: ((_a = this.attribute.values) === null || _a === void 0 ? void 0 : _a.length)
...
class ConfiguratorAttributeReadOnlyComponent extends ConfiguratorAttributeBaseComponent {
    ...
    getAriaLabel(attribute, value) {
        ...
        if (value) {
            ...
            if (value.valuePrice && ((_a = value.valuePrice) === null || _a === void 0 ? void 0 : _a.value) !== 0) {
                if (value.valuePriceTotal && ((_b = value.valuePriceTotal) === null || _b === void 0 ? void 0 : _b.value) !== 0) {
                    ariaLabel = this.translate('configurator.a11y.readOnlyValueOfAttributeFullWithPrice', valueName, attribute, (_c = value.valuePriceTotal) === null || _c === void 0 ? void 0 : _c.formattedValue);
                }
                else {
                    ariaLabel = this.translate('configurator.a11y.readOnlyValueOfAttributeFullWithPrice', valueName, attribute, (_d = value.valuePrice) === null || _d === void 0 ? void 0 : _d.formattedValue);
                }
            }
            else {
...
class ConfiguratorAttributeSingleSelectionBundleDropdownComponent extends ConfiguratorAttributeSingleSelectionBaseComponent {
    ...
    isNotRetractValue() {
        var _a, _b;
        return ((_b = (this.selectionValue &&
            ((_a = this.selectionValue) === null || _a === void 0 ? void 0 : _a.valueCode) !== Configurator.RetractValueCode)) !== null && _b !== void 0 ? _b : false);
    }
    /**
...
class ConfiguratorAttributeCompositionDirective {
    ...
    ngOnInit() {
        ...
        const composition = (_a = this.configuratorAttributeCompositionConfig.productConfigurator) === null || _a === void 0 ? void 0 : _a.assignment;
        if (composition) {
...
class ConfiguratorGroupComponent {
    ...
    getComponentKey(attribute) {
        var _a;
        return ((_a = attribute.uiTypeVariation) === null || _a === void 0 ? void 0 : _a.includes(Configurator.CustomUiTypeIndicator))
...
class ConfiguratorFormComponent {
    ...
    displayConflictResolvedMessage() {
        ...
        if (this.globalMessageService &&
            ((_b = (_a = this.featureConfigservice) === null || _a === void 0 ? void 0 : _a.isLevel('6.1')) !== null && _b !== void 0 ? _b : false)) {
    ...
    ngOnInit() {
        ...
        this.routerData$.pipe(take(1)).subscribe((routingData) => {
            ...
            if (routingData.expMode) {
                (_a = this.configExpertModeService) === null || _a === void 0 ? void 0 : _a.setExpModeRequested(routingData.expMode);
            }
        });
    }
    /**
    ...
    isDialogActive(configuration) {
        var _a;
        return (_a = configuration.interactionState.showConflictSolverDialog) !== null && _a !== void 0 ? _a : false;
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorFormComponent, decorators: [{
        ...
        return [{ type: ConfiguratorCommonsService }, { type: ConfiguratorGroupsService }, { type: i2$1.ConfiguratorRouterExtractorService }, { type: ConfiguratorExpertModeService }, { type: i3.LaunchDialogService }, { type: i1$1.FeatureConfigService, decorators: [{
                        type: Optional
...
class ConfiguratorGroupMenuService {
    ...
    getFocusedGroupIndex(groups) {
        if (groups) {
            const group = groups.find((groupHTMLEl) => {
                var _a, _b, _c, _d;
                return ((_a = groupHTMLEl.nativeElement) === null || _a === void 0 ? void 0 : _a.id) ===
                    ((_d = (_c = (_b = this.windowRef) === null || _b === void 0 ? void 0 : _b.document) === null || _c === void 0 ? void 0 : _c.activeElement) === null || _d === void 0 ? void 0 : _d.id);
            });
            if (group) {
    ...
    focusNextGroup(currentGroupIndex, groups) {
        ...
        if (groups) {
            if (currentGroupIndex === groups.length - 1) {
                (_b = (_a = groups.first) === null || _a === void 0 ? void 0 : _a.nativeElement) === null || _b === void 0 ? void 0 : _b.focus();
            }
            else {
                (_c = groups.toArray()[currentGroupIndex + 1]) === null || _c === void 0 ? void 0 : _c.nativeElement.focus();
            }
        }
    }
    /**
    ...
    focusPreviousGroup(currentGroupIndex, groups) {
        ...
        if (groups) {
            if (currentGroupIndex === 0) {
                (_b = (_a = groups.last) === null || _a === void 0 ? void 0 : _a.nativeElement) === null || _b === void 0 ? void 0 : _b.focus();
            }
            else {
                (_d = (_c = groups.toArray()[currentGroupIndex - 1]) === null || _c === void 0 ? void 0 : _c.nativeElement) === null || _d === void 0 ? void 0 : _d.focus();
            }
        }
    }
    /**
    ...
    isBackBtnFocused(groups) {
        var _a, _b, _c, _d, _e, _f, _g;
        if (groups) {
            return (((_d = (_c = (_b = (_a = groups.first) === null || _a === void 0 ? void 0 : _a.nativeElement) === null || _b === void 0 ? void 0 : _b.classList) === null || _c === void 0 ? void 0 : _c.value) === null || _d === void 0 ? void 0 : _d.indexOf('cx-menu-back')) !== -1 &&
                ((_f = (_e = this.windowRef) === null || _e === void 0 ? void 0 : _e.document) === null || _f === void 0 ? void 0 : _f.activeElement) === ((_g = groups.first) === null || _g === void 0 ? void 0 : _g.nativeElement));
        }
        return undefined;
    }
}
...
class ConfiguratorGroupMenuComponent {
    ...
    isGroupVisited(group, configuration) {
        return this.configuratorGroupsService
            ...
            var _a;
            return isVisited &&
                !this.isConflictGroupType((_a = group.groupType) !== null && _a !== void 0 ? _a : Configurator.GroupType.ATTRIBUTE_GROUP);
        }), take(1));
    }
    /**
     * Verifies whether the current group is conflict one.
    ...
    setFocusForMainMenu(currentGroupId) {
        ...
        this.configuration$.pipe(take(1)).subscribe((configuration) => {
            var _a;
            (_a = configuration.groups) === null || _a === void 0 ? void 0 : _a.forEach((group) => {
                var _a;
                if (((_a = group.subGroups) === null || _a === void 0 ? void 0 : _a.length) !== 1 &&
    ...
    containsSelectedGroup(group, currentGroupId) {
        ...
        (_a = group.subGroups) === null || _a === void 0 ? void 0 : _a.forEach((subGroup) => {
...
class ConfiguratorOverviewBundleAttributeComponent {
    ...
    getProductPrimaryImage(product) {
        var _a;
        return (_a = product === null || product === void 0 ? void 0 : product.images) === null || _a === void 0 ? void 0 : _a.PRIMARY;
    }
    /**
     * Extract corresponding price formula parameters
     *
    ...
    displayPrice() {
        var _a, _b;
        return (((_a = this.attributeOverview.valuePrice) === null || _a === void 0 ? void 0 : _a.value) !== undefined &&
            ((_b = this.attributeOverview.valuePrice) === null || _b === void 0 ? void 0 : _b.value) > 0);
    }
    getAriaLabel() {
        var _a, _b, _c, _d, _e, _f;
        let translatedText = '';
        if (this.displayQuantity()) {
            if (((_a = this.attributeOverview.valuePrice) === null || _a === void 0 ? void 0 : _a.value) !== undefined &&
                ((_b = this.attributeOverview.valuePrice) === null || _b === void 0 ? void 0 : _b.value) !== 0) {
                this.translation
                    ...
                    price: (_c = this.attributeOverview.valuePriceTotal) === null || _c === void 0 ? void 0 : _c.formattedValue,
                    quantity: this.attributeOverview.quantity,
                })
                    .pipe(take(1))
                    .subscribe((text) => (translatedText = text));
            ...
            if (((_d = this.attributeOverview.valuePrice) === null || _d === void 0 ? void 0 : _d.value) !== undefined &&
                ((_e = this.attributeOverview.valuePrice) === null || _e === void 0 ? void 0 : _e.value) !== 0) {
                this.translation
                    .translate('configurator.a11y.itemOfAttributeFullWithPrice', {
                    item: this.attributeOverview.value,
                    attribute: this.attributeOverview.attribute,
                    price: (_f = this.attributeOverview.valuePriceTotal) === null || _f === void 0 ? void 0 : _f.formattedValue,
                })
                    .pipe(take(1))
                    .subscribe((text) => (translatedText = text));
            }
...
class ConfiguratorOverviewFilterBarComponent {
    ...
    getGroupFilterDescription(overview, groupId) {
        var _a, _b, _c;
        return ((_c = (_b = (_a = overview.possibleGroups) === null || _a === void 0 ? void 0 : _a.find((group) => group.id === groupId)) === null || _b === void 0 ? void 0 : _b.groupDescription) !== null && _c !== void 0 ? _c : '');
    }
    /**
    ...
    isShowRemoveAll(overview) {
        var _a, _b, _c, _d;
        const numFilters = ((_b = (_a = overview.attributeFilters) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) +
            ((_d = (_c = overview.groupFilters) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0);
        return numFilters > 1;
    }
    /**
    ...
    getInputFilters(overview) {
        var _a, _b;
        return [(_a = overview.attributeFilters) !== null && _a !== void 0 ? _a : [], (_b = overview.groupFilters) !== null && _b !== void 0 ? _b : []];
    }
    createInputConfig(config, attrFilters, groupFilers) {
        var _a;
        return Object.assign(Object.assign({}, config), { overview: {
                configId: config.configId,
                productCode: config.productCode,
                attributeFilters: attrFilters,
                groupFilters: groupFilers,
                possibleGroups: (_a = config.overview) === null || _a === void 0 ? void 0 : _a.possibleGroups,
            } });
    }
}
...
class ConfiguratorOverviewFilterComponent {
    ...
    extractGroupFilterState(configuration) {
        var _a;
        this.groupFilters = [];
        (_a = configuration.overview.possibleGroups) === null || _a === void 0 ? void 0 : _a.forEach((group) => {
    ...
    collectGroupFilters(overview) {
        ...
        this.groupFilters.forEach((groupFilter) => {
            if (groupFilter.value && (overview === null || overview === void 0 ? void 0 : overview.possibleGroups)) {
...
class ConfiguratorOverviewFilterButtonComponent {
    ...
    getNumFilters(overview) {
        var _a, _b, _c, _d;
        return (((_b = (_a = overview.attributeFilters) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) +
            ((_d = (_c = overview.groupFilters) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0));
    }
    /**
...
class ConfiguratorOverviewFormComponent {
    ...
    hasAttributes(configuration) {
        var _a;
        return this.hasGroupWithAttributes((_a = configuration.overview) === null || _a === void 0 ? void 0 : _a.groups);
    }
    ...
    isSameAttribute(attributes, index) {
        ...
        if (attributes.length > 1) {
            if (index === 0) {
                return (((_a = attributes[index]) === null || _a === void 0 ? void 0 : _a.attribute) === ((_b = attributes[index + 1]) === null || _b === void 0 ? void 0 : _b.attribute));
            }
            else {
                return (((_c = attributes[index]) === null || _c === void 0 ? void 0 : _c.attribute) === ((_d = attributes[index - 1]) === null || _d === void 0 ? void 0 : _d.attribute));
            }
        }
        return false;
    }
    ...
    getStyleClasses(attributes, index) {
        var _a;
        let styleClass = '';
        switch ((_a = attributes[index]) === null || _a === void 0 ? void 0 : _a.type) {
...
class ConfiguratorOverviewMenuComponent {
    ...
    getAmount(configuration) {
        var _a;
        if ((_a = configuration.overview) === null || _a === void 0 ? void 0 : _a.groups) {
    ...
    highlight(elementToHighlight) {
        if (elementToHighlight) {
            ...
            menuItems === null || menuItems === void 0 ? void 0 : menuItems.forEach((menuItem) => {
...
class ConfiguratorOverviewNotificationBannerComponent {
    constructor(configuratorCommonsService, configRouterExtractorService, commonConfigUtilsService) {
        ...
        this.numberOfIssues$ = this.configuration$.pipe(map((configuration) => {
            ...
            if (configOv === null || configOv === void 0 ? void 0 : configOv.totalNumberOfIssues) {
        ...
        this.numberOfConflicts$ = this.configuration$.pipe(map((configuration) => {
            var _a, _b;
            return (_b = (_a = configuration.overview) === null || _a === void 0 ? void 0 : _a.numberOfConflicts) !== null && _b !== void 0 ? _b : 0;
        }));
        this.skipConflictsOnIssueNavigation$ = this.configuration$.pipe(map((configuration) => {
            var _a, _b;
            return ((_b = (_a = configuration.overview) === null || _a === void 0 ? void 0 : _a.numberOfConflicts) !== null && _b !== void 0 ? _b : 0) > 0;
        }));
        this.iconTypes = ICON_TYPE;
    }
}
    ...
    constructor(configuratorCommonsService, configRouterExtractorService, productService, configExpertModeService) {
        ...
        this.product$ = this.configuration$
            ...
            switch (configuration.owner.type) {
                ...
                case CommonConfigurator.OwnerType.ORDER_ENTRY:
                    return (_a = configuration.overview) === null || _a === void 0 ? void 0 : _a.productCode;
            }
    ...
    switchTabOnArrowPress(event, currentTab) {
        ...
        if (event.code === 'ArrowLeft' || event.code === 'ArrowRight') {
            ...
            if (currentTab === '#configTab') {
                (_a = this.overviewTab.nativeElement) === null || _a === void 0 ? void 0 : _a.focus();
            }
            else {
                (_b = this.configTab.nativeElement) === null || _b === void 0 ? void 0 : _b.focus();
            }
        }
    }
...
class ConfiguratorUpdateMessageComponent {
    constructor(configuratorCommonsService, configRouterExtractorService, config) {
        ...
        switchMap((isLoading) => {
            var _a, _b;
            return isLoading
                ? of(isLoading).pipe(delay(((_b = (_a = this.config.productConfigurator) === null || _a === void 0 ? void 0 : _a.updateConfigurationMessage) === null || _b === void 0 ? void 0 : _b.waitingTime) || 1000)) // delay information if it is loading
                : of(isLoading);
...
class RulebasedConfiguratorConnector {
    ...
    isAdapterMatching(adapter, configuratorType) {
        ...
        if (matching && "CLOUDCPQCONFIGURATOR" /* ConfiguratorType.CPQ */ === configuratorType) {
            const isCpqOverOccRequested = (_c = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.productConfigurator) === null || _b === void 0 ? void 0 : _b.cpqOverOcc) !== null && _c !== void 0 ? _c : false;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorRouterListener, decorators: [{
        ...
        return [{ type: ConfiguratorCartService }, { type: i1$1.RoutingService }, { type: ConfiguratorQuantityService, decorators: [{
                        type: Optional
                    }] }];
    } });
    ...
    constructor(actions$, configuratorCommonsConnector, commonConfigUtilsService, configuratorGroupUtilsService, configuratorGroupStatusService, store, configuratorBasicEffectService) {
        ...
        this.createConfiguration$ = createEffect(() => this.actions$.pipe(ofType(CREATE_CONFIGURATION), mergeMap((action) => {
            return this.configuratorCommonsConnector
                ...
                this.store.dispatch(new UpdatePriceSummary(Object.assign(Object.assign({}, configuration), { interactionState: { currentGroup: currentGroup } })));
                return [
        ...
        mergeMap((payload) => {
            return this.configuratorCommonsConnector
                ...
                .pipe(map((configuration) => {
                return new UpdateConfigurationSuccess(Object.assign(Object.assign({}, configuration), { interactionState: {
        ...
        this.updateConfigurationSuccess$ = createEffect(() => this.actions$.pipe(ofType(UPDATE_CONFIGURATION_SUCCESS), map((action) => action.payload), mergeMap((payload) => {
            return this.store.pipe(select(hasPendingChanges(payload.owner.key)), take(1), filter((hasPendingChanges) => hasPendingChanges === false), switchMap(() => this.store.pipe(select(getCurrentGroup(payload.owner.key)), take(1), map((currentGroupId) => {
                ...
                const updatePriceSummaryAction = new UpdatePriceSummary(Object.assign(Object.assign({}, payload), { interactionState: {
                ...
                return container.currentGroupId ===
                    ...
                    : [
                        ...
                        new ChangeGroup({
                            ...
                            parentGroupId: (_a = container.parentGroupFromPayload) === null || _a === void 0 ? void 0 : _a.id,
                        }),
                    ];
            }))));
        })));
            ...
            return this.store.pipe(select(hasPendingChanges(action.payload.configuration.owner.key)), take(1), filter((hasPendingChanges) => hasPendingChanges === false), switchMap(() => {
                return this.configuratorCommonsConnector
                    ...
                    return [
                        ...
                        new ReadConfigurationSuccess(configuration),
                        new UpdatePriceSummary(Object.assign(Object.assign({}, configuration), { interactionState: {
                                currentGroup: action.payload.groupId,
                            } })),
                    ];
                }), catchError((error) => [
    ...
    constructor(actions$, configuratorCommonsConnector, commonConfigUtilsService, configuratorGroupUtilsService, store, configuratorBasicEffectService) {
        ...
        this.addToCart$ = createEffect(() => this.actions$.pipe(ofType(ADD_TO_CART), map((action) => action.payload), switchMap((payload) => {
            return this.configuratorCommonsConnector.addToCart(payload).pipe(switchMap((entry) => {
                var _a;
                const entryNumber = (_a = entry.entry) === null || _a === void 0 ? void 0 : _a.entryNumber;
                if (entryNumber === undefined) {
                    ...
                    return [
                        ...
                        new CartActions.CartAddEntrySuccess(Object.assign(Object.assign({}, entry), { userId: payload.userId, cartId: payload.cartId, productCode: payload.productCode, quantity: payload.quantity, deliveryModeChanged: entry.deliveryModeChanged, entry: entry.entry, quantityAdded: entry.quantityAdded, statusCode: entry.statusCode, statusMessage: entry.statusMessage })),
                    ];
                }
        ...
        this.readConfigurationForCartEntry$ = createEffect(() => this.actions$.pipe(ofType(READ_CART_ENTRY_CONFIGURATION), switchMap((action) => {
            ...
            return this.configuratorCommonsConnector
                ...
                const updatePriceSummaryAction = new UpdatePriceSummary(Object.assign(Object.assign({}, result), { interactionState: {
        ...
        this.removeCartBoundConfigurations$ = createEffect(() => this.actions$.pipe(ofType(REMOVE_CART_BOUND_CONFIGURATIONS), switchMap(() => {
            return this.store.pipe(select(getConfigurationsState), take(1), map((configuratorState) => {
                ...
                ownerKeysProductBound.forEach((ownerKey) => {
                    ...
                    if (((_a = configuration.value) === null || _a === void 0 ? void 0 : _a.nextOwner) !== undefined) {
                        ownerKeysToRemove.push(ownerKey);
                    }
                });
                return new RemoveConfiguration({
...
class ConfiguratorVariantEffects {
    constructor(actions$, configuratorCommonsConnector, configuratorCoreConfig) {
        ...
        this.logger = inject(LoggerService);
        this.searchVariants$ = createEffect(() => this.actions$.pipe(ofType(SEARCH_VARIANTS), filter(() => {
            var _a;
            return ((_a = this.configuratorCoreConfig.productConfigurator) === null || _a === void 0 ? void 0 : _a.enableVariantSearch) === true;
        }), filter((action) => action.payload.owner.configuratorType === "CPQCONFIGURATOR" /* ConfiguratorType.VARIANT */), switchMap((action) => {
            return this.configuratorCommonsConnector
...
class ConfiguratorStateUtils {
    ...
    static mergeGroupWithSupplements(group, attributeSupplements) {
        if (this.isTargetGroup(group, attributeSupplements)) {
            ...
            return Object.assign(Object.assign({}, group), { subGroups: this.mergeGroupsWithSupplements(group.subGroups, attributeSupplements) });
        }
    }
    static mergeTargetGroupWithSupplements(group, attributeSupplements) {
        ...
        attributeSupplements.forEach((attributeSupplement) => {
            ...
            mergedAttributes = this.updateArrayElement(mergedAttributes, (attribute) => attribute.name === attributeName, (attribute) => {
                return Object.assign(Object.assign({}, attribute), { values: this.mergeValuesWithSupplement(attribute.values, attributeSupplement) });
            });
        });
        return Object.assign(Object.assign({}, group), { attributes: mergedAttributes });
    }
    static mergeValuesWithSupplement(attributeValues, attributeSupplement) {
        ...
        attributeSupplement.valueSupplements.forEach((valueSupplement) => {
            mergedValues = this.updateArrayElement(mergedValues, (value) => value.valueCode === valueSupplement.attributeValueKey, (value) => {
                return Object.assign(Object.assign({}, value), { valuePrice: valueSupplement.priceValue });
            });
        });
        return mergedValues;
    }
...
function handleActionDismissConflictSolverDialog(state, action) {
    if (action.type === DISMISS_CONFLICT_DIALOG) {
        const result = Object.assign(Object.assign({}, state), { interactionState: Object.assign(Object.assign({}, state.interactionState), { showConflictSolverDialog: false }) });
        return result;
    }
}
function handleActionCheckConflictSolverDialog(state) {
    const result = Object.assign(Object.assign({}, state), { interactionState: Object.assign({}, state.interactionState) });
    checkConflictSolverDialog(result);
    return result;
}
...
function handleGetConfigurationOverviewSuccess(state, action) {
    const content = Object.assign(Object.assign({}, action.payload.overview), { possibleGroups: action.payload.overview.groups });
    return Object.assign(Object.assign({}, state), { overview: content, priceSummary: content.priceSummary, interactionState: Object.assign(Object.assign({}, state.interactionState), { issueNavigationDone: false }) });
}
function handleUpdateConfigurationOverviewSuccess(state, action) {
    const content = Object.assign({}, action.payload.overview);
    return Object.assign(Object.assign({}, state), { overview: content, priceSummary: content.priceSummary, interactionState: Object.assign(Object.assign({}, state.interactionState), { issueNavigationDone: false }) });
}
function handleSearchVariantsSuccess(state, action) {
    return Object.assign(Object.assign({}, state), { variants: action.payload.variants });
}
function handleReadOrderEntryConfigurationSuccess(state, action) {
    var _a;
    const configuration = Object.assign({}, action.payload);
    const result = Object.assign(Object.assign(Object.assign({}, state), configuration), { priceSummary: (_a = configuration.overview) === null || _a === void 0 ? void 0 : _a.priceSummary });
    return result;
}
function handleSetNextOwnerCartEntry(state, action) {
    const content = Object.assign({}, action.payload.configuration);
    content.nextOwner = ConfiguratorModelUtils.createOwner(CommonConfigurator.OwnerType.CART_ENTRY, action.payload.cartEntryNo);
    const result = Object.assign(Object.assign({}, state), content);
    return result;
}
function handleSetInteractionState(state, action) {
    const newInteractionState = action.payload.interactionState;
    return Object.assign(Object.assign({}, state), { interactionState: newInteractionState });
}
function handleSetCurrentGroup(state, action) {
    const newCurrentGroup = action.payload.currentGroup;
    const result = Object.assign(Object.assign({}, state), { interactionState: Object.assign(Object.assign({}, state.interactionState), { currentGroup: newCurrentGroup }) });
    checkConflictSolverDialog(result);
    return result;
}
function handleSetMenuParentGroup(state, action) {
    const newMenuParentGroup = action.payload.menuParentGroup;
    return Object.assign(Object.assign({}, state), { interactionState: Object.assign(Object.assign({}, state.interactionState), { menuParentGroup: newMenuParentGroup }) });
}
function handleSetGroupsVisited(state, action) {
    ...
    return Object.assign(Object.assign({}, state), { interactionState: Object.assign(Object.assign({}, state.interactionState), { groupsVisited: changedInteractionState.groupsVisited }) });
}
function handleChangeGroup(state, action) {
    const isConflictResolutionMode = action.payload.conflictResolutionMode;
    return Object.assign(Object.assign({}, state), { interactionState: Object.assign(Object.assign({}, state.interactionState), { isConflictResolutionMode: isConflictResolutionMode }) });
}
...
function setInitialCurrentGroup(state) {
    ...
    if (flatGroups && flatGroups.length > 0) {
        initialCurrentGroup = state.immediateConflictResolution
            ? (_a = flatGroups.find((group) => !group.id.startsWith(Configurator.ConflictIdPrefix))) === null || _a === void 0 ? void 0 : _a.id
            : flatGroups[0].id;
    }
    const menuParentGroup = (initialCurrentGroup === null || initialCurrentGroup === void 0 ? void 0 : initialCurrentGroup.startsWith(Configurator.ConflictIdPrefix))
        ? Configurator.ConflictHeaderId
        : undefined;
    return Object.assign(Object.assign({}, state), { interactionState: Object.assign(Object.assign({}, state.interactionState), { currentGroup: initialCurrentGroup, menuParentGroup: menuParentGroup }) });
}
function takeOverChanges(action, state) {
    ...
    const result = Object.assign(Object.assign(Object.assign({}, state), content), { groups: groups, interactionState: Object.assign(Object.assign(Object.assign({}, state.interactionState), content.interactionState), { showConflictSolverDialog: state.interactionState.showConflictSolverDialog, issueNavigationDone: true }) });
    return result;
}
function takeOverPricingChanges(action, state) {
    ...
    const groups = priceSupplements && priceSupplements.length > 0
        ...
        : state.groups;
    const result = Object.assign(Object.assign(Object.assign({}, state), content), { groups: groups, interactionState: Object.assign(Object.assign(Object.assign({}, state.interactionState), content.interactionState), { issueNavigationDone: true }) });
    return result;
}
...
class OccConfiguratorVariantNormalizer {
    ...
    convert(source, target) {
        var _a, _b, _c, _d, _e, _f;
        const resultTarget = Object.assign(Object.assign({}, target), { owner: (_a = target === null || target === void 0 ? void 0 : target.owner) !== null && _a !== void 0 ? _a : ConfiguratorModelUtils.createInitialOwner(), interactionState: (_b = target === null || target === void 0 ? void 0 : target.interactionState) !== null && _b !== void 0 ? _b : {}, configId: source.configId, complete: source.complete, consistent: source.consistent, totalNumberOfIssues: source.totalNumberOfIssues, productCode: source.rootProduct, groups: [], flatGroups: [], kbKey: (_c = source.kbKey) !== null && _c !== void 0 ? _c : undefined, pricingEnabled: (_d = source.pricingEnabled) !== null && _d !== void 0 ? _d : true, hideBasePriceAndSelectedOptions: source.hideBasePriceAndSelectedOptions, immediateConflictResolution: (_e = source.immediateConflictResolution) !== null && _e !== void 0 ? _e : false, newConfiguration: source.newConfiguration });
        const flatGroups = [];
        (_f = source.groups) === null || _f === void 0 ? void 0 : _f.forEach((group) => this.convertGroup(group, resultTarget.groups, flatGroups));
        ...
        const attribute = {
            ...
            userInput: uiType === Configurator.UiType.NUMERIC ||
                ...
                ? sourceAttribute.formattedValue
                    ...
                    : ''
                : undefined,
            maxlength: ((_a = sourceAttribute.maxlength) !== null && _a !== void 0 ? _a : 0) +
    ...
    addRetractValue(sourceAttribute, values) {
        ...
        if (!isRetractBlocked) {
            if (((_b = (_a = this.uiSettingsConfig) === null || _a === void 0 ? void 0 : _a.productConfigurator) === null || _b === void 0 ? void 0 : _b.addRetractOption) ||
    ...
    convertImage(occImage, images) {
        ...
        const image = {
             ...
             * if none provided.
             */
            url: (((_c = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.backend) === null || _b === void 0 ? void 0 : _b.media) === null || _c === void 0 ? void 0 : _c.baseUrl) ||
                ((_f = (_e = (_d = this.config) === null || _d === void 0 ? void 0 : _d.backend) === null || _e === void 0 ? void 0 : _e.occ) === null || _f === void 0 ? void 0 : _f.baseUrl) ||
                '') + occImage.url,
    ...
    convertAttributeType(sourceAttribute) {
        var _a, _b;
        let uiType;
        const sourceType = (_b = (_a = sourceAttribute.type) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '';
...
class OccConfiguratorVariantOverviewNormalizer {
    ...
    convert(source, target) {
        ...
        const resultTarget = Object.assign(Object.assign({}, target), { configId: source.id, groups: (_a = source.groups) === null || _a === void 0 ? void 0 : _a.flatMap((group) => this.convertGroup(group)), priceSummary: this.converterService.convert(prices, VARIANT_CONFIGURATOR_PRICE_SUMMARY_NORMALIZER), productCode: source.productCode });
...
class OccConfiguratorVariantOverviewSerializer {
    ...
    convert(source, target) {
        return Object.assign(Object.assign({}, target), { id: source.configId, productCode: source.productCode, appliedCsticFilter: this.convertAttributeFilters(source.attributeFilters), groupFilterList: this.convertGroupFilters(source.groupFilters) });
    }
    convertAttributeFilters(attributeFilters) {
        const result = [];
        attributeFilters === null || attributeFilters === void 0 ? void 0 : attributeFilters.forEach((filter) => {
    ...
    convertGroupFilters(groupFilters) {
        const result = [];
        groupFilters === null || groupFilters === void 0 ? void 0 : groupFilters.forEach((filter) => {
            result.push({ key: filter, selected: true });
        });
        return result;
    }
...
class OccConfiguratorVariantPriceSummaryNormalizer {
    convert(source, target) {
        const resultTarget = Object.assign(Object.assign({}, target), source.priceSummary);
        return resultTarget;
    }
}
...
class OccConfiguratorVariantSerializer {
    convert(source, target) {
        ...
        const resultTarget = Object.assign(Object.assign({}, target), { configId: source.configId, rootProduct: source.productCode, complete: source.complete, groups: resultGroups });
        return resultTarget;
    }
    convertGroup(source, occGroups) {
        ...
        const group = {
            ...
            id: source.id,
            configurable: source.configurable,
            groupType: this.convertGroupType((_a = source.groupType) !== null && _a !== void 0 ? _a : Configurator.GroupType.ATTRIBUTE_GROUP),
            description: source.description,
    ...
    getRetractedValue(attribute) {
        var _a, _b;
        return (_b = (_a = attribute.values) === null || _a === void 0 ? void 0 : _a.find((value) => value.selected)) === null || _b === void 0 ? void 0 : _b.valueCode;
    }
    ...
    convertAttribute(attribute, occAttributes) {
        ...
        const targetAttribute = {
            ...
            type: this.convertCharacteristicType((_a = attribute.uiType) !== null && _a !== void 0 ? _a : Configurator.UiType.NOT_IMPLEMENTED),
        };
...
class OccConfiguratorVariantUpdateCartEntrySerializer {
    convert(source, target) {
        const resultTarget = Object.assign(Object.assign({}, target), { userId: source.userId, cartId: source.cartId, product: { code: source.configuration.productCode }, entryNumber: source.cartEntryNumber, configId: source.configuration.configId, configurationInfos: [{ configuratorType: "CPQCONFIGURATOR" /* ConfiguratorType.VARIANT */ }] });
        return resultTarget;
    }
}
...
class VariantConfiguratorOccAdapter {
    ...
    createConfiguration(owner, configIdTemplate, forceReset = false) {
        ...
        return this.http
            ...
            return Object.assign(Object.assign({}, resultConfiguration), { owner: owner });
        }));
    }
    readConfiguration(configId, groupId, configurationOwner) {
        const expMode = this.getExpModeRequested();
        return this.http
            ...
            return Object.assign(Object.assign({}, resultConfiguration), { owner: configurationOwner, newConfiguration: false });
        }));
    }
    updateConfiguration(configuration) {
        const configId = configuration.configId;
        ...
        return this.http
            ...
            return Object.assign(Object.assign({}, resultConfiguration), { owner: configuration.owner });
        }));
    }
    addToCart(parameters) {
    ...
    readConfigurationForCartEntry(parameters) {
        ...
        return this.http.get(url).pipe(this.converterService.pipeable(VARIANT_CONFIGURATOR_NORMALIZER), tap((resultConfiguration) => {
            ...
            return Object.assign(Object.assign({}, resultConfiguration), { owner: parameters.owner });
        }));
    }
    updateConfigurationForCartEntry(parameters) {
    ...
    readPriceSummary(configuration) {
        ...
        return this.http.get(url, { context: this.indicateSendUserForAsm() }).pipe(this.converterService.pipeable(VARIANT_CONFIGURATOR_PRICE_NORMALIZER), map((configResult) => {
            const result = Object.assign(Object.assign({}, configuration), { priceSummary: configResult.priceSummary, priceSupplements: configResult.priceSupplements });
            return result;
        }));
    }
    ...
    updateConfigurationOverview(ovInput) {
        ...
        return this.http
            ...
            .pipe(this.converterService.pipeable(VARIANT_CONFIGURATOR_OVERVIEW_NORMALIZER), map((overview) => (Object.assign(Object.assign({}, overview), { attributeFilters: ovInput.attributeFilters, groupFilters: ovInput.groupFilters, possibleGroups: ovInput.possibleGroups }))));
    }
...
class OccConfiguratorVariantPriceNormalizer {
    convert(source, target) {
        ...
        (_a = source.attributes) === null || _a === void 0 ? void 0 : _a.forEach((attr) => {
        ...
        const resultTarget = Object.assign(Object.assign({}, target), { configId: source.configId, productCode: '', groups: [], flatGroups: [], owner: ConfiguratorModelUtils.createInitialOwner(), interactionState: {}, priceSummary: source === null || source === void 0 ? void 0 : source.priceSummary, priceSupplements: priceSupplements });
        return resultTarget;
    }
    convertAttributeSupplements(source, priceSupplements) {
        var _a;
        const attributeSupplement = {
            attributeUiKey: source === null || source === void 0 ? void 0 : source.csticUiKey,
            valueSupplements: [],
        };
        (_a = source === null || source === void 0 ? void 0 : source.priceSupplements) === null || _a === void 0 ? void 0 : _a.forEach((value) => {
            this.convertValueSupplement(value, attributeSupplement === null || attributeSupplement === void 0 ? void 0 : attributeSupplement.valueSupplements);
        });
        priceSupplements.push(attributeSupplement);
    }
    convertValueSupplement(source, valueSupplements) {
        const valueSupplement = {
            attributeValueKey: source === null || source === void 0 ? void 0 : source.attributeValueKey,
            priceValue: source === null || source === void 0 ? void 0 : source.priceValue,
            obsoletePriceValue: source === null || source === void 0 ? void 0 : source.obsoletePriceValue,
        };
