import { Cart, CartItemContext, OrderEntry } from '@spartacus/cart/base/root';
 ...
 */
export declare class CommonConfiguratorUtilsService {
    protected userIdService: UserIdService;
    constructor(userIdService: UserIdService);
    /**
     ...
     */
    isActiveCartContext(cartItemContext: CartItemContext | undefined): Observable<boolean>;
    /**
     ...
     */
    getSlotsFromLayoutConfiguration(layoutConfig: LayoutConfig, templateName: string, sectionName: string, breakPoint: BREAKPOINT.lg | BREAKPOINT.md | BREAKPOINT.sm | BREAKPOINT.xs): string[];
    static ɵfac: i0.ɵɵFactoryDeclaration<CommonConfiguratorUtilsService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<CommonConfiguratorUtilsService>;
}
