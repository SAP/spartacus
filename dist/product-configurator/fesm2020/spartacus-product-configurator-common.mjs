...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorIssuesNotificationComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: CommonConfiguratorUtilsService }, { type: i2.CartItemContext, decorators: [{
                    type: Optional
                }] }]; } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorCartEntryInfoComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i2.CartItemContext, decorators: [{
                    type: Optional
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: ConfiguratorCartEntryBundleInfoComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: CommonConfiguratorUtilsService }, { type: ConfiguratorCartEntryBundleInfoService }, { type: i1.BreakpointService }, { type: i4.TranslationService }, { type: i2.CartItemContext, decorators: [{
                    type: Optional
                }] }]; } });
