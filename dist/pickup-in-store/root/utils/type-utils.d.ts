 ...
 * ```
 */
export type RequiredDeepPath<T, P extends string> = RequiredDeepArray<T, PathToStringArray<P>>;
/**
 * A utility type that takes a base type and a union of strings that represent
 ...
 * ```
 */
export type PickRequiredDeep<T, P extends string> = PickRequiredDeepArray<T, PathToStringArray<P>>;
/** A cart with the ids required for pickup in store */
export type CartWithIdAndUserId = RequiredDeepPath<Cart, 'guid' | 'user.uid' | 'code'>;
export {};
