...
class PickupOptionsComponent {
    ...
    ngOnChanges() {
        ...
        if (this.disableControls) {
            (_a = this.pickupOptionsForm.get('pickupOption')) === null || _a === void 0 ? void 0 : _a.disable();
        }
        this.pickupOptionsForm.markAllAsTouched();
        (_b = this.pickupOptionsForm.get('pickupOption')) === null || _b === void 0 ? void 0 : _b.setValue(this.selectedOption);
    }
...
class CartPickupOptionsContainerComponent {
    ...
    ngOnInit() {
        var _a, _b, _c;
        const outletContext = (_c = (_b = (_a = this.outlet) === null || _a === void 0 ? void 0 : _a.context$) === null || _b === void 0 ? void 0 : _b.pipe(map((context) => {
            this.cartType = context.cartType;
            return context.item;
        }), filter(orderEntryWithRequiredFields))) !== null && _c !== void 0 ? _c : EMPTY;
        this.cmsService
            .getCurrentPage()
            .pipe(filter(Boolean), take(1), tap((cmsPage) => {
            var _a;
            this.page = cmsPage.pageId;
            this.pickupOptionFacade.setPageContext((_a = cmsPage.pageId) !== null && _a !== void 0 ? _a : '');
        }))
            .subscribe();
        ...
        this.disableControls$ = this.activeCartFacade.getEntries().pipe(map((entries) => entries.map((entry) => { var _a; return (_a = entry.product) === null || _a === void 0 ? void 0 : _a.code; })), switchMap((productCodes) => outletContext.pipe(map((orderEntry) => orderEntry === null || orderEntry === void 0 ? void 0 : orderEntry.product.code), map((orderEntry) => productCodes.filter((productCode) => productCode === orderEntry)
            .length > 1))));
        this.storeDetails$ = outletContext.pipe(map((orderEntry) => {
            var _a;
            return ({
                storeName: (_a = orderEntry.deliveryPointOfService) === null || _a === void 0 ? void 0 : _a.name,
            ...
            this.intendedPickupLocationService.setIntendedLocation(productCode, Object.assign(Object.assign({}, storeDetails), { pickupOption: 'pickup' }));
            ...
            this.intendedPickupLocationService.setIntendedLocation(givenProductCode, Object.assign(Object.assign({}, storeDetails), { pickupOption: 'delivery' }));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CartPickupOptionsContainerComponent, decorators: [{
        ...
        return [{ type: i1.ActiveCartFacade }, { type: i1$1.LaunchDialogService }, { type: i2$2.PickupLocationsSearchFacade }, { type: i2$2.PickupOptionFacade }, { type: i2$2.PreferredStoreFacade }, { type: i0.ViewContainerRef }, { type: i2$1.CmsService }, { type: i2$2.IntendedPickupLocationFacade }, { type: i1$1.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
...
class StoreScheduleComponent {
    ...
    ngOnChanges() {
        var _a, _b, _c, _d;
        this.openingTimes =
            (_d = (_c = (_b = (_a = this.storeDetails) === null || _a === void 0 ? void 0 : _a.openingHours) === null || _b === void 0 ? void 0 : _b.weekDayOpeningList) === null || _c === void 0 ? void 0 : _c.map(({ weekDay, closed, openingTime, closingTime }) => {
                var _a, _b;
                return {
                    openingHours: `${(_a = openingTime === null || openingTime === void 0 ? void 0 : openingTime.formattedHour) !== null && _a !== void 0 ? _a : ''} - ${(_b = closingTime === null || closingTime === void 0 ? void 0 : closingTime.formattedHour) !== null && _b !== void 0 ? _b : ''}`,
                    weekDay: weekDay !== null && weekDay !== void 0 ? weekDay : '',
                    closed,
                };
            })) !== null && _d !== void 0 ? _d : [];
    }
...
class SetPreferredStoreComponent {
    ...
    ngOnInit() {
        var _a;
        this.subscription.add((_a = this.outlet) === null || _a === void 0 ? void 0 : _a.context$.subscribe((pointOfServiceNames) => (this.pointOfServiceName = pointOfServiceNames)));
    }
    ngOnDestroy() {
        this.subscription.unsubscribe();
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: SetPreferredStoreComponent, decorators: [{
        ...
        return [{ type: i2$2.PreferredStoreFacade }, { type: i1$1.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
...
function isProductWithCode(product) {
    return !!(product === null || product === void 0 ? void 0 : product.code);
}
/**
 * A container component of the pair of the pickup options radio buttons for cart entry.
 */
class PdpPickupOptionsContainerComponent {
    ...
    ngOnInit() {
        ...
        this.displayPickupLocation$ = this.currentProductService.getProduct().pipe(filter(isProductWithCode), map((product) => product.code), switchMap((productCode) => this.intendedPickupLocationService
            ...
            this.intendedPickupLocationService.setIntendedLocation(productCode, Object.assign(Object.assign({}, storeDetails), { pickupOption: 'delivery' }));
...
class PickupInStoreOrderConsignmentContainerComponent {
    ...
    ngOnInit() {
        var _a, _b;
        this.pointOfService$ = (_b = (_a = this.outlet) === null || _a === void 0 ? void 0 : _a.context$) === null || _b === void 0 ? void 0 : _b.pipe(map((context) => { var _a; return (_a = context.item) === null || _a === void 0 ? void 0 : _a.deliveryPointOfService; }), filter((pointOfService) => !!pointOfService));
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: PickupInStoreOrderConsignmentContainerComponent, decorators: [{
        ...
        return [{ type: i1$1.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
...
class PickupInfoContainerComponent {
    ...
    ngOnInit() {
        this.activeCartService
            ...
            .map((entry) => { var _a; return (_a = entry.deliveryPointOfService) === null || _a === void 0 ? void 0 : _a.name; })
...
class DeliveryPointsService {
    ...
    getDeliveryPointsOfService(entries) {
        return of(entries).pipe(map((items) => items.filter((entry) => !!entry.deliveryPointOfService)), switchMap((elements) => iif(() => !!elements.length, of(elements).pipe(map((_elements) => {
            ...
            COPY.sort((a, b) => { var _a, _b; return ((_b = (_a = a.deliveryPointOfService) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.localeCompare(getProperty(b.deliveryPointOfService, 'name') || '')) || 0; });
            return COPY;
        }), map((sortedArray) => sortedArray.reduce((accumulator, value) => {
            var _a;
            const DELIVERY_POINT_OF_SERVICE = (_a = value
                .deliveryPointOfService) === null || _a === void 0 ? void 0 : _a.name;
            const existingValue = accumulator[DELIVERY_POINT_OF_SERVICE]
                ? accumulator[DELIVERY_POINT_OF_SERVICE]
                : [];
            return Object.assign(Object.assign({}, accumulator), { [DELIVERY_POINT_OF_SERVICE]: [...existingValue, value] });
            ...
            const STORE_DETAILS_MAP = storeDetails
                ...
                .reduce((accumulator, value) => (Object.assign(Object.assign({}, accumulator), { [value.name]: value })), {});
            return deliveryPointOfServiceMap.map((store) => (Object.assign(Object.assign({}, store), { storeDetails: STORE_DETAILS_MAP[store.name] })));
        })))), of([]))));
    }
}
...
class StoreListComponent {
     ...
     */
    onSelectStore(store) {
        const { stockInfo: _ } = store, pointOfService = __rest(store, ["stockInfo"]);
        this.intendedPickupLocationService.setIntendedLocation(this.productCode, Object.assign(Object.assign({}, pointOfService), { pickupOption: 'pickup' }));
...
class CurrentLocationService {
    ...
    getCurrentLocation(successCallback, errorCallback, options) {
        var _a, _b, _c;
        (_c = (_b = (_a = this.windowRef.nativeWindow) === null || _a === void 0 ? void 0 : _a.navigator) === null || _b === void 0 ? void 0 : _b.geolocation) === null || _c === void 0 ? void 0 : _c.getCurrentPosition(successCallback, errorCallback, options);
    }
}
...
class PickupOptionDialogComponent {
    ...
    onFindStores(locationSearchParams) {
        this.pickupLocationsSearchService.startSearch(Object.assign({ productCode: this.productCode }, locationSearchParams));
    }
    /**
