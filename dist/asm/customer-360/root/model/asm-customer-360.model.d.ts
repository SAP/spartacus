...
export declare enum AsmCustomer360Type {
...
export declare enum PaymentCardCode {
    VISA = "visa",
    MASTER = "master",
...
export declare enum KeyBoardEventCode {
...
export type AsmCustomer360Data = AsmCustomer360ActiveCart | AsmCustomer360ProductInterestList | AsmCustomer360ReviewList | AsmCustomer360StoreLocation | AsmCustomer360SupportTicketList | AsmCustomer360CustomerProfile | AsmCustomer360SavedCart | AsmCustomer360Overview | AsmCustomer360ActivityList | AsmCustomer360CouponList | AsmCustomer360PromotionList | AsmCustomer360CustomerCouponList;
export interface AsmCustomer360Response {
    value: Array<AsmCustomer360Data>;
}
export declare enum AsmDialogActionType {
    NAVIGATE = "NAVIGATE"
}
