...
class AsmCustomer360Component {
    constructor(asmCustomer360Config, asmCustomer360Facade, launchDialogService, csAgentAuthService, directionService) {
        ...
        this.customerOverview$ = this.asmCustomer360Facade
            ...
            .pipe(map((response) => {
            var _a;
            const overviewItem = (_a = response === null || response === void 0 ? void 0 : response.value) === null || _a === void 0 ? void 0 : _a.find((item) => item.type === AsmCustomer360Type.OVERVIEW);
            return (overviewItem === null || overviewItem === void 0 ? void 0 : overviewItem.overview) || undefined;
        }), catchError(() => {
            this.showErrorAlert$.next(true);
            return of(undefined);
        }));
        this.tabs = (_b = (_a = asmCustomer360Config === null || asmCustomer360Config === void 0 ? void 0 : asmCustomer360Config.asmCustomer360) === null || _a === void 0 ? void 0 : _a.tabs) !== null && _b !== void 0 ? _b : [];
    ...
    getAvatarText(customer) {
        customer = customer !== null && customer !== void 0 ? customer : {};
        const { firstName = '', lastName = '' } = customer;
        return `${firstName.charAt(0)}${lastName.charAt(0)}`;
    }
    getAvatarImage(overview) {
        var _a;
        return ((_a = overview === null || overview === void 0 ? void 0 : overview.userAvatar) === null || _a === void 0 ? void 0 : _a.url)
            ? {
...
class AsmCustomer360ActiveCartComponent {
    constructor(sectionContext, productService) {
        ...
        this.productItems$ = this.activeCart$.pipe(concatMap((cart) => {
            var _a;
            if (!((_a = cart === null || cart === void 0 ? void 0 : cart.entries) === null || _a === void 0 ? void 0 : _a.length)) {
                return of([]);
            }
            else {
                return forkJoin(cart.entries.map((entry) => {
                    return this.productService
                        ...
                        return Object.assign(Object.assign({}, product), { quantity: entry.quantity, basePrice: entry.basePrice, totalPrice: entry.totalPrice });
                    }), take(1));
                }));
            }
        }));
...
class AsmCustomer360TableComponent {
    ...
    ngOnChanges(changes) {
        if (changes === null || changes === void 0 ? void 0 : changes.entries) {
    ...
    removeCellTabIndex(columnIndex, rowIndex) {
        var _a, _b, _c;
        const tableCell = (_c = (_b = (_a = this.table.nativeElement.rows) === null || _a === void 0 ? void 0 : _a[rowIndex]) === null || _b === void 0 ? void 0 : _b.cells) === null || _c === void 0 ? void 0 : _c[columnIndex];
        const childElement = tableCell === null || tableCell === void 0 ? void 0 : tableCell.firstChild;
        if (childElement) {
...
class AsmCustomer360ActivityComponent {
    ...
    ngOnInit() {
        ...
        this.entries$ = combineLatest([this.context.data$]).pipe(map(([data]) => {
            ...
            data.activities.forEach((activity) => {
                var _a, _b;
                entries.push(Object.assign(Object.assign({}, activity), { typeLabel: (_a = activity.type) === null || _a === void 0 ? void 0 : _a.name, statusLabel: (_b = activity.status) === null || _b === void 0 ? void 0 : _b.name }));
            });
            return entries;
        }));
    }
    itemSelected(entry) {
        ...
        if (entry) {
            let urlCommand;
            if (((_a = entry.type) === null || _a === void 0 ? void 0 : _a.code) === TypeCodes.SavedCart) {
                urlCommand = {
                    cxRoute: 'savedCartsDetails',
                    params: { savedCartId: entry === null || entry === void 0 ? void 0 : entry.associatedTypeId },
                };
            }
            else if (((_b = entry.type) === null || _b === void 0 ? void 0 : _b.code) === TypeCodes.Cart) {
                urlCommand = {
                    cxRoute: 'cart',
                };
            }
            else if (((_c = entry.type) === null || _c === void 0 ? void 0 : _c.code) === TypeCodes.Order) {
                urlCommand = {
                    cxRoute: 'orderDetails',
                    params: { code: entry === null || entry === void 0 ? void 0 : entry.associatedTypeId },
                };
            }
            else if (((_d = entry.type) === null || _d === void 0 ? void 0 : _d.code) === TypeCodes.Ticket) {
                urlCommand = {
                    cxRoute: 'supportTicketDetails',
                    params: { ticketCode: entry === null || entry === void 0 ? void 0 : entry.associatedTypeId },
                };
            }
            if (urlCommand) {
...
class AsmCustomer360MapComponent {
    ...
    ngOnInit() {
        ...
        this.subscription.add(this.dataSource$
            ...
            }, undefined, undefined, undefined, (_a = this.storeFinderConfig.googleMaps) === null || _a === void 0 ? void 0 : _a.radius);
            return this.storeFinderService.getFindStoresEntities();
        }), concatMap((storeSearchData) => {
            var _a;
            if (storeSearchData) {
                this.storeData = storeSearchData;
                this.selectedStore = (_a = this.storeData.stores) === null || _a === void 0 ? void 0 : _a[0];
            }
            return of(undefined);
        }))
...
class AsmCustomer360ProductInterestsComponent {
    constructor(sectionContext, productService) {
        ...
        this.products$ = this.sectionContext.data$.pipe(concatMap((interestList) => {
            var _a;
            if (!((_a = interestList === null || interestList === void 0 ? void 0 : interestList.customerProductInterests) === null || _a === void 0 ? void 0 : _a.length)) {
                return of([]);
            }
            else {
...
class AsmCustomer360ProductReviewsComponent {
    ...
    ngOnInit() {
        this.reviewEntries$ = combineLatest([
            ...
            return data.reviews.map((entry) => (Object.assign(Object.assign({}, entry), { item: `${entry.productName}, ${skuLabel}: ${entry.productCode}`, dateAndStatus: `${this.getLongDate(new Date(entry.createdAt))} / ${entry.localizedReviewStatus}` })));
        }));
    }
    navigateTo(entry) {
        const params = {
    ...
    getLongDate(date) {
        var _a, _b, _c;
        return date
            ? (_c = this.datePipe.transform(date, (_b = (_a = this.asmCustomer360Config) === null || _a === void 0 ? void 0 : _a.asmCustomer360) === null || _b === void 0 ? void 0 : _b.dateTimeFormat)) !== null && _c !== void 0 ? _c : ''
            : '';
    }
}
...
class AsmCustomer360ProfileComponent {
    ...
    ngOnInit() {
        this.customerProfileData$ = this.sectionContext.data$.pipe(map((data) => {
            return data === null || data === void 0 ? void 0 : data.profile;
        }));
    }
    getCardContent({ defaultPayment, expiryMonth, expiryYear, cardNumber, cardType, }) {
        return combineLatest([
            ...
            const card = {
                ...
                text: [cardNumber !== null && cardNumber !== void 0 ? cardNumber : '', textExpires],
                img: this.getCardIcon((_a = cardType === null || cardType === void 0 ? void 0 : cardType.code) !== null && _a !== void 0 ? _a : ''),
...
class AsmCustomer360SupportTicketsComponent {
    ...
    ngOnInit() {
        this.supportTicketsEntries$ = this.context.data$.pipe(map((data) => {
            var _a, _b;
            return ((_b = (_a = data === null || data === void 0 ? void 0 : data.tickets) === null || _a === void 0 ? void 0 : _a.map((entry) => {
                return Object.assign(Object.assign({}, entry), { statusLabel: entry.status.name, categoryLabel: entry.category.name });
            })) !== null && _b !== void 0 ? _b : []);
        }));
    }
    navigateTo(entry) {
...
class AsmCustomer360CouponComponent {
    ...
    ngOnInit() {
        this.subscription.add(this.userIdService.getUserId().subscribe((user) => {
            this.userId = user !== null && user !== void 0 ? user : '';
        }));
        this.subscription.add(this.activeCartFacade.requireLoadedCart().subscribe((cart) => {
            this.currentCartId = cart === null || cart === void 0 ? void 0 : cart.code;
        }));
    ...
    fetchCoupons() {
        this.entries$ = this.context.data$.pipe(map((data) => {
            ...
            data.coupons.forEach((coupon) => {
                entries.push(Object.assign({}, coupon));
            });
            return entries;
        }), catchError(() => {
            this.showErrorAlert$.next(true);
    ...
    refreshComponent() {
        this.entries$ = this.asmCustomer360Facade
            ...
            .pipe(map((response) => {
            var _a;
            const couponList = (_a = response === null || response === void 0 ? void 0 : response.value) === null || _a === void 0 ? void 0 : _a.find((item) => item.type === AsmCustomer360Type.COUPON_LIST);
            const newEntries = [];
            if (couponList.coupons) {
                couponList.coupons.forEach((coupon) => {
                    newEntries.push(Object.assign({}, coupon));
                });
            }
            return newEntries;
        }), catchError(() => {
    ...
    applyCouponToCustomer(entry) {
        this.cartVoucherService.addVoucher(entry === null || entry === void 0 ? void 0 : entry.code, this.currentCartId);
        this.refreshActionButton(true, entry === null || entry === void 0 ? void 0 : entry.code);
    }
    removeCouponToCustomer(entry) {
        this.cartVoucherService.removeVoucher(entry === null || entry === void 0 ? void 0 : entry.code, this.currentCartId);
        this.refreshActionButton(false, entry === null || entry === void 0 ? void 0 : entry.code);
    }
...
class AsmCustomer360PromotionComponent {
    ...
    refreshPromotions() {
        this.asmCustomer360Facade
            ...
            .pipe(map((response) => {
            var _a;
            const promotionList = (_a = response === null || response === void 0 ? void 0 : response.value) === null || _a === void 0 ? void 0 : _a.find((item) => item.type === AsmCustomer360Type.PROMOTION_LIST);
            const newEntries = [];
...
class AsmCustomer360CustomerCouponComponent {
    ...
    mapParams(applied, response) {
        var _a;
        const couponList = (_a = response === null || response === void 0 ? void 0 : response.value) === null || _a === void 0 ? void 0 : _a.find((item) => item.type === AsmCustomer360Type.CUSTOMER_COUPON_LIST);
        const newEntries = [];
    ...
    claimCouponToCustomer(entry) {
        ...
        this.refreshActionButton(entry === null || entry === void 0 ? void 0 : entry.codeForApplyAction);
    }
