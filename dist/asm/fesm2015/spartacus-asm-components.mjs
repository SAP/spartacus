...
class AsmComponentService {
    ...
    asmEnablerService, asmDeepLinkService) {
        ...
        this.searchparam = new URLSearchParams((_b = (_a = this.winRef) === null || _a === void 0 ? void 0 : _a.location) === null || _b === void 0 ? void 0 : _b.search);
    }
    /**
    ...
    getSearchParameter(key) {
        ...
        return ((_b = (_a = this.asmDeepLinkService) === null || _a === void 0 ? void 0 : _a.getSearchParameter(key)) !== null && _b !== void 0 ? _b : this.searchparam.get(key));
    }
    ...
    isEmulateInURL() {
        var _a, _b, _c;
        // TODO(CXSPA-3090): Use asmDeepLinkService only in 7.0
        return (((_b = (_a = this.asmDeepLinkService) === null || _a === void 0 ? void 0 : _a.isEmulateInURL()) !== null && _b !== void 0 ? _b : (_c = this.asmEnablerService) === null || _c === void 0 ? void 0 : _c.isEmulateInURL()) ||
            false);
    }
    /**
    ...
    getDeepLinkUrlParams() {
        var _a;
        return (_a = this.asmDeepLinkService) === null || _a === void 0 ? void 0 : _a.getParamsInUrl();
    }
    /**
    ...
    handleDeepLinkNavigation(parameters = this.getDeepLinkUrlParams()) {
        var _a;
        (_a = this.asmDeepLinkService) === null || _a === void 0 ? void 0 : _a.handleNavigation(parameters);
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: AsmComponentService, decorators: [{
        ...
        return [{ type: i1$1.AuthService }, { type: i2$1.CsAgentAuthService }, { type: i1$1.WindowRef }, { type: i2$1.AsmEnablerService, decorators: [{
                        type: Optional
...
class AsmBindCartComponent {
    ...
    onSaveInactiveCart() {
        var _a, _b;
        (_a = this.asmComponentService) === null || _a === void 0 ? void 0 : _a.setShowDeeplinkCartInfoAlert(false);
        const customerId = (_b = this.asmComponentService) === null || _b === void 0 ? void 0 : _b.getSearchParameter('customerId');
    ...
    resetDeeplinkCart() {
        var _a, _b;
        if ((_a = this.featureConfig) === null || _a === void 0 ? void 0 : _a.isLevel('6.2')) {
            this.deepLinkCartId = '';
            this.displayBindCartBtn$.next(true);
            this.displaySaveCartBtn$.next(false);
            (_b = this.asmComponentService) === null || _b === void 0 ? void 0 : _b.setShowDeeplinkCartInfoAlert(false);
        }
    }
    ngOnDestroy() {
    ...
    subscribeForDeeplinkCart() {
        var _a, _b;
        if ((_a = this.featureConfig) === null || _a === void 0 ? void 0 : _a.isLevel('6.2')) {
            this.subscription.add((_b = this.asmComponentService) === null || _b === void 0 ? void 0 : _b.isEmulatedByDeepLink().pipe(filter((emulated) => {
                var _a;
                return emulated &&
                    !!((_a = this.asmComponentService) === null || _a === void 0 ? void 0 : _a.getSearchParameter('cartId'));
            })).subscribe(() => {
                var _a, _b, _c, _d, _e;
                // TODO(CXSPA-3090): Remove feature flag in 7.0.
                if ((_a = this.featureConfig) === null || _a === void 0 ? void 0 : _a.isLevel('6.3')) {
                    const cartType = (_b = this.asmComponentService) === null || _b === void 0 ? void 0 : _b.getSearchParameter('cartType');
                    if (cartType === 'inactive' || cartType === 'active') {
                        this.displayBindCartBtn$.next(false);
                        this.displaySaveCartBtn$.next(cartType === 'inactive');
                        this.deepLinkCartId =
                            (_c = this.asmComponentService) === null || _c === void 0 ? void 0 : _c.getSearchParameter('cartId');
                        this.cartId.setValue(this.deepLinkCartId);
                        (_d = this.asmComponentService) === null || _d === void 0 ? void 0 : _d.setShowDeeplinkCartInfoAlert(true);
                        (_e = this.asmComponentService) === null || _e === void 0 ? void 0 : _e.handleDeepLinkNavigation();
                    }
                    return;
                }
    ...
    onDeeplinkCart() {
        var _a, _b;
        this.deepLinkCartId = (_a = this.asmComponentService) === null || _a === void 0 ? void 0 : _a.getSearchParameter('cartId');
        this.cartId.setValue(this.deepLinkCartId);
        (_b = this.asmComponentService) === null || _b === void 0 ? void 0 : _b.setShowDeeplinkCartInfoAlert(true);
    }
    /**
     * @deprecated in 6.3: Will be removed in CXSPA-3090.
     */
    isDeepLinkInactiveCart() {
        var _a;
        const cartType = (_a = this.asmComponentService) === null || _a === void 0 ? void 0 : _a.getSearchParameter('cartType');
    ...
    goToSavedCartDetails(cartId) {
        var _a;
        (_a = this.routing) === null || _a === void 0 ? void 0 : _a.go({
    ...
    goToActiveCartDetail() {
        var _a;
        (_a = this.routing) === null || _a === void 0 ? void 0 : _a.go({ cxRoute: 'cart' });
    }
}
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: AsmBindCartComponent, decorators: [{
        ...
        return [{ type: i1$1.GlobalMessageService }, { type: i2$2.ActiveCartFacade }, { type: i2$2.MultiCartFacade }, { type: i2$1.AsmBindCartFacade }, { type: i1.LaunchDialogService }, { type: i2.SavedCartFacade }, { type: AsmComponentService, decorators: [{
                        type: Optional
...
class AsmCreateCustomerFormComponent {
    ...
    onRegisterUserFail(error) {
        ...
        const errorDetails = (_a = error.details) !== null && _a !== void 0 ? _a : [];
...
class CustomerSelectionComponent {
    ...
    createCustomer() {
        var _a;
        this.asmService.customerSearchReset();
        (_a = this.launchDialogService) === null || _a === void 0 ? void 0 : _a.openDialogAndSubscribe("ASM_CREATE_CUSTOMER_FORM" /* LAUNCH_CALLER.ASM_CREATE_CUSTOMER_FORM */, this.createCustomerLink);
    }
    /**
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CustomerSelectionComponent, decorators: [{
        ...
        return [{ type: i1$2.UntypedFormBuilder }, { type: i2$3.AsmService }, { type: i2$1.AsmConfig }, { type: i1.DirectionService }, { type: i1.LaunchDialogService, decorators: [{
                        type: Optional
                    }] }];
...
class CustomerEmulationComponent {
    ...
    ngOnInit() {
        ...
        this.isAsmCustomer360Configured =
            (_a = this.featureModules) === null || _a === void 0 ? void 0 : _a.isConfigured('asmCustomer360');
        if (this.isAsmCustomer360Configured) {
            // trigger lazy loading of the Customer 360 feature:
            (_b = this.featureModules) === null || _b === void 0 ? void 0 : _b.resolveFeature('asmCustomer360').subscribe(() => {
    ...
    openAsmCustomer360() {
        this.subscription.add(this.isAsmCustomer360Loaded$
            ...
            (_a = this.launchDialogService) === null || _a === void 0 ? void 0 : _a.openDialogAndSubscribe("ASM_CUSTOMER_360" /* LAUNCH_CALLER.ASM_CUSTOMER_360 */, this.asmCustomer360LauncherElement, data);
            this.subscription.add((_b = this.launchDialogService) === null || _b === void 0 ? void 0 : _b.dialogClose.pipe(filter((result) => Boolean(result))).subscribe((event) => {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CustomerEmulationComponent, decorators: [{
        ...
        return [{ type: AsmComponentService }, { type: i2$4.UserAccountFacade }, { type: i1.LaunchDialogService, decorators: [{
                        type: Optional
...
class AsmMainUiComponent {
    ...
    subscribeForDeeplink() {
        ...
        if ((_a = this.featureConfig) === null || _a === void 0 ? void 0 : _a.isLevel('6.2')) {
            ...
            // TODO(CXSPA-3090): Use asmDeepLinkService only in 7.0.
            const parameters = (_b = this.asmComponentService.getDeepLinkUrlParams()) !== null && _b !== void 0 ? _b : {
            ...
            this.subscription.add(combineLatest([
                ...
                if (agentLoggedIn && parameters.customerId) {
                    if (!isEmulatedByDeepLink && userLoggedin) {
                        ...
                        setTimeout(() => this.startSessionWithParameters(Object.assign(Object.assign({}, parameters), { emulated: isEmulatedByDeepLink })));
                    }
                }
            }));
        }
    ...
    confirmSwitchCustomer(switchCustomerId) {
        this.customer$
            ...
            if ((curCustomer === null || curCustomer === void 0 ? void 0 : curCustomer.customerId) !== switchCustomerId) {
    ...
    startCustomerEmulationSession({ customerId }, parameters) {
        ...
        if (customerId) {
            ...
            if (parameters) {
                // TODO(CXSPA-3090): Remove feature flag in 7.0
                if ((_a = this.featureConfig) === null || _a === void 0 ? void 0 : _a.isLevel('6.3')) {
                    this.asmComponentService.handleDeepLinkNavigation(Object.assign({ customerId }, parameters));
                }
                else {
    ...
    createCustomer() {
        var _a;
        (_a = this.launchDialogService) === null || _a === void 0 ? void 0 : _a.openDialogAndSubscribe("ASM_CREATE_CUSTOMER_FORM" /* LAUNCH_CALLER.ASM_CREATE_CUSTOMER_FORM */, this.addNewCustomerLink);
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: AsmMainUiComponent, decorators: [{
        ...
        return [{ type: i1$1.AuthService }, { type: i2$1.CsAgentAuthService }, { type: AsmComponentService }, { type: i1$1.GlobalMessageService }, { type: i1$1.RoutingService }, { type: i2$3.AsmService }, { type: i2$4.UserAccountFacade }, { type: i1.LaunchDialogService }, { type: i1$1.FeatureConfigService, decorators: [{
                        type: Optional
                    }] }];
...
class CustomerListComponent {
    ...
    changePage(page) {
        ...
        if ((_a = this.searchBox) === null || _a === void 0 ? void 0 : _a.value) {
    ...
    fetchCustomers() {
        ...
        this.enableAsmB2bCustomerList =
            ((_b = (_a = this.featureConfig) === null || _a === void 0 ? void 0 : _a.isLevel('6.1')) !== null && _b !== void 0 ? _b : false) &&
        ...
        if (this.selectedUserGroupId) {
            ...
            if ((_c = this.searchBox) === null || _c === void 0 ? void 0 : _c.value) {
                options.query = this.searchBox.value;
            }
    ...
    updateCustomerListColumns() {
        var _a, _b;
        const columns = ((_a = this.customerListConfig) === null || _a === void 0 ? void 0 : _a.columns) || [];
        for (const column of columns) {
            ...
            if (column.headerLocalizationKey === 'asm.customerList.tableHeader.cart') {
                column.headerLocalizationKey = ((_b = this.featureConfig) === null || _b === void 0 ? void 0 : _b.isLevel('6.1'))
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CustomerListComponent, decorators: [{
        ...
        return [{ type: i1.LaunchDialogService }, { type: i1.BreakpointService }, { type: i2$1.AsmConfig }, { type: i1$1.TranslationService }, { type: i2$1.AsmCustomerListFacade }, { type: i1$1.FeatureConfigService, decorators: [{
                        type: Optional
