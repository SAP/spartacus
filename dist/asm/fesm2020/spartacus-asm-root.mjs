...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: UserIdHttpHeaderInterceptor, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.Config }, { type: i1$1.UserIdService }, { type: undefined, decorators: [{
                    type: Inject,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: CsAgentAuthService, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.AuthService }, { type: AsmAuthStorageService }, { type: i1$1.UserIdService }, { type: i1$1.OAuthLibWrapperService }, { type: i3$1.Store }, { type: i4.UserProfileFacade }, { type: i5.UserAccountFacade }, { type: i1$1.FeatureConfigService, decorators: [{
                    type: Optional
                }] }]; } });
