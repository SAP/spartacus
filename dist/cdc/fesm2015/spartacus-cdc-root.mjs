...
import { CxEvent, Config, facadeFactory, GlobalMessageType, OccUserConsentAdapter, I18nModule, UserConsentAdapter, provideDefaultConfigFactory, ConfigInitializerService, provideDefaultConfig } from '@spartacus/core';
...
class CdcUserPreferenceSerializer {
    ...
    convert(source, target) {
        var _a, _b;
        if (source) {
            const preference = (_a = source.id) === null || _a === void 0 ? void 0 : _a.concat('.isConsentGranted');
            let giveConsent = false;
            if (preference) {
                if ((_b = source.currentConsent) === null || _b === void 0 ? void 0 : _b.consentGivenDate) {
                    giveConsent = true;
                }
    ...
    persistCdcConsentsToStorage(siteConsent) {
        ...
        for (const key in siteDetails) {
            ...
            if (Object.hasOwn(siteDetails, key) &&
                ((_a = siteDetails[key]) === null || _a === void 0 ? void 0 : _a.isActive) === true) {
                const consent = {};
                consent.id = key;
                consent.required = (_b = siteDetails[key]) === null || _b === void 0 ? void 0 : _b.isMandatory;
...
class CdcJsService {
    ...
    addCdcEventHandlers(baseSite) {
        var _a, _b, _c;
        this.gigyaSDK = (_a = this.winRef.nativeWindow) === null || _a === void 0 ? void 0 : _a['gigya'];
        (_c = (_b = this.gigyaSDK) === null || _b === void 0 ? void 0 : _b.accounts) === null || _c === void 0 ? void 0 : _c.addEventHandlers({
    ...
    onLoginEventHandler(baseSite, response) {
        var _a;
        if (response && !((_a = response === null || response === void 0 ? void 0 : response.context) === null || _a === void 0 ? void 0 : _a.skipOccAuth)) {
    ...
    onInitRegistrationHandler(user, response) {
        var _a, _b;
        if (!(response === null || response === void 0 ? void 0 : response.regToken) || !(user === null || user === void 0 ? void 0 : user.uid) || !(user === null || user === void 0 ? void 0 : user.password)) {
            return throwError(null);
        }
        else {
            const regSource = ((_b = (_a = this.winRef.nativeWindow) === null || _a === void 0 ? void 0 : _a.location) === null || _b === void 0 ? void 0 : _b.href) || '';
    ...
    loginUserWithoutScreenSet(email, password, context) {
        ...
        return this.getSessionExpirationValue().pipe(switchMap((sessionExpiration) => {
            return this.invokeAPI('accounts.login', Object.assign(Object.assign({ loginID: email, password: password, ignoreInterruptions: ignoreInterruptions }, (context && { context: context })), { sessionExpiry: sessionExpiration })).pipe(take(1), tap({
                error: (response) => {
    ...
    registerOrganisationWithoutScreenSet(orgInfo) {
        var _a, _b;
        if (!(orgInfo === null || orgInfo === void 0 ? void 0 : orgInfo.companyName) ||
            !(orgInfo === null || orgInfo === void 0 ? void 0 : orgInfo.email) ||
            !(orgInfo === null || orgInfo === void 0 ? void 0 : orgInfo.firstName) ||
            !(orgInfo === null || orgInfo === void 0 ? void 0 : orgInfo.lastName)) {
            ...
            return this.invokeAPI('accounts.b2b.registerOrganization', {
                ...
                requester: Object.assign(Object.assign({ firstName: orgInfo.firstName, lastName: orgInfo.lastName, email: orgInfo.email }, (orgInfo.phoneNumber &&
                    orgInfo.phoneNumber.length > 0 && { phone: orgInfo.phoneNumber })), { department: department, jobFunction: position }),
                regSource: regSource,
            }).pipe(take(1), tap({
                error: (errorResponse) => this.handleRegisterError(errorResponse),
            }));
    ...
    openDelegatedAdminLogin(orgId) {
        return this.zone.run(() => {
            var _a, _b, _c;
            return (_c = (_b = (_a = this.gigyaSDK) === null || _a === void 0 ? void 0 : _a.accounts) === null || _b === void 0 ? void 0 : _b.b2b) === null || _c === void 0 ? void 0 : _c.openDelegatedAdminLogin({
                orgId: orgId,
            });
        });
    }
    ...
    getSessionExpirationValue() {
        var _a;
        if (((_a = this.cdcConfig) === null || _a === void 0 ? void 0 : _a.cdc) !== undefined) {
    ...
    getCurrentBaseSiteChannel() {
        ...
        this.baseSiteService
            .get(baseSiteUid)
            .pipe(take(1))
            .subscribe((data) => { var _a; return (channel = (_a = data === null || data === void 0 ? void 0 : data.channel) !== null && _a !== void 0 ? _a : ''); });
        return channel;
    }
    /**
    ...
    handleResetPassResponse(response) {
        if (response && response.status === 'OK') {
            ...
            const errorMessage = (response === null || response === void 0 ? void 0 : response.errorMessage) || {
    ...
    updateProfileWithoutScreenSet(user) {
        ...
        if (!(user === null || user === void 0 ? void 0 : user.firstName) ||
            ((_a = user === null || user === void 0 ? void 0 : user.firstName) === null || _a === void 0 ? void 0 : _a.length) === 0 ||
            !(user === null || user === void 0 ? void 0 : user.lastName) ||
            ((_b = user === null || user === void 0 ? void 0 : user.lastName) === null || _b === void 0 ? void 0 : _b.length) === 0) {
            ...
            return this.invokeAPI(setAccountInfoAPI, Object.assign({}, profileObj)).pipe(take(1), tap(() => this.userProfileFacade.update(user).subscribe({
    ...
    updateUserPasswordWithoutScreenSet(oldPassword, newPassword) {
        if (!oldPassword ||
            (oldPassword === null || oldPassword === void 0 ? void 0 : oldPassword.length) === 0 ||
            !newPassword ||
            (newPassword === null || newPassword === void 0 ? void 0 : newPassword.length) === 0) {
    ...
    onProfileUpdateEventHandler(response) {
        if (response) {
            ...
            this.getLoggedInUserEmail().subscribe((user) => {
                const currentEmail = user === null || user === void 0 ? void 0 : user.uid;
    ...
    updateUserEmailWithoutScreenSet(password, newEmail) {
        if (!password ||
            (password === null || password === void 0 ? void 0 : password.length) === 0 ||
            !newEmail ||
            (newEmail === null || newEmail === void 0 ? void 0 : newEmail.length) === 0) {
            ...
            return this.getLoggedInUserEmail().pipe(switchMap((user) => {
                const email = user === null || user === void 0 ? void 0 : user.uid;
                if (!email || (email === null || email === void 0 ? void 0 : email.length) === 0) {
                    return throwError('Email or password not provided');
                }
                // Verify the password by attempting to login
    ...
    updateAddressWithoutScreenSet(formattedAddress, zipCode, city, country) {
        if (!formattedAddress || (formattedAddress === null || formattedAddress === void 0 ? void 0 : formattedAddress.length) === 0) {
            return throwError('No address provided');
        }
        else {
            const profileObj = Object.assign(Object.assign(Object.assign({ address: formattedAddress }, (city && { city: city })), (country && { country: country })), (zipCode && { zip: zipCode }));
            return this.invokeAPI(setAccountInfoAPI, {
                profile: profileObj,
            });
        }
    ...
    invokeAPI(methodName, payload) {
        return new Observable((result) => {
            ...
            actualAPI(Object.assign(Object.assign({}, payload), { callback: (response) => {
                    this.zone.run(() => {
...
class CdcUserConsentService {
    ...
    updateCdcConsent(isConsentGranted, consentCodes, user, regToken) {
        ...
        let userId = '';
        if (user === undefined) {
            userId = (_a = this.getUserID()) !== null && _a !== void 0 ? _a : '';
        }
...
class CdcUserConsentAdapter extends OccUserConsentAdapter {
    ...
    withdrawConsent(userId, consentCode, consentId) {
        if (!this.cdcConsentsStorage.checkIfConsentExists(consentId !== null && consentId !== void 0 ? consentId : '')) {
