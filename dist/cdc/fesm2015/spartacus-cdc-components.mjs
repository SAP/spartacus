...
class GigyaRaasComponent {
    ...
    showScreenSet(data, lang) {
        var _a, _b, _c;
        (_c = (_b = (_a = this.winRef.nativeWindow) === null || _a === void 0 ? void 0 : _a['gigya']) === null || _b === void 0 ? void 0 : _b.accounts) === null || _c === void 0 ? void 0 : _c.showScreenSet(Object.assign(Object.assign({ screenSet: data.screenSet, startScreen: data.startScreen, lang }, (this.displayInEmbedMode(data)
