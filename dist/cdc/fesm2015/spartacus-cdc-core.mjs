...
class CdcUserAddressesEffects {
    ...
    getCountryName(countries, countryIsocode) {
        var _a;
        return (_a = countries.find((country) => country.isocode === countryIsocode)) === null || _a === void 0 ? void 0 : _a.name;
    }
    ...
    sendAddressToCDC(address) {
        ...
        return this.userAddressService.getDeliveryCountries().pipe(take(1), switchMap((countries) => {
            var _a;
            const countryName = this.getCountryName(countries, ((_a = address.country) === null || _a === void 0 ? void 0 : _a.isocode) || ' ') ||
                ' ';
