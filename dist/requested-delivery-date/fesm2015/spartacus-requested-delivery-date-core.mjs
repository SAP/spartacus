...
class RequestedDeliveryDateBadRequestHandler extends HttpErrorHandler {
    ...
    handleError(request, response) {
        var _a;
        if (request && ((_a = this.getErrors(response)) === null || _a === void 0 ? void 0 : _a.length)) {
            this.globalMessageService.add({ key: 'requestedDeliveryDate.errorMessage' }, GlobalMessageType.MSG_TYPE_ERROR);
        }
    }
    getErrors(response) {
        var _a;
        return ((_a = response.error) === null || _a === void 0 ? void 0 : _a.errors).filter((error) => (error === null || error === void 0 ? void 0 : error.type) === 'ValidationError' &&
            (error === null || error === void 0 ? void 0 : error.message) === 'checkout.multi.requestedretrievaldatevalid.error');
    }
    getPriority() {
