...
class DeliveryModeDatePickerComponent {
    ...
    ngOnInit() {
        var _a;
        if ((_a = this.deliveryOutlet) === null || _a === void 0 ? void 0 : _a.context$) {
            this.subscription.add(this.deliveryOutlet.context$.subscribe((context) => {
                this.cartEntry = context === null || context === void 0 ? void 0 : context.item;
                this.isDatePickerReadOnly = (context === null || context === void 0 ? void 0 : context.readonly) || false;
            }));
        }
    ...
    isEarliestRetrievalDatePresent() {
        var _a;
        return this.dateValidationService.isDateStringValid((_a = this.cartEntry) === null || _a === void 0 ? void 0 : _a.earliestRetrievalAt);
    }
    isRequestedDeliveryDatePresent() {
        var _a;
        return this.dateValidationService.isDateStringValid((_a = this.cartEntry) === null || _a === void 0 ? void 0 : _a.requestedRetrievalAt);
    }
    ...
    setRequestedDeliveryDate() {
        var _a, _b, _c, _d, _e;
        const userId = ((_b = (_a = this.cartEntry) === null || _a === void 0 ? void 0 : _a.user) === null || _b === void 0 ? void 0 : _b.uid) || '';
        const cartId = ((_c = this.cartEntry) === null || _c === void 0 ? void 0 : _c.code) || '';
        const requestedDate = ((_e = (_d = this.form) === null || _d === void 0 ? void 0 : _d.get('requestDeliveryDate')) === null || _e === void 0 ? void 0 : _e.value) || '';
        if (userId.length === 0 ||
            cartId.length === 0 ||
        ...
        this.subscription.add(this.requestedDelDateFacade
            ...
            error: (error) => {
                var _a;
                if (error && ((_a = this.getErrors(error)) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    getErrors(response) {
        var _a;
        return ((_a = response.error) === null || _a === void 0 ? void 0 : _a.errors).filter((error) => (error === null || error === void 0 ? void 0 : error.type) === 'UnknownResourceError');
    }
    ngOnDestroy() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: DeliveryModeDatePickerComponent, decorators: [{
        ...
        return [{ type: i1.CxDatePipe }, { type: RequestedDeliveryDateFacade }, { type: DateValidationService }, { type: i1.EventService }, { type: i1.TranslationService }, { type: i1.GlobalMessageService }, { type: i4.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class OrderOverviewDeliveryDateComponent {
    ...
    ngOnInit() {
        var _a;
        if ((_a = this.orderOutlet) === null || _a === void 0 ? void 0 : _a.context$) {
            this.subscription.add(this.orderOutlet.context$.subscribe((context) => (this.order = context === null || context === void 0 ? void 0 : context.item)));
        }
    }
    isRequestedDeliveryDatePresent() {
        var _a;
        return this.dateValidationService.isDateStringValid((_a = this.order) === null || _a === void 0 ? void 0 : _a.requestedRetrievalAt);
    }
    getRequestedDeliveryDateCardContent(isoDate) {
        return this.translation
            .translate('requestedDeliveryDate.readOnlyTextLabel')
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.9", ngImport: i0, type: OrderOverviewDeliveryDateComponent, decorators: [{
        ...
        return [{ type: DateValidationService }, { type: i1.TranslationService }, { type: i4.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
    } });
