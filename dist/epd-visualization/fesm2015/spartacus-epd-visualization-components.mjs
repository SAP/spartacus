...
class VisualViewerAnimationSliderService {
    ...
    get handleWidth() {
        var _a;
        return (_a = this.getClientWidth(this.handleElement)) !== null && _a !== void 0 ? _a : 0;
    }
    get barWidth() {
        var _a;
        return (_a = this.getClientWidth(this.barElement)) !== null && _a !== void 0 ? _a : 0;
    }
...
class VisualViewerService {
    ...
    ngOnDestroy() {
        var _a;
        (_a = this.selectedNodeIdsSubscription) === null || _a === void 0 ? void 0 : _a.unsubscribe();
    }
    ...
    loadVisualization(productCode) {
        ...
        return this.viewportAdded$.pipe(mergeMap(() => this.resolveVisualization(productCode).pipe(mergeMap((visualizationLoadInfo) => {
            if (visualizationLoadInfo.lookupResult ===
                ...
                let mergedVisualizationLoadInfo = Object.assign(Object.assign({}, visualizationLoadInfo), { loadStatus: VisualizationLoadStatus.Loading });
                ...
                return this.loadScene(this.sceneId, this.contentType).pipe(mergeMap((sceneLoadInfo) => {
                    if (sceneLoadInfo.sceneLoadState === SceneLoadState.Failed) {
                        mergedVisualizationLoadInfo = Object.assign(Object.assign({}, visualizationLoadInfo), { loadStatus: VisualizationLoadStatus.UnexpectedError, errorMessage: sceneLoadInfo.errorMessage });
                    }
                    else {
                        this.selectedNodeIdsSubscription =
                            this.selectedNodeIds$.subscribe(this.handleSelectedNodeIds.bind(this));
                        mergedVisualizationLoadInfo = Object.assign(Object.assign({}, visualizationLoadInfo), { loadStatus: VisualizationLoadStatus.Loaded });
                    }
                    this.setVisualizationLoadInfo(mergedVisualizationLoadInfo);
...
class VisualPickingProductListService {
    ...
    ngOnDestroy() {
        var _a, _b, _c;
        (_a = this.getFilteredProductReferencesSubscription) === null || _a === void 0 ? void 0 : _a.unsubscribe();
        (_b = this.filteredItemsSubscription) === null || _b === void 0 ? void 0 : _b.unsubscribe();
        (_c = this.productReferencesSubscription) === null || _c === void 0 ? void 0 : _c.unsubscribe();
    }
...
class VisualPickingTabService {
    ...
    ngOnDestroy() {
        ...
        (_a = this.visualizationLoadInfoChangeSubscription) === null || _a === void 0 ? void 0 : _a.unsubscribe();
        (_b = this.getProductReferencesSubscription) === null || _b === void 0 ? void 0 : _b.unsubscribe();
        (_c = this.getFilteredProductReferencesSubscription) === null || _c === void 0 ? void 0 : _c.unsubscribe();
    }
    get selectedProductCodes() {
        return this._selectedProductCodes;
    }
    ...
    get visualizationLoadStatus() {
        var _a, _b;
        return ((_b = (_a = this.visualViewerService.visualizationLoadInfo) === null || _a === void 0 ? void 0 : _a.loadStatus) !== null && _b !== void 0 ? _b : VisualizationLoadStatus.NotStarted);
    }
