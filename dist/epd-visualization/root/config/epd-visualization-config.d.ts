...
export declare abstract class EpdVisualizationConfig implements Config {
    /**
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<EpdVisualizationConfig, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<EpdVisualizationConfig>;
}
