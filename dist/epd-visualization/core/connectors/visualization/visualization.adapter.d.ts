...
export declare abstract class VisualizationAdapter {
    /**
     ...
     */
    abstract lookupVisualization(visualizationUsageId: UsageId, folderUsageId: UsageId): Observable<LookupVisualizationsResponse>;
}
