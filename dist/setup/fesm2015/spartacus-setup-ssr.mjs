...
const getRequestContext = (request) => {
    var _a, _b, _c;
    return (_c = (_b = (_a = request.res) === null || _a === void 0 ? void 0 : _a.locals) === null || _b === void 0 ? void 0 : _b.cx) === null || _c === void 0 ? void 0 : _c.request;
};
/**
...
const preprocessRequestForLogger = (request, logger) => {
    const requestContext = Object.assign(Object.assign({}, createInitialRequestContext()), { traceContext: getTraceContext(request, logger) });
...
const setRequestContext = (request, context) => {
    if (request.res) {
        request.res.locals = Object.assign(Object.assign({}, request.res.locals), { cx: Object.assign(Object.assign({}, request.res.locals.cx), { request: context }) });
    }
};
/**
...
const getTraceContext = (request, logger) => {
    var _a;
    try {
        return (_a = parseTraceparent(request.get('traceparent'))) !== null && _a !== void 0 ? _a : undefined;
    }
    catch (e) {
...
class DefaultExpressServerLogger {
    ...
    mapContext(context) {
        ...
        const outputContext = Object.assign({ timestamp }, context);
        if (context.request) {
     ...
     */
    mapRequest(request) {
        return Object.assign({ url: request.originalUrl }, getRequestContext(request));
    }
}
...
const getLoggableSsrOptimizationOptions = (value) => {
    ...
    Object.keys(value).forEach((key) => {
        ...
        if (isClassInstance(newValue[key])) {
            newValue[key] = (_a = newValue[key].constructor) === null || _a === void 0 ? void 0 : _a.name;
        }
...
class OptimizedSsrEngine {
    ...
    constructor(expressEngine, ssrOptions) {
        ...
        this.ssrOptions = ssrOptions
            ? Object.assign(Object.assign({}, defaultSsrOptimizationOptions), ssrOptions) : undefined;
    ...
    shouldRender(request) {
        ...
        if (fallBack) {
            this.log(`CSR fallback: rendering in progress (${request === null || request === void 0 ? void 0 : request.originalUrl})`, true, { request });
        }
        else if (concurrencyLimitExceeded) {
            this.log(`CSR fallback: Concurrency limit exceeded (${(_b = this.ssrOptions) === null || _b === void 0 ? void 0 : _b.concurrency})`, true, { request });
        }
        return ((!fallBack &&
    ...
    renderResponse(filePath, options, callback) {
        ...
        if (this.returnCachedRender(request, callback)) {
            this.log(`Render from cache (${request === null || request === void 0 ? void 0 : request.originalUrl})`, true, {
                request,
            });
            return;
        }
        ...
        if (this.shouldTimeout(request)) {
            ...
            requestTimeout = setTimeout(() => {
                ...
                this.fallbackToCsr(response, filePath, callback);
                this.log(`SSR rendering exceeded timeout ${timeout}, fallbacking to CSR for ${request === null || request === void 0 ? void 0 : request.originalUrl}`, false, { request });
            }, timeout);
        }
        else {
        ...
        const renderCallback = (err, html) => {
            ...
            if (requestTimeout) {
                ...
                callback(err, html);
                this.log(`Request is resolved with the SSR rendering result (${request === null || request === void 0 ? void 0 : request.originalUrl})`, true, { request });
    ...
    handleRender({ filePath, options, renderCallback, request, }) {
        ...
        this.log(`Request is waiting for the SSR rendering to complete (${request === null || request === void 0 ? void 0 : request.originalUrl})`, true, { request });
    }
    /**
     * Delegates the render to the original _Angular Universal express engine_.
     *
    ...
    startRender({ filePath, options, renderCallback, request, }) {
        ...
        let maxRenderTimeout = setTimeout(() => {
            ...
            this.log(`Rendering of ${request === null || request === void 0 ? void 0 : request.originalUrl} was not able to complete. This might cause memory leaks!`, false, { request });
        }, (_b = (_a = this.ssrOptions) === null || _a === void 0 ? void 0 : _a.maxRenderTime) !== null && _b !== void 0 ? _b : 300000); // 300000ms == 5 minutes
        this.log(`Rendering started (${request === null || request === void 0 ? void 0 : request.originalUrl})`, true, { request });
        this.renderingCache.setAsRendering(renderingKey);
        this.currentConcurrency++;
        options = Object.assign(Object.assign({}, options), { providers: [
                {
        ...
        this.expressEngine(filePath, options, (err, html) => {
            ...
            this.log(`Rendering completed (${request === null || request === void 0 ? void 0 : request.originalUrl})`, true, {
                request,
            });
            this.currentConcurrency--;
            renderCallback(err, html);
    ...
    initLogger(ssrOptions) {
        if ((ssrOptions === null || ssrOptions === void 0 ? void 0 : ssrOptions.logger) === true) {
            return new DefaultExpressServerLogger();
        }
        return (ssrOptions === null || ssrOptions === void 0 ? void 0 : ssrOptions.logger) || new LegacyExpressServerLogger();
    }
}
...
function serverRequestOriginFactory(options) {
    return () => {
        ...
        if (options === null || options === void 0 ? void 0 : options.serverRequestOrigin) {
