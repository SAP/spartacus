...
export declare const SMART_EDIT_DUMMY_COMPONENT_TYPE = "SmartEditDummyCMSComponent";
/**
...
export declare abstract class CmsConfig extends OccConfig {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<CmsConfig, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<CmsConfig>;
}
