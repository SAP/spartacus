...
class CloseAccountComponent {
    ...
    openModal() {
        ...
        dialog === null || dialog === void 0 ? void 0 : dialog.pipe(take(1)).subscribe();
    }
}
...
class RegisterComponentService {
    ...
    generateAdditionalConsentsFormControl() {
        var _a, _b;
        return (_b = (_a = this.fb) === null || _a === void 0 ? void 0 : _a.array([])) !== null && _b !== void 0 ? _b : undefined;
    }
}
...
class RegisterComponent {
    get additionalConsents() {
        var _a;
        return (_a = this.registerForm) === null || _a === void 0 ? void 0 : _a.get('additionalConsents');
    }
    ...
    constructor(globalMessageService, fb, router, anonymousConsentsService, anonymousConsentsConfig, authConfigService, registerComponentService) {
        ...
        this.registerForm = this.fb.group({
            ...
            additionalConsents: (_c = (_b = (_a = this.registerComponentService).generateAdditionalConsentsFormControl) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : this.fb.array([]),
    ...
    ngOnInit() {
        ...
        this.additionalRegistrationConsents =
            ((_d = this.registerComponentService) === null || _d === void 0 ? void 0 : _d.getAdditionalConsents()) || [];
...
class UpdatePasswordComponentService {
    ...
    onSuccess() {
        ...
        this.form.reset();
        // sets the redirect url after login
        (_a = this.authRedirectService) === null || _a === void 0 ? void 0 : _a.setRedirectUrl(this.routingService.getUrl({ cxRoute: 'home' }));
        // TODO(#9638): Use logout route when it will support passing redirect url
        (_b = this.authService) === null || _b === void 0 ? void 0 : _b.coreLogout().then(() => {
            this.routingService.go({ cxRoute: 'login' });
        });
    }
    onError(_error) {
        ...
        if (_error instanceof HttpErrorModel &&
            ((_a = _error.details) === null || _a === void 0 ? void 0 : _a[0].type) === 'AccessDeniedError') {
