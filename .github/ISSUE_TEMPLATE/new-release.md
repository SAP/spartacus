...
- [ ] Get the spartacussampledata source code zips for 1905, 2005, 2011 and 2105 CX versions (use `release/1905/next`, `release/2005/next`, `release/2011/next` and `release/2105/next` branches)
...
- [ ] Tag sample data branches for each version (1905, 2005, 2011, 2105):
  ...
  - [ ] tag the final commit on [release/2105/next](https://github.tools.sap/cx-commerce/spartacussampledata/commits/release/2105/next) branch: `git tag 2105-*.*.* HEAD-COMMIT-HASH-FROM-release/2011/next`
