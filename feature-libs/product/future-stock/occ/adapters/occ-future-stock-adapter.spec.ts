...
import { FUTURE_STOCK_LIST_NORMALIZER, FUTURE_STOCK_NORMALIZER, ProductFutureStock, ProductFutureStockList } from '@spartacus/product/future-stock/core';
...
describe('OccFutureStockAdapter', () => {
    ...
    expect(converter.pipeable).toHaveBeenCalledWith(FUTURE_STOCK_LIST_NORMALIZER);
  });
});
