...
export const LOAD_DEFAULT_POINT_OF_SERVICE = '[Default Point Of Service] Load Default Point Of Service';
export const LOAD_DEFAULT_POINT_OF_SERVICE_SUCCESS = '[Default Point Of Service] Load Default Point Of Service Success';
export const SET_DEFAULT_POINT_OF_SERVICE = '[Default Point Of Service] Set Default Point Of Service';
