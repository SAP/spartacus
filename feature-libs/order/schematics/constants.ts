import { SPARTACUS_ORDER } from '@spartacus/schematics';

export const ORDER_FOLDER_NAME = 'order';
export const ORDER_MODULE_NAME = 'order';
export const SCSS_FILE_NAME = 'order.scss';

export const ORDER_FEATURE_NAME_CONSTANT = 'ORDER_FEATURE';
export const SPARTACUS_ORDER_ROOT = `${SPARTACUS_ORDER}/root`;
export const SPARTACUS_ORDER_ASSETS = `${SPARTACUS_ORDER}/assets`;
