...
import { MyAccountV2OrderConsolidatedInformationComponent } from './myaccount-v2-order-consolidated-information.component';
import { OrderConsignmentsService } from '@spartacus/order/components';
...
class MockOrderConsignmentsService
  implements Partial<OrderConsignmentsService>
{
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        providers: [
          {
            provide: OrderConsignmentsService,
            useClass: MockOrderConsignmentsService,
          },
