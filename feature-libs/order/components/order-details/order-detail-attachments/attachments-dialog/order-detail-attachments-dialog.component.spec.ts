...
import { OrderDetailAttachmentsDialogComponent } from './order-detail-attachments-dialog.component';
...
const mockConfig: OrderDetailAttachmentsConfig = {
...
describe('AttachmentsDialogComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      declarations: [OrderDetailAttachmentsDialogComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(OrderDetailAttachmentsDialogComponent);
