...
@Component({
  selector: 'cx-order-detail-attachments-dialog',
  templateUrl: './order-detail-attachments-dialog.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: false,
})
export class OrderDetailAttachmentsDialogComponent {
  protected config = inject(OrderDetailAttachmentsConfig);
