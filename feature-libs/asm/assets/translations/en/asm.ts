export const asm = {
  asm: {
    ...
    customer360: {
      ...
      generalTabEmptyText: 'There is currently no recorded customer activity',
      feedBackTabSupportTitle: 'Support Tickets',
      feedBackTabSupportEmptyText: 'There are currently no Support Ticket items',
      feedBackTabProductReviewsTitle: 'Product Reviews',
      feedBackTabProductReviewsEmptyText:'There are currently no Product Review items',
      tableHeader: {
        id: 'ID',
        type: 'Type',
      ...
      mapDisplayCount: '{{start}} - {{end}} from {{count}} stores found',
