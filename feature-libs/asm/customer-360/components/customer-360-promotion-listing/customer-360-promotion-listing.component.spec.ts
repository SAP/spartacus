...
import { PromotionListEntry } from './customer-360-promotion-listing.model';
...
describe('Customer360PromotionListingComponent', () => {
  ...
  @Component({
    ...
    template: `
      <cx-customer-360-promotion-listing
  ...
  let component: Customer360PromotionListingComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [TestHostComponent, Customer360PromotionListingComponent],
    }).compileComponents();
  });
  ...
  beforeEach(() => {
    ...
    component = fixture.debugElement.query(
      By.directive(Customer360PromotionListingComponent)
    ).componentInstance;
  ...
  it('should display header text', () => {
    ...
    const header = el.query(
      By.css('.cx-customer-360-promotion-listing-heading-text')
    );
  ...
  it('should display entries list', () => {
    ...
    const entriesList = el.query(By.css('.cx-customer-360-promotion-listing'));
    expect(entriesList).toBeTruthy();

    const listTableBody = el.query(By.css('table'));

    const rows = listTableBody.queryAll(
      By.css('.cx-customer-360-promotion-listing-row')
    );
  ...
  it('should display empty message when entries is empty', () => {
    ...
    const emptyMessage = el.query(
      By.css('.cx-customer-360-promotion-listing-empty')
    );
  ...
  it('should be able to display promotion applied correctly', () => {
    ...
    const ngContainer = el.query(
      By.css('table .cx-customer-360-promotion-listing-applied')
    );
