...
describe('Customer360TableComponent', () => {
  ...
  let component: Customer360TableComponent;
  ...
  beforeEach(() => {
    ...
    component = fixture.debugElement.query(
      By.directive(Customer360TableComponent)
    ).componentInstance;
  ...
  it('should display header text', () => {
    ...
    const header = el.query(By.css('.cx-customer-360-table-heading-text'));
  ...
  it('should display table', () => {
    ...
    const table = el.query(By.css('.cx-customer-360-table'));
  ...
  describe('table pagination', () => {
    ...
    it('should display the list of pages', () => {
      const pages = el.queryAll(
        By.css(
          '.cx-customer-360-table-heading-pages .cx-customer-360-table-heading-page'
        )
      );
