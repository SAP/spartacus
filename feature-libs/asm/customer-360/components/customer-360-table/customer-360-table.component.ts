...
@Component({
  ...
  selector: 'cx-customer-360-table',
  templateUrl: './customer-360-table.component.html',
})
export class Customer360TableComponent implements OnChanges, AfterViewChecked {
