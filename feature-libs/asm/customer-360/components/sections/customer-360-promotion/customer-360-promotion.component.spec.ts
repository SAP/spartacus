...
describe('Customer360PromotionComponent', () => {
  let component: Customer360PromotionComponent;
  let fixture: ComponentFixture<Customer360PromotionComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Customer360PromotionComponent);
