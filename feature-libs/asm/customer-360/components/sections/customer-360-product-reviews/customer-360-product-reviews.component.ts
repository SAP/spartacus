...
import { ReviewEntry } from './customer-360-product-reviews.model';
import { Customer360Config } from '../../config/customer-360-config';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'cx-customer-360-product-reviews',
  templateUrl: './customer-360-product-reviews.component.html',
  providers: [CxDatePipe],
})
export class Customer360ProductReviewsComponent implements OnInit {
