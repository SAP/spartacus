...
describe('Customer360ProductInterestsComponent', () => {
  let component: Customer360ProductInterestsComponent;
  let fixture: ComponentFixture<Customer360ProductInterestsComponent>;
  let el: DebugElement;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [
        Customer360ProductInterestsComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Customer360ProductInterestsComponent);
