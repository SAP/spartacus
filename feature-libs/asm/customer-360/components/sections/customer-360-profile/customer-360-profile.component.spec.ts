...
describe('Customer360ProfileComponent', () => {
  ...
  let component: Customer360ProfileComponent;
  let fixture: ComponentFixture<Customer360ProfileComponent>;
  let el: DebugElement;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Customer360ProfileComponent);
