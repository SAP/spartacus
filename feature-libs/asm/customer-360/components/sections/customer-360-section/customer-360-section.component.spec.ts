...
import { Customer360SectionComponent } from './customer-360-section.component';

describe('Customer360SectionComponent', () => {
  let component: Customer360SectionComponent;
  let fixture: ComponentFixture<Customer360SectionComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [Customer360SectionComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(Customer360SectionComponent);
