...
import { Customer360TableComponent } from '../../customer-360-table/customer-360-table.component';
...
describe('Customer360SupportTicketsComponent', () => {
  ...
  let component: Customer360SupportTicketsComponent;
  let fixture: ComponentFixture<Customer360SupportTicketsComponent>;
  let el: DebugElement;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [
        Customer360SupportTicketsComponent,
        MockTranslatePipe,
        MockCxIconComponent,
        Customer360TableComponent,
        ArgsPipe,
      ],
      providers: [
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(Customer360SupportTicketsComponent);
  ...
  it('should display the column headers', () => {
    const headers = el.queryAll(By.css('.cx-customer-360-table-header'));
    expect(headers.length).toBe(component.supportTicketsColumns.length);
  });

  it('should display table', () => {
    const tableBody = el.query(By.css('.cx-customer-360-table tbody'));
  ...
  it('should navigate ticket', () => {
    ...
    const tableBody = el.query(By.css('.cx-customer-360-table tbody'));
    const tableRows = tableBody.queryAll(By.css('tr'));
    const linkCell = tableRows[0].query(By.css('.cx-customer-360-table-link'));
