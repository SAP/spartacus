...
} from '../../customer-360-table/customer-360-table.model';
import { Customer360SectionContext } from '../customer-360-section-context.model';
import { SupportTicketEntry } from './customer-360-support-tickets.model';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'cx-customer-360-support-tickets',
  templateUrl: './customer-360-support-tickets.component.html',
})
export class Customer360SupportTicketsComponent implements OnInit {
