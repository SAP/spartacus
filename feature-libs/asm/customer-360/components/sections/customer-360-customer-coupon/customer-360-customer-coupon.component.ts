...
@Component({
  ...
  selector: 'cx-customer-360-customer-coupon',
  templateUrl: './customer-360-customer-coupon.component.html',
})
export class Customer360CustomerCouponComponent implements OnInit, OnDestroy {
