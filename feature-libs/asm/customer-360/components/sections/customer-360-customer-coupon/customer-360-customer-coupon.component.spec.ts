...
import { Customer360PromotionListingComponent } from '../../customer-360-promotion-listing/customer-360-promotion-listing.component';
import { CustomerCouponEntry } from './customer-360-customer-coupon.model';
import { By } from '@angular/platform-browser';
import { DebugElement } from '@angular/core';

describe('Customer360CouponComponent', () => {
  let customerCouponService: CustomerCouponService;
  let component: Customer360CustomerCouponComponent;
  let fixture: ComponentFixture<Customer360CustomerCouponComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [
        Customer360CustomerCouponComponent,
        Customer360PromotionListingComponent,
      ],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(Customer360CustomerCouponComponent);
  ...
  it('should reload customer coupon list when searching customer coupon ', () => {
    ...
    el.query(
      By.css('.cx-customer-360-promotion-listing-search-icon-search')
    ).nativeElement.click();
