...
import { ActivityEntry, TypeCodes } from './customer-360-activity.model';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'cx-customer-360-activity',
  templateUrl: './customer-360-activity.component.html',
})
export class Customer360ActivityComponent implements OnInit {
