...
describe('Customer360ActivityComponent', () => {
  ...
  let component: Customer360ActivityComponent;
  let fixture: ComponentFixture<Customer360ActivityComponent>;
  let el: DebugElement;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(Customer360ActivityComponent);
  ...
  describe('table', () => {
    ...
    it('should navigate to cart, order detail, saved cart detail, and support ticket detail', () => {
      ...
      const linkCell = tableRows[0].query(
        By.css('.cx-customer-360-table-link')
      );
