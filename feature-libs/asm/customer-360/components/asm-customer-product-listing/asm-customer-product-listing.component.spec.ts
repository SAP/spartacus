...
describe('AsmCustomerProductListingComponent', () => {
  let component: AsmCustomerProductListingComponent;
  let fixture: ComponentFixture<AsmCustomerProductListingComponent>;
  let el: DebugElement;
  ...
  class AsmCustomerProductListingComponentTest {
    @ViewChild(AsmCustomerProductListingComponent)
    componentRef: AsmCustomerProductListingComponent;
  ...
  function createComponent(): void {
    fixture = TestBed.createComponent(AsmCustomerProductListingComponent);
