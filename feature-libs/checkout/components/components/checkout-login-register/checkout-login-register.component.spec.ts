...
describe('LoginRegisterComponent', () => {
  let component: CheckoutLoginRegisterComponent;
  let fixture: ComponentFixture<CheckoutLoginRegisterComponent>;
  ...
  const testBedDefaults = {
    ...
    declarations: [CheckoutLoginRegisterComponent, MockUrlPipe],
    providers: [
  ...
  function createComponent() {
    fixture = TestBed.createComponent(CheckoutLoginRegisterComponent);
