  ...
  backend: {
    occ: {
      endpoints: {
        ...
        loadCheckoutDetails:
          'users/${userId}/carts/${cartId}?fields=deliveryAddress(FULL),deliveryMode(FULL),paymentInfo(FULL),paymentType(FULL),purchaseOrderNumber,costCenter(FULL)', // TODO: Move b2b part to b2b config of this endpoint
        /* eslint-enable */
      },
    },
  },
