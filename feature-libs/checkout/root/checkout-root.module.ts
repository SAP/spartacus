...
import { OrderConfirmationGetOrderEntries } from './pages/order-confirmation-get-order-entries-context.service';
    ...
    RouterModule.forChild([
      {
        ...
        data: {
          ...
          cxContext: {
            [ORDER_ENTRIES_CONTEXT]: OrderConfirmationGetOrderEntries,
          },
        },
      },
    ]),
