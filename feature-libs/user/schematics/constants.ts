import { SPARTACUS_USER } from '@spartacus/schematics';

export const USER_FOLDER_NAME = 'user';
export const SCSS_FILE_NAME = 'user.scss';
export const USER_FEATURE_NAME = 'User';

export const USER_ACCOUNT_FEATURE_NAME = 'userAccount';
export const USER_ACCOUNT_FEATURE_CONSTANT = 'USER_ACCOUNT_FEATURE';
...
export const USER_PROFILE_FEATURE_CONSTANT = 'USER_PROFILE_FEATURE';
