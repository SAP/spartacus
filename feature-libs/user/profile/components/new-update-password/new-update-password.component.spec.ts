...
class MockUpdatePasswordService
  implements Partial<NewUpdatePasswordComponentService>
{
...
describe('UpdatePasswordComponent', () => {
  let component: NewUpdatePasswordComponent;
  let fixture: ComponentFixture<NewUpdatePasswordComponent>;
  let el: DebugElement;

  let service: NewUpdatePasswordComponentService;
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [NewUpdatePasswordComponent, MockCxSpinnerComponent],
        providers: [
          {
        ...
        .overrideComponent(NewUpdatePasswordComponent, {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NewUpdatePasswordComponent);
    component = fixture.componentInstance;
    el = fixture.debugElement;
    service = TestBed.inject(NewUpdatePasswordComponentService);
