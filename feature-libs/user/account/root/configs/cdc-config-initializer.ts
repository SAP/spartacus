...
import { AuthConfig, AuthLibConfig, BASE_SITE_CONTEXT_ID, BaseSiteService, ConfigInitializer, ConfigInitializerService } from '@spartacus/core';
  ...
  protected getAuthConfig(): AuthConfig {
    ...
    const result = {
        authentication: {
            ...
            tokenEndpoint:'https://auth.pilot-demo6-p1-public.model-t.myhybris.cloud/oidc/op/v1.0/4__GcGe4z3mp-6QicQgo0Y_Q/token',
            OAuthLibConfig: <AuthLibConfig>{
                clientId: 'T8ONdZ84OQW6Kud0LwM9pFC1',
                issuer: 'https://auth.pilot-demo6-p1-public.model-t.myhybris.cloud/oidc/op/v1.0/4__GcGe4z3mp-6QicQgo0Y_Q',
