...
import { BreadcrumbMeta, ContentPageMetaResolver, I18nTestingModule, PageRobotsMeta, RouterState, RoutingService, SemanticPathService } from '@spartacus/core';
...
const accountSummariesBreadcrumb = { label: 'Account Summaries', link: '/organization' };
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            providers: [
                ...
                { provide: ContentPageMetaResolver, useClass: MockContentPageMetaResolver },
            ],
        });
    ...
    describe('resolveBreadcrumbs', () => {
        describe('when on the Account Summary units list page', () => {
            ...
            it('should NOT return breadcrumb for the Account Summary page', async () => {
                ...
                expect(
                    val
                ).toEqual([testHomeBreadcrumb, organizationBreadcrumb]);
            });
        });
