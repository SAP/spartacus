...
import {
  ...
  ORGANIZATION_ADMINISTRATION_FEATURE_CONSTANT,
  ORGANIZATION_ADMINISTRATION_FEATURE_NAME,
  ORGANIZATION_FOLDER_NAME,
  ORGANIZATION_ORDER_APPROVAL_FEATURE_CONSTANT,
...
function addAdministrationFeature(options: SpartacusOrganizationOptions): Rule {
  return addLibraryFeature(options, {
    ...
    lazyLoadingChunk: {
      ...
      namedImports: [ORGANIZATION_ADMINISTRATION_FEATURE_CONSTANT],
    },
    i18n: {
...
function addOrderApprovalsFeature(options: SpartacusOrganizationOptions): Rule {
  return addLibraryFeature(options, {
    ...
    lazyLoadingChunk: {
      ...
      namedImports: [ORGANIZATION_ORDER_APPROVAL_FEATURE_CONSTANT],
    },
    i18n: {
