...
describe('UserFormComponent', () => {
  ...
  it('should display list of rights', () => {
    component.form = mockForm;
    (component.form?.get('roles') as FormArray).push(
      new FormControl('unitorderviewergroup')
    );

    fixture.detectChanges();

    expect(component.form.get('roles').value).toContain('unitorderviewergroup');
  });
