...
// Side-effect imports: register module augmentations at application startup.
...
@NgModule({
  providers: [
    ...
    // OCC endpoint config must be registered eagerly (in the root module) so that
    // OccEndpointsService — a root singleton built once at app startup — can
    // resolve our custom endpoint keys before the lazy feature module loads.
