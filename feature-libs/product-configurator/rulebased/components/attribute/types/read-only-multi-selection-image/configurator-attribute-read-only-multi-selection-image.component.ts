...
@Component({
  selector: 'cx-configurator-attribute-read-only-multi-selection-image',
  templateUrl:
    './configurator-attribute-read-only-multi-selection-image.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ConfiguratorAttributeReadOnlyMultiSelectionImageComponent
