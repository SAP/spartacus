...
describe('ConfiguratorAttributeReadOnlyMultiSelectionImageComponent', () => {
  let component: ConfiguratorAttributeReadOnlyMultiSelectionImageComponent;
  let fixture: ComponentFixture<ConfiguratorAttributeReadOnlyMultiSelectionImageComponent>;
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        .overrideComponent(ConfiguratorAttributeReadOnlyMultiSelectionImageComponent, {
          set: {
