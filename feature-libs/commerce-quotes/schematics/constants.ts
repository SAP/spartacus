...
export const SPARTACUS_COMMERCE_QUOTES_ROOT = `${SPARTACUS_COMMERCE_QUOTES}/root`;
export const SPARTACUS_COMMERCE_QUOTES_ASSETS = `${SPARTACUS_COMMERCE_QUOTES}/assets`;
