...
describe('Spartacus Commerce Quotes schematics: ng-add', () => {
  ...
  const libraryNoFeaturesOptions: SpartacusCommerceQuotesOptions = {
    project: 'schematics-test',
    lazy: true,
    features: [],
  };
  ...
  describe('Commerce Quotes feature', () => {
    describe('general setup', () => {
      beforeEach(async () => {
        appTree = await schematicRunner
          .runSchematicAsync('ng-add', commerceQuotesFeatureOptions, appTree)
          .toPromise();
      });
    ...
    describe('eager loading', () => {
      beforeEach(async () => {
        appTree = await schematicRunner
          .runSchematicAsync(
            'ng-add',
            { ...commerceQuotesFeatureOptions, lazy: false },
            appTree
          )
          .toPromise();
      });
