 ...
 *
 * @function
 * @param {RenderingStrategyResolverOptions} options - The options to configure the rendering strategy resolver.
 * @param {string[]} [options.excludedUrls] - An optional array of URLs for which server-side rendering (SSR) should be disabled.
 * @param {string[]} [options.excludedParams] - An optional array of Query parameters for which SSR should be disabled.
 * @param {Request} request - The request object for which the rendering strategy should be determined.
 * @returns {function(request:Request): RenderingStrategy} - A rendering strategy resolver function that takes a Request object
