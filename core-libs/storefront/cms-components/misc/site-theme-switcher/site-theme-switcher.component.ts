...
import { FeatureDirective, SiteTheme, TranslatePipe, TranslationService, useFeatureStyles } from '@spartacus/core';
...
@Component({
  ...
  imports: [NgIf, NgFor, IconComponent, AsyncPipe, TranslatePipe, FeatureDirective],
})
