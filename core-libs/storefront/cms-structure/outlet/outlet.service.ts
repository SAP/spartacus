...
export class OutletService<T = TemplateRef<any> | Type<any>> {
  ...
  /**
   * @param component The component class that will be dynamically added to the outlet UI
   */
  add(
    outlet: string,
  ...
  /**
   * @param templateOrComponent A component class that inserts a component dynamically.
   */
  add(
    outlet: string,
