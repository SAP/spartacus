...
import {
  ...
  SPARTACUS_ORGANIZATION_B2B_UNIT_SELECTION,
  SPARTACUS_ORGANIZATION_B2B_UNIT_SELECTION_ASSETS,
  SPARTACUS_ORGANIZATION_B2B_UNIT_SELECTION_ROOT,
...
export const ORGANIZATION_B2B_UNIT_SELECTION_MODULE_NAME =
  'OrganizationB2bUnitSelection';
export const B2B_UNIT_SELECTION_MODULE = 'B2bUnitSelectionModule';
...
export const ORGANIZATION_B2B_UNIT_SELECTION_SCHEMATICS_CONFIG: SchematicConfig =
  {
    library: {
      featureName: ORGANIZATION_B2B_UNIT_SELECTION_FEATURE_NAME,
      mainScope: SPARTACUS_ORGANIZATION,
      featureScope: SPARTACUS_ORGANIZATION_B2B_UNIT_SELECTION,
      b2b: true,
    },
    folderName: ORGANIZATION_FOLDER_NAME,
    moduleName: ORGANIZATION_B2B_UNIT_SELECTION_MODULE_NAME,
    featureModule: {
      name: B2B_UNIT_SELECTION_MODULE,
      importPath: SPARTACUS_ORGANIZATION_B2B_UNIT_SELECTION,
    },
    rootModule: {
      name: B2B_UNIT_SELECTION_ROOT_MODULE,
      importPath: SPARTACUS_ORGANIZATION_B2B_UNIT_SELECTION_ROOT,
    },
    lazyLoadingChunk: {
      moduleSpecifier: SPARTACUS_ORGANIZATION_B2B_UNIT_SELECTION_ROOT,
      namedImports: [ORGANIZATION_B2B_UNIT_SELECTION_FEATURE_NAME_CONSTANT],
    },
    i18n: {
      resources: B2B_UNIT_SELECTION_TRANSLATIONS,
      chunks: B2B_UNIT_SELECTION_TRANSLATION_CHUNKS_CONFIG,
      importPath: SPARTACUS_ORGANIZATION_B2B_UNIT_SELECTION_ASSETS,
    },
    styles: {
      scssFileName: ORGANIZATION_SCSS_FILE_NAME,
      importStyle: SPARTACUS_ORGANIZATION,
    ...
    // Requires B2bOrganization (Administration) to be installed first,
    // as per the reviewer's guidance. The feature itself is opt-in at runtime
    // via the b2bUnitSelection.enabled config flag.
    dependencyFeatures: [ORGANIZATION_ADMINISTRATION_FEATURE_NAME],
  };
