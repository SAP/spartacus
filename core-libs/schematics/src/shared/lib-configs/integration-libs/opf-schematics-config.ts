...
import {
  ...
  OPF_QUICK_BUY_PICKUP_IN_STORE_FEATURE_NAME,
  ...
  SPARTACUS_OPF_QUICK_BUY_PICKUP_IN_STORE,
...
export const OPF_QUICK_BUY_PICKUP_IN_STORE_MODULE =
  'OpfQuickBuyPickupInStoreModule';
...
export const OPF_QUICK_BUY_PICKUP_IN_STORE_SCHEMATICS_CONFIG: SchematicConfig =
  {
    library: {
      featureName: OPF_QUICK_BUY_PICKUP_IN_STORE_FEATURE_NAME,
      mainScope: SPARTACUS_OPF,
      featureScope: SPARTACUS_OPF_QUICK_BUY_PICKUP_IN_STORE,
    },
    folderName: OPF_FOLDER_NAME,
    moduleName: OPF_MODULE_NAME,
    featureModule: {
      name: OPF_QUICK_BUY_PICKUP_IN_STORE_MODULE,
      importPath: SPARTACUS_OPF_QUICK_BUY_PICKUP_IN_STORE,
    },
    dependencyFeatures: [
      OPF_QUICK_BUY_FEATURE_NAME,
      PICKUP_IN_STORE_FEATURE_NAME,
    ...
    importAfter: [
      {
        markerModuleName: OPF_QUICK_BUY_MODULE,
        featureModuleName: OPF_QUICK_BUY_PICKUP_IN_STORE_MODULE,
      },
    ],
  };
